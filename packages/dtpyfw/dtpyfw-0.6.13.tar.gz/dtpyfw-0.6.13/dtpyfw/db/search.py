...
__all__ = ("get_list", "GetListContext")
...
class GetListContext:
    ...
    This dataclass consolidates all parameters for the get_list function,
    providing a cleaner API and better maintainability.
...
def get_list(
    ...
    Args:
        ctx: GetListContext dataclass containing all configuration parameters:
            ...
            - pre_conditions: Optional SQLAlchemy filter expressions
    ...
    pre_conditions = ctx.pre_conditions or []
