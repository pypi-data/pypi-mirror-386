...
__all__ = ("ModelBase", "SoftDeleteMixin", "TimestampMixin", "ConfigurableMixin", "DatabaseBase")
...
class ModelBase(DatabaseBase, TimestampMixin):
    ...
    for settings fields and change tracking. Inherits from DatabaseBase for 
    SQLAlchemy v2 DeclarativeBase functionality.
    ...
    Example usage:
        ...
        class Post(ModelBase, SoftDeleteMixin):
            __tablename__ = 'posts'
