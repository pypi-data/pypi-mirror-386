...
def download_content(
        url, username=None, password=None, retries=None, proxy=None, error=False, block_size=6 * 1024):
    url = _get_url(url, username, password)
    result = b''
    times = 0
...
def download_file(
        url, path=None, username=None, password=None, retries=None, proxy=None, interval=0.5, error=False,
        block_size=6 * 1024):
    url = _get_url(url, username, password)
    if path is None:
