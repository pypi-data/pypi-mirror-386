            ...
            def render_load():
                ...
                with content_container:
                    ...
                    with ui.card().classes("mt-4"):
                        ...
                        if not load_active or load_config.get("development_deficiency_mining_only", False) or load_config.get("development_load_reports_only", False):
                        ...
                        def update_delete_projects_before_load_state():
                            ...
                            development_deficiency_only = load_config.get("development_deficiency_mining_only", False)
                            development_reports_only = load_config.get("development_load_reports_only", False)
                            ...
                            if development_deficiency_only or development_reports_only:
                                ...
                                if load_active:
                                    delete_projects_before_load_switch.props(remove="disable")
                        ...
                        development_deficiency_mining_only_switch = ui.switch(
                            ...
                            value=load_config.get("development_deficiency_mining_only", False),
                        ...
                        development_load_reports_only_switch = ui.switch(
                            ...
                            value=load_config.get("development_load_reports_only", False),
