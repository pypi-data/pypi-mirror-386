...
def get_types(database_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str database_name: Limit types to a specific database
    :param _builtins.str region: The region in which the resource is located.
    :param _builtins.str schema_name: Limit types to a specific schema within a specific database
    """
    __args__ = dict()
...
def get_types_output(database_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
