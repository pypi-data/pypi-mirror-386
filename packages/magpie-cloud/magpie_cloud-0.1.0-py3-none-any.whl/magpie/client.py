"""
Magpie client for MicroVM Orchestrator
"""
...
class Magpie:
    """
    Main client for interacting with MicroVM Orchestrator API.
    
    Args:
        api_key: Your API key for authentication
        base_url: Base URL of the API (default: https://api.microvm.io)
    ...
    def __init__(
        self,
        api_key: str,
        base_url: str = "https://api.microvm.io",
        timeout: int = 30
    ):
        if not api_key:
