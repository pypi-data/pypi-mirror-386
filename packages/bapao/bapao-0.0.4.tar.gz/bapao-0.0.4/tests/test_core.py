...
class TestPasskeyGenerator:
    ...
    def test_passkey_hint_generation(self):
        ...
        expected = "Stored in Bitwarden as 'BAPAO-test-profile'"
...
class TestProfile:
    ...
    def test_profile_creation_with_passkey_fields(self):
        ...
        profile = Profile(
            ...
            has_passkey=True,
            passkey_hint="Stored in Bitwarden as 'BAPAO-test'"
        )
...
class TestConfigManager:
    ...
    def test_config_manager_stores_passkey_info(self, temp_config_dir):
        ...
        profile = Profile(
            ...
            base_directory="/tmp/test",
            has_passkey=True,
            passkey_hint="Stored in Bitwarden as 'BAPAO-test-passkey'"
        )
...
class TestSecurityFeatures:
    ...
    def test_zero_trust_model(self):
        ...
        assert "Bitwarden" in profile.passkey_hint
