# awslaus storage gateway mcp server
...
```bash
pip install awslabs-storage-gateway-mcp-server
```

Or use with uvx:

```bash
uvx awslabs-storage-gateway-mcp-server
```

## Usage

```bash
awslabs-storage-gateway-mcp-server
```
