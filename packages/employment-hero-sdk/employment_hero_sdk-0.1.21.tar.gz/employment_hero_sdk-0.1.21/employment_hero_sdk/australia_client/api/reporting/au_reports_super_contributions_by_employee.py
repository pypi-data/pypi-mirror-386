...
from ...models.super_accrual_export_model import SuperAccrualExportModel
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/business/{business_id}/report/supercontributions/byemployee",
        "params": params,
    }
...
) -> Optional[List["SuperAccrualExportModel"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = SuperAccrualExportModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["SuperAccrualExportModel"]]:
    return Response(
