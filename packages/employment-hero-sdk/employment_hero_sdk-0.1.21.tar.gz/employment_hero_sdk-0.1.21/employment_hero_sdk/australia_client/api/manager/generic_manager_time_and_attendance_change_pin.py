...
from ...models.change_kiosk_pin_model import ChangeKioskPinModel
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/api/v2/business/{business_id}/manager/kiosk/{kiosk_id}/changepin",
    }

    if isinstance(body, ChangeKioskPinModel):
