...
from ..models.shift_costings_request_shift_model_external_service import ShiftCostingsRequestShiftModelExternalService
...
T = TypeVar("T", bound="ShiftCostingsRequestShiftModel")
...
class ShiftCostingsRequestShiftModel:
    ...
    Attributes:
        ...
        source (Union[Unset, ShiftCostingsRequestShiftModelExternalService]):
    ...
    source: Union[Unset, ShiftCostingsRequestShiftModelExternalService] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = ShiftCostingsRequestShiftModelExternalService(_source)
        ...
        shift_costings_request_shift_model = cls(
            shift_id=shift_id,
            state=state,
        ...
        shift_costings_request_shift_model.additional_properties = d
        return shift_costings_request_shift_model
