...
T = TypeVar("T", bound="PaymentHistoryReportRequestModel")


@_attrs_define
class PaymentHistoryReportRequestModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payment_history_report_request_model = cls(
        ...
        payment_history_report_request_model.additional_properties = d
        return payment_history_report_request_model
