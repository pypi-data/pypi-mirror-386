...
T = TypeVar("T", bound="PagedResultModelManagerExpenseRequestModel")


@_attrs_define
class PagedResultModelManagerExpenseRequestModel:
    """
    Attributes:
        item_count_future (Union[Unset, IFutureValueInt32]):
        item_count (Union[Unset, int]):
        items (Union[Unset, List['ManagerExpenseRequestModel']]):
    ...
    items: Union[Unset, List["ManagerExpenseRequestModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = ManagerExpenseRequestModel.from_dict(items_item_data)
        ...
        paged_result_model_manager_expense_request_model = cls(
        ...
        paged_result_model_manager_expense_request_model.additional_properties = d
        return paged_result_model_manager_expense_request_model
