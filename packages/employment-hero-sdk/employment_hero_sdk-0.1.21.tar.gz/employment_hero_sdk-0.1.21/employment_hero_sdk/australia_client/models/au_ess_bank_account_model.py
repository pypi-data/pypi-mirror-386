...
from ..models.au_ess_bank_account_model_bank_account_type_enum import AuEssBankAccountModelBankAccountTypeEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="AuEssBankAccountModel")


@_attrs_define
class AuEssBankAccountModel:
    """
    Attributes:
        account_type (Union[Unset, AuEssBankAccountModelBankAccountTypeEnum]):
        id (Union[Unset, int]):
    ...
    account_type: Union[Unset, AuEssBankAccountModelBankAccountTypeEnum] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_account_type, Unset):
            ...
            account_type = AuEssBankAccountModelBankAccountTypeEnum(_account_type)
        ...
        au_ess_bank_account_model.additional_properties = d
        return au_ess_bank_account_model
