...
from ..models.employee_recurring_tax_adjustment_model_tax_adjustment_type_enum import (
    EmployeeRecurringTaxAdjustmentModelTaxAdjustmentTypeEnum,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EmployeeRecurringTaxAdjustmentModel")


@_attrs_define
class EmployeeRecurringTaxAdjustmentModel:
    """
    Attributes:
        adjustment_type (Union[Unset, EmployeeRecurringTaxAdjustmentModelTaxAdjustmentTypeEnum]):
        id (Union[Unset, int]):
    ...
    adjustment_type: Union[Unset, EmployeeRecurringTaxAdjustmentModelTaxAdjustmentTypeEnum] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_adjustment_type, Unset):
            ...
            adjustment_type = EmployeeRecurringTaxAdjustmentModelTaxAdjustmentTypeEnum(_adjustment_type)
        ...
        employee_recurring_tax_adjustment_model = cls(
        ...
        employee_recurring_tax_adjustment_model.additional_properties = d
        return employee_recurring_tax_adjustment_model
