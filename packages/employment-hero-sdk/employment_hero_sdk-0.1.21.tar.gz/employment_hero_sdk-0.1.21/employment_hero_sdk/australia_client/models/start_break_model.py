...
from ..models.start_break_model_nullable_time_attendance_shift_note_visibility import (
    StartBreakModelNullableTimeAttendanceShiftNoteVisibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StartBreakModel")


@_attrs_define
class StartBreakModel:
    """
    Attributes:
        ...
        note_visibility (Union[Unset, StartBreakModelNullableTimeAttendanceShiftNoteVisibility]):
    """
    ...
    note_visibility: Union[Unset, StartBreakModelNullableTimeAttendanceShiftNoteVisibility] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_note_visibility, Unset):
            ...
            note_visibility = StartBreakModelNullableTimeAttendanceShiftNoteVisibility(_note_visibility)

        start_break_model = cls(
        ...
        start_break_model.additional_properties = d
        return start_break_model
