...
T = TypeVar("T", bound="RosterShiftEditModel")


@_attrs_define
class RosterShiftEditModel:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        roster_shift_edit_model.additional_properties = d
        return roster_shift_edit_model
