...
from ..models.au_manager_roster_shift_model_nullable_shift_assignment_status_enum import (
...
T = TypeVar("T", bound="AuManagerRosterShiftModel")


@_attrs_define
class AuManagerRosterShiftModel:
    """
    Attributes:
        ...
        shift_assignment_status (Union[Unset, AuManagerRosterShiftModelNullableShiftAssignmentStatusEnum]):
    """
    ...
    shift_assignment_status: Union[Unset, AuManagerRosterShiftModelNullableShiftAssignmentStatusEnum] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_shift_assignment_status, Unset):
            ...
            shift_assignment_status = AuManagerRosterShiftModelNullableShiftAssignmentStatusEnum(
                _shift_assignment_status
            )

        au_manager_roster_shift_model = cls(
        ...
        au_manager_roster_shift_model.additional_properties = d
        return au_manager_roster_shift_model
