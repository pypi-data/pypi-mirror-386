...
T = TypeVar("T", bound="AuEarningsLineModelIDictionaryStringIList1")


@_attrs_define
class AuEarningsLineModelIDictionaryStringIList1:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        au_earnings_line_model_i_dictionary_string_i_list_1 = cls()
        ...
        au_earnings_line_model_i_dictionary_string_i_list_1.additional_properties = additional_properties
        return au_earnings_line_model_i_dictionary_string_i_list_1
