...
T = TypeVar("T", bound="LeaveApplicationWithAttachmentModel")


@_attrs_define
class LeaveApplicationWithAttachmentModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        leave_application_with_attachment_model = cls(
            from_date=from_date,
            to_date=to_date,
        ...
        leave_application_with_attachment_model.additional_properties = d
        return leave_application_with_attachment_model
