...
T = TypeVar("T", bound="ChartOfAccountsCategoryModel")


@_attrs_define
class ChartOfAccountsCategoryModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        chart_of_accounts_category_model = cls(
        ...
        chart_of_accounts_category_model.additional_properties = d
        return chart_of_accounts_category_model
