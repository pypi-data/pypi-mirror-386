...
T = TypeVar("T", bound="EmployeeGroupPermissionModel")


@_attrs_define
class EmployeeGroupPermissionModel:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        employee_group_permission_model = cls(
            id=id,
        ...
        employee_group_permission_model.additional_properties = d
        return employee_group_permission_model
