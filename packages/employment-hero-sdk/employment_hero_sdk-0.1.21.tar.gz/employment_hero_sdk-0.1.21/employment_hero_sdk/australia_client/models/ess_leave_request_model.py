...
from ..models.ess_leave_request_model_leave_unit_type_enum import EssLeaveRequestModelLeaveUnitTypeEnum
...
T = TypeVar("T", bound="EssLeaveRequestModel")


@_attrs_define
class EssLeaveRequestModel:
    """
    Attributes:
        ...
        unit_type (Union[Unset, EssLeaveRequestModelLeaveUnitTypeEnum]):
    ...
    unit_type: Union[Unset, EssLeaveRequestModelLeaveUnitTypeEnum] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_unit_type, Unset):
            ...
            unit_type = EssLeaveRequestModelLeaveUnitTypeEnum(_unit_type)
        ...
        ess_leave_request_model.additional_properties = d
        return ess_leave_request_model
