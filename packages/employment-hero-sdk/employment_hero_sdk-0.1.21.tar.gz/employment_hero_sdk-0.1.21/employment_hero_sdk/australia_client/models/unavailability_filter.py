...
T = TypeVar("T", bound="UnavailabilityFilter")


@_attrs_define
class UnavailabilityFilter:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        unavailability_filter.additional_properties = d
        return unavailability_filter
