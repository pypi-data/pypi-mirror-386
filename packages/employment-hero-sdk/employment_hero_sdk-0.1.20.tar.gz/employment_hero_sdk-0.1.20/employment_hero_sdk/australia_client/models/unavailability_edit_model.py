...
from ..models.unavailability_edit_model_nullable_day_of_week import UnavailabilityEditModelNullableDayOfWeek
from ..models.unavailability_edit_model_nullable_day_of_week_flags_enum import (
    UnavailabilityEditModelNullableDayOfWeekFlagsEnum,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UnavailabilityEditModel")


@_attrs_define
class UnavailabilityEditModel:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        recurring_day (Union[Unset, UnavailabilityEditModelNullableDayOfWeek]):
        recurring_days (Union[Unset, UnavailabilityEditModelNullableDayOfWeekFlagsEnum]):
    ...
    recurring_day: Union[Unset, UnavailabilityEditModelNullableDayOfWeek] = UNSET
    recurring_days: Union[Unset, UnavailabilityEditModelNullableDayOfWeekFlagsEnum] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_recurring_day, Unset):
            ...
            recurring_day = UnavailabilityEditModelNullableDayOfWeek(_recurring_day)
        ...
        if isinstance(_recurring_days, Unset):
            ...
            recurring_days = UnavailabilityEditModelNullableDayOfWeekFlagsEnum(_recurring_days)
        ...
        unavailability_edit_model.additional_properties = d
        return unavailability_edit_model
