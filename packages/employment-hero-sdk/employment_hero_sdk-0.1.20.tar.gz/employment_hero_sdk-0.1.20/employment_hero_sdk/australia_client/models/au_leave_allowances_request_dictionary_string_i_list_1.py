...
T = TypeVar("T", bound="AuLeaveAllowancesRequestDictionaryStringIList1")


@_attrs_define
class AuLeaveAllowancesRequestDictionaryStringIList1:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        au_leave_allowances_request_dictionary_string_i_list_1 = cls()
        ...
        au_leave_allowances_request_dictionary_string_i_list_1.additional_properties = additional_properties
        return au_leave_allowances_request_dictionary_string_i_list_1
