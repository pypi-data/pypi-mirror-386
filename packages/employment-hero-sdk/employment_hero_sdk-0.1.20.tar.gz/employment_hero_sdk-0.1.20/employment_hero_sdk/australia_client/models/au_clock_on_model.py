...
from ..models.au_clock_on_model_nullable_time_attendance_shift_note_visibility import (
    AuClockOnModelNullableTimeAttendanceShiftNoteVisibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AuClockOnModel")


@_attrs_define
class AuClockOnModel:
    """
    Attributes:
        ...
        note_visibility (Union[Unset, AuClockOnModelNullableTimeAttendanceShiftNoteVisibility]):
    """
    ...
    note_visibility: Union[Unset, AuClockOnModelNullableTimeAttendanceShiftNoteVisibility] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_note_visibility, Unset):
            ...
            note_visibility = AuClockOnModelNullableTimeAttendanceShiftNoteVisibility(_note_visibility)

        au_clock_on_model = cls(
        ...
        au_clock_on_model.additional_properties = d
        return au_clock_on_model
