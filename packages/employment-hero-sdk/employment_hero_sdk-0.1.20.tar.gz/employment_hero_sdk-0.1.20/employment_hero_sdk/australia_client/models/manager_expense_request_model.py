...
T = TypeVar("T", bound="ManagerExpenseRequestModel")


@_attrs_define
class ManagerExpenseRequestModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        manager_expense_request_model = cls(
        ...
        manager_expense_request_model.additional_properties = d
        return manager_expense_request_model
