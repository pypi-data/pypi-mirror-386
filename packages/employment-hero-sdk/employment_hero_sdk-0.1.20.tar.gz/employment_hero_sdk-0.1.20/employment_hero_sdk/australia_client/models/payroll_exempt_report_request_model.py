...
T = TypeVar("T", bound="PayrollExemptReportRequestModel")


@_attrs_define
class PayrollExemptReportRequestModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payroll_exempt_report_request_model = cls(
            state=state,
        ...
        payroll_exempt_report_request_model.additional_properties = d
        return payroll_exempt_report_request_model
