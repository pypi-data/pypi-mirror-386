...
T = TypeVar("T", bound="AuAcceptRosterShiftsResponseModel")


@_attrs_define
class AuAcceptRosterShiftsResponseModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        au_accept_roster_shifts_response_model = cls(
            shifts=shifts,
        ...
        au_accept_roster_shifts_response_model.additional_properties = d
        return au_accept_roster_shifts_response_model
