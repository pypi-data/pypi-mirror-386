...
T = TypeVar("T", bound="WhiteLabelReportSignupsRequestModel")


@_attrs_define
class WhiteLabelReportSignupsRequestModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        white_label_report_signups_request_model = cls(
        ...
        white_label_report_signups_request_model.additional_properties = d
        return white_label_report_signups_request_model
