...
T = TypeVar("T", bound="TimeAndAttendanceKioskModel")
...
class TimeAndAttendanceKioskModel:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_and_attendance_kiosk_model = cls(
            id=id,
        ...
        time_and_attendance_kiosk_model.additional_properties = d
        return time_and_attendance_kiosk_model
