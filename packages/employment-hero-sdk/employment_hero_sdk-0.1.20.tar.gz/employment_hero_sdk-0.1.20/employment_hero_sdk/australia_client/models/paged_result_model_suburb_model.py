...
T = TypeVar("T", bound="PagedResultModelSuburbModel")


@_attrs_define
class PagedResultModelSuburbModel:
    """
    Attributes:
        item_count_future (Union[Unset, IFutureValueInt32]):
        item_count (Union[Unset, int]):
        items (Union[Unset, List['SuburbModel']]):
    ...
    items: Union[Unset, List["SuburbModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = SuburbModel.from_dict(items_item_data)
        ...
        paged_result_model_suburb_model = cls(
        ...
        paged_result_model_suburb_model.additional_properties = d
        return paged_result_model_suburb_model
