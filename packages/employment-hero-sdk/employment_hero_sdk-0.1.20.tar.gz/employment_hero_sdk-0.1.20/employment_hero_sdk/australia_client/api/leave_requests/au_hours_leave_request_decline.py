...
from ...models.decline_leave_request import DeclineLeaveRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/api/v2/business/{business_id}/employee/{employee_id}/leaverequest/{leave_request_id}/decline",
    }

    if isinstance(body, DeclineLeaveRequest):
