...
from ...models.expense_request_response_model import ExpenseRequestResponseModel
...
) -> Optional[ExpenseRequestResponseModel]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ExpenseRequestResponseModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[ExpenseRequestResponseModel]:
    return Response(
