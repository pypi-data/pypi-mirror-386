...
from ...models.au_pay_categories_model import AuPayCategoriesModel
...
def _get_kwargs(
    ...
    *,
    ...
    request_group_by_earnings_location: Union[Unset, bool] = UNSET,
    ...
    params["request.groupByEarningsLocation"] = request_group_by_earnings_location
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/business/{business_id}/report/paycategories",
        "params": params,
    }
...
) -> Optional[List["AuPayCategoriesModel"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = AuPayCategoriesModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["AuPayCategoriesModel"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        request_group_by_earnings_location (Union[Unset, bool]):
    ...
    kwargs = _get_kwargs(
        ...
        request_group_by_earnings_location=request_group_by_earnings_location,
