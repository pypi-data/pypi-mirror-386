...
from ...models.super_contributions_report_export_model import SuperContributionsReportExportModel
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/business/{business_id}/report/supercontributions/bysuperfund",
        "params": params,
    }
...
) -> Optional[List["SuperContributionsReportExportModel"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = SuperContributionsReportExportModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["SuperContributionsReportExportModel"]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        List['SuperContributionsReportExportModel']
    """
