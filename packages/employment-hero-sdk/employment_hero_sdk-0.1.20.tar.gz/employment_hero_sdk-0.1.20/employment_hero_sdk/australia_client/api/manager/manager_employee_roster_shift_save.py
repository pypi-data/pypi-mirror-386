...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": f"/api/v2/business/{business_id}/manager/{employee_id}/rostershift/unavailability/{unavailability_id}",
    }
...
) -> Optional[ManagerUnavailabilityModel]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ManagerUnavailabilityModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[ManagerUnavailabilityModel]:
    return Response(
