...
T = TypeVar("T", bound="InvoiceQueryOptionsModel")


@_attrs_define
class InvoiceQueryOptionsModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_query_options_model = cls(
            from_date=from_date,
            to_date=to_date,
        )

        invoice_query_options_model.additional_properties = d
        return invoice_query_options_model
