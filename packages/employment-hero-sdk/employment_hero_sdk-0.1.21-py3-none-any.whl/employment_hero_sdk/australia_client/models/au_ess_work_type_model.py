...
from ..models.au_ess_work_type_model_au_employment_type_enum import AuEssWorkTypeModelAuEmploymentTypeEnum
from ..models.au_ess_work_type_model_nullable_work_type_mapping_type import (
    AuEssWorkTypeModelNullableWorkTypeMappingType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AuEssWorkTypeModel")


@_attrs_define
class AuEssWorkTypeModel:
    """
    Attributes:
        is_unit_based_work_type (Union[Unset, bool]):
        unit_type (Union[Unset, str]):
        employment_types (Union[Unset, List[AuEssWorkTypeModelAuEmploymentTypeEnum]]):
        ...
        mapping_type (Union[Unset, AuEssWorkTypeModelNullableWorkTypeMappingType]):
        short_code (Union[Unset, str]):
    """

    is_unit_based_work_type: Union[Unset, bool] = UNSET
    unit_type: Union[Unset, str] = UNSET
    employment_types: Union[Unset, List[AuEssWorkTypeModelAuEmploymentTypeEnum]] = UNSET
    ...
    mapping_type: Union[Unset, AuEssWorkTypeModelNullableWorkTypeMappingType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for employment_types_item_data in _employment_types or []:
            employment_types_item = AuEssWorkTypeModelAuEmploymentTypeEnum(employment_types_item_data)
        ...
        if isinstance(_mapping_type, Unset):
            ...
            mapping_type = AuEssWorkTypeModelNullableWorkTypeMappingType(_mapping_type)

        short_code = d.pop("shortCode", UNSET)

        au_ess_work_type_model = cls(
        ...
        au_ess_work_type_model.additional_properties = d
        return au_ess_work_type_model
