...
T = TypeVar("T", bound="TimesheetBreakManagerModel")


@_attrs_define
class TimesheetBreakManagerModel:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timesheet_break_manager_model = cls(
            id=id,
            start=start,
            end=end,
        ...
        timesheet_break_manager_model.additional_properties = d
        return timesheet_break_manager_model
