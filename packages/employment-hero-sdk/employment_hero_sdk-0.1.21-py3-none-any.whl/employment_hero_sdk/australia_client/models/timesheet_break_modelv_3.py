...
T = TypeVar("T", bound="TimesheetBreakModelv3")


@_attrs_define
class TimesheetBreakModelv3:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timesheet_break_modelv_3 = cls(
            start_time=start_time,
            end_time=end_time,
            is_paid_break=is_paid_break,
        )

        timesheet_break_modelv_3.additional_properties = d
        return timesheet_break_modelv_3
