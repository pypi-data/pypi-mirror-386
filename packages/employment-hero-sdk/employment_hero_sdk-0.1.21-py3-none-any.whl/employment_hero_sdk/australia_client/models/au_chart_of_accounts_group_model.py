...
if TYPE_CHECKING:
    from ..models.au_chart_of_accounts_default_accounts_model import AuChartOfAccountsDefaultAccountsModel
    from ..models.chart_of_accounts_category_model import ChartOfAccountsCategoryModel
    from ..models.chart_of_accounts_leave_category_model import ChartOfAccountsLeaveCategoryModel
    from ..models.chart_of_accounts_liability_category_model import ChartOfAccountsLiabilityCategoryModel


T = TypeVar("T", bound="AuChartOfAccountsGroupModel")


@_attrs_define
class AuChartOfAccountsGroupModel:
    """
    Attributes:
        default_accounts (Union[Unset, AuChartOfAccountsDefaultAccountsModel]):
        leave_categories (Union[Unset, List['ChartOfAccountsLeaveCategoryModel']]):
        pay_categories (Union[Unset, List['ChartOfAccountsCategoryModel']]):
        deduction_categories (Union[Unset, List['ChartOfAccountsLiabilityCategoryModel']]):
        employee_expense_categories (Union[Unset, List['ChartOfAccountsCategoryModel']]):
        employer_liability_categories (Union[Unset, List['ChartOfAccountsLiabilityCategoryModel']]):
    """

    default_accounts: Union[Unset, "AuChartOfAccountsDefaultAccountsModel"] = UNSET
    leave_categories: Union[Unset, List["ChartOfAccountsLeaveCategoryModel"]] = UNSET
    pay_categories: Union[Unset, List["ChartOfAccountsCategoryModel"]] = UNSET
    deduction_categories: Union[Unset, List["ChartOfAccountsLiabilityCategoryModel"]] = UNSET
    employee_expense_categories: Union[Unset, List["ChartOfAccountsCategoryModel"]] = UNSET
    employer_liability_categories: Union[Unset, List["ChartOfAccountsLiabilityCategoryModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_default_accounts, Unset):
            ...
            default_accounts = AuChartOfAccountsDefaultAccountsModel.from_dict(_default_accounts)

        leave_categories = []
        _leave_categories = d.pop("leaveCategories", UNSET)
        for leave_categories_item_data in _leave_categories or []:
            leave_categories_item = ChartOfAccountsLeaveCategoryModel.from_dict(leave_categories_item_data)
        ...
        for pay_categories_item_data in _pay_categories or []:
            pay_categories_item = ChartOfAccountsCategoryModel.from_dict(pay_categories_item_data)
        ...
        for deduction_categories_item_data in _deduction_categories or []:
            deduction_categories_item = ChartOfAccountsLiabilityCategoryModel.from_dict(deduction_categories_item_data)
        ...
        for employee_expense_categories_item_data in _employee_expense_categories or []:
            employee_expense_categories_item = ChartOfAccountsCategoryModel.from_dict(
        ...
        for employer_liability_categories_item_data in _employer_liability_categories or []:
            employer_liability_categories_item = ChartOfAccountsLiabilityCategoryModel.from_dict(
                employer_liability_categories_item_data
            )

            employer_liability_categories.append(employer_liability_categories_item)

        au_chart_of_accounts_group_model = cls(
        ...
        au_chart_of_accounts_group_model.additional_properties = d
        return au_chart_of_accounts_group_model
