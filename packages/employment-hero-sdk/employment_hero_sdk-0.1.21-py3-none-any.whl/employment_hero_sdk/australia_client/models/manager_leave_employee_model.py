...
T = TypeVar("T", bound="ManagerLeaveEmployeeModel")


@_attrs_define
class ManagerLeaveEmployeeModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        manager_leave_employee_model = cls(
        ...
        manager_leave_employee_model.additional_properties = d
        return manager_leave_employee_model
