...
from ..models.au_ess_roster_shift_model_nullable_shift_assignment_status_enum import (
...
T = TypeVar("T", bound="AuEssRosterShiftModel")


@_attrs_define
class AuEssRosterShiftModel:
    """
    Attributes:
        ...
        shift_assignment_status (Union[Unset, AuEssRosterShiftModelNullableShiftAssignmentStatusEnum]):
    """
    ...
    shift_assignment_status: Union[Unset, AuEssRosterShiftModelNullableShiftAssignmentStatusEnum] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_shift_assignment_status, Unset):
            ...
            shift_assignment_status = AuEssRosterShiftModelNullableShiftAssignmentStatusEnum(_shift_assignment_status)

        au_ess_roster_shift_model = cls(
        ...
        au_ess_roster_shift_model.additional_properties = d
        return au_ess_roster_shift_model
