...
from ..models.ess_unavailability_model_nullable_day_of_week import EssUnavailabilityModelNullableDayOfWeek
from ..models.ess_unavailability_model_nullable_day_of_week_flags_enum import (
    EssUnavailabilityModelNullableDayOfWeekFlagsEnum,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EssUnavailabilityModel")


@_attrs_define
class EssUnavailabilityModel:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        recurring_day (Union[Unset, EssUnavailabilityModelNullableDayOfWeek]):
        recurring_days (Union[Unset, EssUnavailabilityModelNullableDayOfWeekFlagsEnum]):
    ...
    recurring_day: Union[Unset, EssUnavailabilityModelNullableDayOfWeek] = UNSET
    recurring_days: Union[Unset, EssUnavailabilityModelNullableDayOfWeekFlagsEnum] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_recurring_day, Unset):
            ...
            recurring_day = EssUnavailabilityModelNullableDayOfWeek(_recurring_day)
        ...
        if isinstance(_recurring_days, Unset):
            ...
            recurring_days = EssUnavailabilityModelNullableDayOfWeekFlagsEnum(_recurring_days)
        ...
        ess_unavailability_model.additional_properties = d
        return ess_unavailability_model
