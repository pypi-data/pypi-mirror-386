...
from ..models.business_access_model_related_user_type import BusinessAccessModelRelatedUserType
...
T = TypeVar("T", bound="BusinessAccessModel")


@_attrs_define
class BusinessAccessModel:
    """
    Attributes:
        access_type (Union[Unset, BusinessAccessModelRelatedUserType]):
    ...
    access_type: Union[Unset, BusinessAccessModelRelatedUserType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_access_type, Unset):
            ...
            access_type = BusinessAccessModelRelatedUserType(_access_type)
        ...
        business_access_model.additional_properties = d
        return business_access_model
