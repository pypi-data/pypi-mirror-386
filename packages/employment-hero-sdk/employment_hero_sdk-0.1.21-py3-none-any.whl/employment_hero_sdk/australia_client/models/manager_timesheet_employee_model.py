...
T = TypeVar("T", bound="ManagerTimesheetEmployeeModel")


@_attrs_define
class ManagerTimesheetEmployeeModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        manager_timesheet_employee_model = cls(
        ...
        manager_timesheet_employee_model.additional_properties = d
        return manager_timesheet_employee_model
