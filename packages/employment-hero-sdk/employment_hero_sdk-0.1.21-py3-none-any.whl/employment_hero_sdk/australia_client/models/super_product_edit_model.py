...
from ..models.super_product_edit_model_external_service import SuperProductEditModelExternalService
from ..types import UNSET, Unset

T = TypeVar("T", bound="SuperProductEditModel")


@_attrs_define
class SuperProductEditModel:
    """
    Attributes:
        id (Union[Unset, int]):
        abn (Union[Unset, str]):
        ...
        source (Union[Unset, SuperProductEditModelExternalService]):
        ...
        super_details_default_fund_id (Union[Unset, int]):
    """
    ...
    source: Union[Unset, SuperProductEditModelExternalService] = UNSET
    ...
    super_details_default_fund_id: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        super_details_default_fund_id = self.super_details_default_fund_id
        ...
        if super_details_default_fund_id is not UNSET:
            field_dict["superDetailsDefaultFundId"] = super_details_default_fund_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = SuperProductEditModelExternalService(_source)
        ...
        super_details_default_fund_id = d.pop("superDetailsDefaultFundId", UNSET)

        super_product_edit_model = cls(
            id=id,
            abn=abn,
            ...
            super_details_default_fund_id=super_details_default_fund_id,
        )

        super_product_edit_model.additional_properties = d
        return super_product_edit_model
