...
from ..models.au_timesheet_line_model_external_service import AuTimesheetLineModelExternalService
...
T = TypeVar("T", bound="AuTimesheetLineModel")


@_attrs_define
class AuTimesheetLineModel:
    """
    Attributes:
        ...
        source (Union[Unset, AuTimesheetLineModelExternalService]):
    ...
    source: Union[Unset, AuTimesheetLineModelExternalService] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = AuTimesheetLineModelExternalService(_source)
        ...
        au_timesheet_line_model.additional_properties = d
        return au_timesheet_line_model
