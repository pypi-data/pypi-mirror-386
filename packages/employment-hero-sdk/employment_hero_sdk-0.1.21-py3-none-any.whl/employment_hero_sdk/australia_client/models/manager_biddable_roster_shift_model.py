...
from ..models.manager_biddable_roster_shift_model_nullable_shift_assignment_status_enum import (
    ManagerBiddableRosterShiftModelNullableShiftAssignmentStatusEnum,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.bidding_employee import BiddingEmployee
    from ..models.manager_current_roster_shift import ManagerCurrentRosterShift
...
T = TypeVar("T", bound="ManagerBiddableRosterShiftModel")


@_attrs_define
class ManagerBiddableRosterShiftModel:
    """
    Attributes:
        total_bidding_employees (Union[Unset, int]):
        bidding_employees (Union[Unset, List['BiddingEmployee']]):
        ...
        current_shift (Union[Unset, ManagerCurrentRosterShift]):
        id (Union[Unset, int]):
        ...
        shift_assignment_status (Union[Unset, ManagerBiddableRosterShiftModelNullableShiftAssignmentStatusEnum]):
    """

    total_bidding_employees: Union[Unset, int] = UNSET
    bidding_employees: Union[Unset, List["BiddingEmployee"]] = UNSET
    ...
    current_shift: Union[Unset, "ManagerCurrentRosterShift"] = UNSET
    ...
    shift_assignment_status: Union[Unset, ManagerBiddableRosterShiftModelNullableShiftAssignmentStatusEnum] = UNSET
    additional_properties: Dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> Dict[str, Any]:
        total_bidding_employees = self.total_bidding_employees

        bidding_employees: Union[Unset, List[Dict[str, Any]]] = UNSET
        if not isinstance(self.bidding_employees, Unset):
            bidding_employees = []
            for bidding_employees_item_data in self.bidding_employees:
                bidding_employees_item = bidding_employees_item_data.to_dict()
                bidding_employees.append(bidding_employees_item)
        ...
        field_dict.update({})
        if total_bidding_employees is not UNSET:
            field_dict["totalBiddingEmployees"] = total_bidding_employees
        if bidding_employees is not UNSET:
            field_dict["biddingEmployees"] = bidding_employees
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        total_bidding_employees = d.pop("totalBiddingEmployees", UNSET)

        bidding_employees = []
        _bidding_employees = d.pop("biddingEmployees", UNSET)
        for bidding_employees_item_data in _bidding_employees or []:
            bidding_employees_item = BiddingEmployee.from_dict(bidding_employees_item_data)
        ...
        if isinstance(_current_shift, Unset):
            ...
            current_shift = ManagerCurrentRosterShift.from_dict(_current_shift)
        ...
        if isinstance(_shift_assignment_status, Unset):
            ...
            shift_assignment_status = ManagerBiddableRosterShiftModelNullableShiftAssignmentStatusEnum(
                _shift_assignment_status
            )

        manager_biddable_roster_shift_model = cls(
            total_bidding_employees=total_bidding_employees,
            bidding_employees=bidding_employees,
        ...
        manager_biddable_roster_shift_model.additional_properties = d
        return manager_biddable_roster_shift_model
