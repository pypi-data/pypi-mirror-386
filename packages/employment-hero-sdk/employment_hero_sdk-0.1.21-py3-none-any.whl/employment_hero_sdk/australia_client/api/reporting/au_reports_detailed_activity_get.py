...
from ...models.au_detailed_activity_report_export_model import AuDetailedActivityReportExportModel
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/business/{business_id}/report/detailedactivity",
        "params": params,
    }
...
) -> Optional[List["AuDetailedActivityReportExportModel"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = AuDetailedActivityReportExportModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["AuDetailedActivityReportExportModel"]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        List['AuDetailedActivityReportExportModel']
    """
