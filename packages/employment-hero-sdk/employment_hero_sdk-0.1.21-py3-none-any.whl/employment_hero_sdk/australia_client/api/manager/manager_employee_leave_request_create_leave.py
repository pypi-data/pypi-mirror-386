...
from ...models.manager_leave_application_model import ManagerLeaveApplicationModel
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/api/v2/business/{business_id}/manager/{employee_id}/leaverequest",
    }

    if isinstance(body, ManagerLeaveApplicationModel):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        business_id (str):
        employee_id (int):
        body (ManagerLeaveApplicationModel):
        body (ManagerLeaveApplicationModel):
