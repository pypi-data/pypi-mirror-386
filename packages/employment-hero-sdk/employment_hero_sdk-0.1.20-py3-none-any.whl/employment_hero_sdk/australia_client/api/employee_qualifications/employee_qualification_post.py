...
from ...models.employee_qualification_request import EmployeeQualificationRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, EmployeeQualificationRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        business_id (str):
        employee_id (str):
        body (EmployeeQualificationRequest):
        body (EmployeeQualificationRequest):
