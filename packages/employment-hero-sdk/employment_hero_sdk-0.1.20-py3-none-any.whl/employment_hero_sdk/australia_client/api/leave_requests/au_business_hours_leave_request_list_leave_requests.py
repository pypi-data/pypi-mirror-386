...
from ...models.au_business_hours_leave_request_list_leave_requests_filter_group_by import (
    AuBusinessHoursLeaveRequestListLeaveRequestsFilterGroupBy,
)
from ...models.au_business_hours_leave_request_list_leave_requests_filter_status import (
...
def _get_kwargs(
    business_id: int,
    *,
    filter_status: Union[Unset, AuBusinessHoursLeaveRequestListLeaveRequestsFilterStatus] = UNSET,
    ...
    filter_group_by: Union[Unset, AuBusinessHoursLeaveRequestListLeaveRequestsFilterGroupBy] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/business/{business_id}/leaverequest",
        "params": params,
    }
...
) -> Optional[List["HourLeaveRequestResponseModel"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = HourLeaveRequestResponseModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["HourLeaveRequestResponseModel"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        business_id (int):
        filter_status (Union[Unset, AuBusinessHoursLeaveRequestListLeaveRequestsFilterStatus]):
        ...
        filter_group_by (Union[Unset, AuBusinessHoursLeaveRequestListLeaveRequestsFilterGroupBy]):
...
def sync(
    ...
    *,
    ...
    Returns:
        List['HourLeaveRequestResponseModel']
    """
