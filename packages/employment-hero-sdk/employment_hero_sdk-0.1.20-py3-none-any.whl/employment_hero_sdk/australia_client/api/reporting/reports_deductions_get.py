...
from ...models.deductions_report_export_model import DeductionsReportExportModel
...
def _get_kwargs(
    ...
    *,
    ...
    request_deduction_category_id: Union[Unset, int] = UNSET,
    request_disable_rollup_reporting: Union[Unset, bool] = UNSET,
    ...
    params["request.deductionCategoryId"] = request_deduction_category_id

    params["request.disableRollupReporting"] = request_disable_rollup_reporting
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/business/{business_id}/report/deductions",
        "params": params,
    }
...
) -> Optional[List["DeductionsReportExportModel"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = DeductionsReportExportModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["DeductionsReportExportModel"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        request_deduction_category_id (Union[Unset, int]):
        request_disable_rollup_reporting (Union[Unset, bool]):
    ...
    kwargs = _get_kwargs(
        ...
        request_deduction_category_id=request_deduction_category_id,
        request_disable_rollup_reporting=request_disable_rollup_reporting,
...
def sync(
    ...
    *,
    ...
    Returns:
        List['DeductionsReportExportModel']
    """
