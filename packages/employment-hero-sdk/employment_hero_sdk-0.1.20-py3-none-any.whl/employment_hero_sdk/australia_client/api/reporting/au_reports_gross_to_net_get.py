...
from ...models.au_reports_gross_to_net_get_request_filter_type import AuReportsGrossToNetGetRequestFilterType
...
def _get_kwargs(
    ...
    *,
    ...
    request_filter_type: Union[Unset, AuReportsGrossToNetGetRequestFilterType] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/business/{business_id}/report/grosstonet",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        request_filter_type (Union[Unset, AuReportsGrossToNetGetRequestFilterType]):
