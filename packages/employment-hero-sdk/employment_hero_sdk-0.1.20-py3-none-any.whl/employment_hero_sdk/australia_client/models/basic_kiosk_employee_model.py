...
from ..models.basic_kiosk_employee_model_time_attendance_status import BasicKioskEmployeeModelTimeAttendanceStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="BasicKioskEmployeeModel")


@_attrs_define
class BasicKioskEmployeeModel:
    """
    Attributes:
        ...
        status (Union[Unset, BasicKioskEmployeeModelTimeAttendanceStatus]):
    ...
    status: Union[Unset, BasicKioskEmployeeModelTimeAttendanceStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = BasicKioskEmployeeModelTimeAttendanceStatus(_status)
        ...
        basic_kiosk_employee_model = cls(
        ...
        basic_kiosk_employee_model.additional_properties = d
        return basic_kiosk_employee_model
