...
T = TypeVar("T", bound="CostingReportRequestModel")


@_attrs_define
class CostingReportRequestModel:
    """
    Attributes:
        show_zero_pay_categories (Union[Unset, bool]):
    ...
    show_zero_pay_categories: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        show_zero_pay_categories = self.show_zero_pay_categories
        ...
        field_dict.update({})
        if show_zero_pay_categories is not UNSET:
            field_dict["showZeroPayCategories"] = show_zero_pay_categories
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        show_zero_pay_categories = d.pop("showZeroPayCategories", UNSET)
        ...
        costing_report_request_model = cls(
            show_zero_pay_categories=show_zero_pay_categories,
        ...
        costing_report_request_model.additional_properties = d
        return costing_report_request_model
