...
T = TypeVar("T", bound="RosterShiftBreakApiModel")


@_attrs_define
class RosterShiftBreakApiModel:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        roster_shift_break_api_model = cls(
            id=id,
        ...
        roster_shift_break_api_model.additional_properties = d
        return roster_shift_break_api_model
