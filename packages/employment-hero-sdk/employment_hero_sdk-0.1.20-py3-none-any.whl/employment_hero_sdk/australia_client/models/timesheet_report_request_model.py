...
from ..models.timesheet_report_request_model_timesheet_line_status_type import (
    TimesheetReportRequestModelTimesheetLineStatusType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="TimesheetReportRequestModel")


@_attrs_define
class TimesheetReportRequestModel:
    """
    Attributes:
        employee_id (Union[Unset, int]):
        include_costs (Union[Unset, bool]):
        statuses (Union[Unset, List[TimesheetReportRequestModelTimesheetLineStatusType]]):
    ...
    statuses: Union[Unset, List[TimesheetReportRequestModelTimesheetLineStatusType]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for statuses_item_data in _statuses or []:
            statuses_item = TimesheetReportRequestModelTimesheetLineStatusType(statuses_item_data)
        ...
        timesheet_report_request_model = cls(
        ...
        timesheet_report_request_model.additional_properties = d
        return timesheet_report_request_model
