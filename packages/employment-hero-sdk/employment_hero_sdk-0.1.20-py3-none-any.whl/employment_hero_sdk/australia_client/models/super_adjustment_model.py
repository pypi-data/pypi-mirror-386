...
T = TypeVar("T", bound="SuperAdjustmentModel")


@_attrs_define
class SuperAdjustmentModel:
    """
    Attributes:
        notes (Union[Unset, str]):
        amount (Union[Unset, float]):
        contribution_type (Union[Unset, str]):
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contribution_type = d.pop("contributionType", UNSET)
        ...
        super_adjustment_model.additional_properties = d
        return super_adjustment_model
