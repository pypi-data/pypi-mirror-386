...
T = TypeVar("T", bound="EmployeeExpenseModelIDictionaryStringIList1")


@_attrs_define
class EmployeeExpenseModelIDictionaryStringIList1:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        employee_expense_model_i_dictionary_string_i_list_1 = cls()
        ...
        employee_expense_model_i_dictionary_string_i_list_1.additional_properties = additional_properties
        return employee_expense_model_i_dictionary_string_i_list_1
