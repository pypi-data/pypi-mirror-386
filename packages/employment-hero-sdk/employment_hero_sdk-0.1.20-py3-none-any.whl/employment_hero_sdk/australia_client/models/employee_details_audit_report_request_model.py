...
from ..models.employee_details_audit_report_request_model_nullable_employee_audit_section import (
    EmployeeDetailsAuditReportRequestModelNullableEmployeeAuditSection,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EmployeeDetailsAuditReportRequestModel")


@_attrs_define
class EmployeeDetailsAuditReportRequestModel:
    """
    Attributes:
        employee_id (Union[Unset, int]):
        section (Union[Unset, EmployeeDetailsAuditReportRequestModelNullableEmployeeAuditSection]):
    ...
    section: Union[Unset, EmployeeDetailsAuditReportRequestModelNullableEmployeeAuditSection] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_section, Unset):
            ...
            section = EmployeeDetailsAuditReportRequestModelNullableEmployeeAuditSection(_section)
        ...
        employee_details_audit_report_request_model = cls(
        ...
        employee_details_audit_report_request_model.additional_properties = d
        return employee_details_audit_report_request_model
