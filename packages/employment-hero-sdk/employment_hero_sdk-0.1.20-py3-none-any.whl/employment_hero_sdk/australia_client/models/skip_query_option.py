...
if TYPE_CHECKING:
    ...
    from ..models.skip_query_validator import SkipQueryValidator


T = TypeVar("T", bound="SkipQueryOption")
...
class SkipQueryOption:
    ...
    Attributes:
        ...
        validator (Union[Unset, SkipQueryValidator]):
    """

    context: Union[Unset, "ODataQueryContext"] = UNSET
    raw_value: Union[Unset, str] = UNSET
    value: Union[Unset, int] = UNSET
    validator: Union[Unset, "SkipQueryValidator"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_validator, Unset):
            ...
            validator = SkipQueryValidator.from_dict(_validator)

        skip_query_option = cls(
            context=context,
            raw_value=raw_value,
            value=value,
            validator=validator,
        ...
        skip_query_option.additional_properties = d
