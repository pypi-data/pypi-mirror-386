...
T = TypeVar("T", bound="PayRunEmployerLiabilityResponseDictionaryStringList1")


@_attrs_define
class PayRunEmployerLiabilityResponseDictionaryStringList1:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        pay_run_employer_liability_response_dictionary_string_list_1 = cls()
        ...
        pay_run_employer_liability_response_dictionary_string_list_1.additional_properties = additional_properties
        return pay_run_employer_liability_response_dictionary_string_list_1
