...
T = TypeVar("T", bound="ExpenseRequestLineItemModel")


@_attrs_define
class ExpenseRequestLineItemModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        expense_request_line_item_model = cls(
        ...
        expense_request_line_item_model.additional_properties = d
        return expense_request_line_item_model
