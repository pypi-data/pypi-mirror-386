...
T = TypeVar("T", bound="ChartOfAccountsLeaveCategoryModel")


@_attrs_define
class ChartOfAccountsLeaveCategoryModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        chart_of_accounts_leave_category_model = cls(
        ...
        chart_of_accounts_leave_category_model.additional_properties = d
        return chart_of_accounts_leave_category_model
