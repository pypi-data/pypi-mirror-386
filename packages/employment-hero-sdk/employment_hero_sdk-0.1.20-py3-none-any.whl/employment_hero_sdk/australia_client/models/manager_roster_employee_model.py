...
T = TypeVar("T", bound="ManagerRosterEmployeeModel")


@_attrs_define
class ManagerRosterEmployeeModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        manager_roster_employee_model = cls(
        ...
        manager_roster_employee_model.additional_properties = d
        return manager_roster_employee_model
