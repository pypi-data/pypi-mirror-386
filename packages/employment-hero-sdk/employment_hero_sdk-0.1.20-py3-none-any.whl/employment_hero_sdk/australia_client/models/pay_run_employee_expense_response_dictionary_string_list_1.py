...
T = TypeVar("T", bound="PayRunEmployeeExpenseResponseDictionaryStringList1")


@_attrs_define
class PayRunEmployeeExpenseResponseDictionaryStringList1:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        pay_run_employee_expense_response_dictionary_string_list_1 = cls()
        ...
        pay_run_employee_expense_response_dictionary_string_list_1.additional_properties = additional_properties
        return pay_run_employee_expense_response_dictionary_string_list_1
