...
T = TypeVar("T", bound="ExpenseRequestResponseModel")


@_attrs_define
class ExpenseRequestResponseModel:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        expense_request_response_model = cls(
            id=id,
        ...
        expense_request_response_model.additional_properties = d
        return expense_request_response_model
