...
from ..models.clock_off_model_nullable_time_attendance_shift_note_visibility import (
    ClockOffModelNullableTimeAttendanceShiftNoteVisibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ClockOffModel")
...
class ClockOffModel:
    ...
    Attributes:
        ...
        note_visibility (Union[Unset, ClockOffModelNullableTimeAttendanceShiftNoteVisibility]):
    """
    ...
    note_visibility: Union[Unset, ClockOffModelNullableTimeAttendanceShiftNoteVisibility] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_note_visibility, Unset):
            ...
            note_visibility = ClockOffModelNullableTimeAttendanceShiftNoteVisibility(_note_visibility)
        ...
        clock_off_model.additional_properties = d
        return clock_off_model
