...
T = TypeVar("T", bound="PaygReportRequestModel")


@_attrs_define
class PaygReportRequestModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payg_report_request_model.additional_properties = d
        return payg_report_request_model
