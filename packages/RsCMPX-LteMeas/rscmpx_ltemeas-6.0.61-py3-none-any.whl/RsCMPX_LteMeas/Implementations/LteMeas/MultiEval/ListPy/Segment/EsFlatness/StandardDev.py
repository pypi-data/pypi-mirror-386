...
class StandardDevCls:
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- 5 Ripple_1: float or bool: No parameter help available
			- 6 Ripple_2: float or bool: No parameter help available
			- 7 Max_R_1_Min_R_2: float or bool: No parameter help available
			- 8 Max_R_2_Min_R_1: float or bool: No parameter help available"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			ArgStruct.scalar_int('Seg_Reliability'),
			ArgStruct.scalar_int('Statist_Expired'),
