...
class ExtremeCls:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- 20 Tx_Power_Minimum: float: Minimum user equipment power
			- 21 Tx_Power_Maximum: float: Maximum user equipment power
			- 22 Peak_Power_Min: float: Minimum user equipment peak power
			- 23 Peak_Power_Max: float: Maximum user equipment peak power
			- 24 Psd_Minimum: float: No parameter help available
			- 25 Psd_Maximum: float: No parameter help available
			- 26 Evm_Dmrs_Low: float: EVM DMRS value, low EVM window position
			- 27 Evm_Dmrs_High: float: EVM DMRS value, high EVM window position
			- 28 Mag_Err_Dmrs_Low: float: Magnitude error DMRS value, low EVM window position
			- 29 Mag_Err_Dmrs_High: float: Magnitude error DMRS value, high EVM window position
			- 30 Ph_Error_Dmrs_Low: float: Phase error DMRS value, low EVM window position
			- 31 Ph_Error_Dmrs_High: float: Phase error DMRS value, high EVM window position"""
		__meta_args_list = [
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- 20 Tx_Power_Minimum: float or bool: Minimum user equipment power
			- 21 Tx_Power_Maximum: float or bool: Maximum user equipment power
			- 22 Peak_Power_Min: float or bool: Minimum user equipment peak power
			- 23 Peak_Power_Max: float or bool: Maximum user equipment peak power
			- 24 Psd_Minimum: float or bool: No parameter help available
			- 25 Psd_Maximum: float or bool: No parameter help available
			- 26 Evm_Dmrs_Low: float or bool: EVM DMRS value, low EVM window position
			- 27 Evm_Dmrs_High: float or bool: EVM DMRS value, high EVM window position
			- 28 Mag_Err_Dmrs_Low: float or bool: Magnitude error DMRS value, low EVM window position
			- 29 Mag_Err_Dmrs_High: float or bool: Magnitude error DMRS value, high EVM window position
			- 30 Ph_Error_Dmrs_Low: float or bool: Phase error DMRS value, low EVM window position
			- 31 Ph_Error_Dmrs_High: float or bool: Phase error DMRS value, high EVM window position"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			ArgStruct.scalar_int('Seg_Reliability'),
			ArgStruct.scalar_int('Statist_Expired'),
