...
class StandardDevCls:
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- 15 Frequency_Error: float or bool: No parameter help available
			- 16 Timing_Error: float or bool: No parameter help available
			- 17 Tx_Power: float or bool: No parameter help available
			- 18 Peak_Power: float or bool: No parameter help available"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			ArgStruct.scalar_int('Out_Of_Tolerance'),
