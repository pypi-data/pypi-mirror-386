...
class ExtremeCls:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- 5 Obw: float: Occupied bandwidth
			- 6 Tx_Power_Min: float: Minimum total TX power in the slot
			- 7 Tx_Power_Max: float: Maximum total TX power in the slot"""
		__meta_args_list = [
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- 3 Statist_Expired: int: Reached statistical length in slots
			- 4 Out_Of_Tolerance: int: Percentage of measured subframes with failed limit check
			- 5 Obw: float or bool: Occupied bandwidth
			- 6 Tx_Power_Min: float or bool: Minimum total TX power in the slot
			- 7 Tx_Power_Max: float or bool: Maximum total TX power in the slot"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			ArgStruct.scalar_int('Seg_Reliability'),
			ArgStruct.scalar_int('Statist_Expired'),
