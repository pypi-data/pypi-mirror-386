...
class StandardDevCls:
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- 3 Ripple_1: float or bool: No parameter help available
			- 4 Ripple_2: float or bool: No parameter help available
			- 5 Max_R_1_Min_R_2: float or bool: No parameter help available
			- 6 Max_R_2_Min_R_1: float or bool: No parameter help available"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			ArgStruct.scalar_int('Out_Of_Tolerance'),
