...
class StandardDevCls:
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- 5 Evm_Rms_Low: float or bool: No parameter help available
			- 6 Evm_Rms_High: float or bool: No parameter help available
			- 7 Evm_Peak_Low: float or bool: No parameter help available
			- 8 Evm_Peak_High: float or bool: No parameter help available
			- 9 Mag_Error_Rms_Low: float or bool: No parameter help available
			- 10 Mag_Error_Rms_High: float or bool: No parameter help available
			- 11 Mag_Error_Peak_Low: float or bool: No parameter help available
			- 12 Mag_Err_Peak_High: float or bool: No parameter help available
			- 13 Ph_Error_Rms_Low: float or bool: No parameter help available
			- 14 Ph_Error_Rms_High: float or bool: No parameter help available
			- 15 Ph_Error_Peak_Low: float or bool: No parameter help available
			- 16 Ph_Error_Peak_High: float or bool: No parameter help available
			- 17 Iq_Offset: float or bool: No parameter help available
			- 18 Frequency_Error: float or bool: No parameter help available
			- 19 Timing_Error: float or bool: No parameter help available
			- 20 Tx_Power: float or bool: No parameter help available
			- 21 Peak_Power: float or bool: No parameter help available
			- 22 Psd: float or bool: No parameter help available
			- 23 Evm_Dmrs_Low: float or bool: No parameter help available
			- 24 Evm_Dmrs_High: float or bool: No parameter help available
			- 25 Mag_Err_Dmrs_Low: float or bool: No parameter help available
			- 26 Mag_Err_Dmrs_High: float or bool: No parameter help available
			- 27 Ph_Error_Dmrs_Low: float or bool: No parameter help available
			- 28 Ph_Error_Dmrs_High: float or bool: No parameter help available"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			ArgStruct.scalar_int('Seg_Reliability'),
			ArgStruct.scalar_int('Statist_Expired'),
