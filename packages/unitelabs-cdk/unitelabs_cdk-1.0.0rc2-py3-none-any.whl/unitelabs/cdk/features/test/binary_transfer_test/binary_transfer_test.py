...
class BinaryTransferTest(sila.Feature):
    ...
    async def echo_binary_value(self, binary_value: bytes) -> bytes:
        ...
        .. parameter:: The Binary value to be returned.
        .. return:: The received Binary value transmitted in the same way it has been received.
        """

        return binary_value

    @sila.ObservableCommand()
    @sila.IntermediateResponse(name="Joint Binary")
    @sila.Response(name="Received Value")
    async def echo_binaries_observably(
        ...
        .. parameter:: List of binaries to echo
        .. yields:: Single binary from the parameter list
        .. return:: A single binary comprised of binaries received as parameter
        """
    ...
    @sila.UnobservableCommand()
    @sila.Response(name="Binary")
    @sila.Response(name="StringMetadata")
    async def echo_binary_and_metadata_string(
        ...
        .. parameter:: The binary to echo
        .. return:: The received binary
        .. return:: The received String Metadata
        """
