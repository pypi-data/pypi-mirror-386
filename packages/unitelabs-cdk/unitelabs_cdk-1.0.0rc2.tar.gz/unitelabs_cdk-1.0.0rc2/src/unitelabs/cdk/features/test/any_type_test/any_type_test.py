...
class AnyTypeTest(sila.Feature):
    ...
    @sila.Response(name="Received Any Type")
    ...
    async def set_any_type_value(
        ...
        .. parameter:: The Any type value to be set.
        .. return:: The type that has been received.
        .. return:: The value that has been received.
        """
    ...
    @sila.UnobservableProperty()
    def any_type_structure_value(self) -> sila.Any:
        """
