...
def handle_create(args):
    ...
    if os.path.exists(dest_dir):
        # print(f"{YELLOW}⚠️  Directory '{dest_dir}' already exists. Do you want to overwrite? (y/n){RESET}")
        if input(f"{YELLOW}⚠️  Directory '{dest_dir}' already exists. Do you want to overwrite? (y/n){RESET}").lower() not in ('y', 'yes'):
