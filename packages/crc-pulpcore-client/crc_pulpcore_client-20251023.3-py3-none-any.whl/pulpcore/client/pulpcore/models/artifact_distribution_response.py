...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "pulp_labels", "base_url", "content_guard", "hidden", "pulp_href", "base_path", "name", "pulp_last_updated", "prn", "pulp_created"]
