...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "pulp_created", "name", "no_content_change_since", "pulp_labels", "pulp_last_updated", "pulp_href", "prn", "content_guard", "base_path", "base_url"]
