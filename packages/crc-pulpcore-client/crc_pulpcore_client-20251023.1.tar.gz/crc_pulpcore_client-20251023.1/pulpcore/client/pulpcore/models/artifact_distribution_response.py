...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "name", "prn", "content_guard", "base_path", "base_url", "hidden", "pulp_labels", "no_content_change_since", "pulp_href", "pulp_last_updated"]
