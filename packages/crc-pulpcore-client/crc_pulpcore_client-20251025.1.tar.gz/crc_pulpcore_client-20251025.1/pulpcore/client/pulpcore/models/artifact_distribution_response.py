...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "pulp_href", "name", "content_guard", "no_content_change_since", "base_url", "hidden", "pulp_last_updated", "pulp_labels", "prn", "base_path"]
