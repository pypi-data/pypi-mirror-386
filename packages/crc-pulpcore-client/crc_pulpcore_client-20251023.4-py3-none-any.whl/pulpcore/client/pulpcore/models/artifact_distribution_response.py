...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "pulp_last_updated", "pulp_created", "base_url", "hidden", "content_guard", "name", "base_path", "pulp_href", "prn", "pulp_labels"]
