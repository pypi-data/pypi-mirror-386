...
static int import_capnp__lib__capnp(void) {
  ...
  if (!module) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "wrap_dynamic_struct_reader", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp_wrap_dynamic_struct_reader, "PyObject *( ::capnp::Response< ::capnp::DynamicStruct> &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "call_server_method", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp_call_server_method, " ::kj::Promise<void>  *(PyObject *, char *,  ::capnp::CallContext< ::capnp::DynamicStruct, ::capnp::DynamicStruct> &, PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "wrap_kj_exception", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp_wrap_kj_exception, "PyObject *( ::kj::Exception &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "wrap_kj_exception_for_reraise", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp_wrap_kj_exception_for_reraise, "PyObject *( ::kj::Exception &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "get_exception_info", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp_get_exception_info, "PyObject *(PyObject *, PyObject *, PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "promise_task_add_done_callback", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp_promise_task_add_done_callback, "void (PyObject *, PyObject *, ::kj::PromiseFulfiller<void> &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "promise_task_cancel", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp_promise_task_cancel, "void (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "_asyncio_stream_write_start", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp__asyncio_stream_write_start, "void (PyObject *,  ::kj::ArrayPtr< ::kj::ArrayPtr<uint8_t const >  const > , ::kj::PromiseFulfiller<void> &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "_asyncio_stream_write_stop", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp__asyncio_stream_write_stop, "void (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "_asyncio_stream_read_start", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp__asyncio_stream_read_start, "void (PyObject *, void *, size_t, size_t,  ::kj::PromiseFulfiller<size_t>  &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "_asyncio_stream_read_stop", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp__asyncio_stream_read_stop, "void (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "_asyncio_stream_shutdown_write", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp__asyncio_stream_shutdown_write, "void (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "_asyncio_stream_close", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp__asyncio_stream_close, "void (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_5(module, "make_async_message_reader", (void (**)(void))&__pyx_api_f_5capnp_3lib_5capnp_make_async_message_reader, "PyObject *( ::kj::Own< ::capnp::MessageReader> )") < 0) goto bad;
