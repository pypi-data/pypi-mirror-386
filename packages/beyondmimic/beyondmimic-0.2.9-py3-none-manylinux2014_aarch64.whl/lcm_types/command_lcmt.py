...
class command_lcmt(object):
    ...
    def __init__(self):
        self.command = [ 0.0 for dim0 in range(7) ]
        """ LCM Type: double[7] """
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack('>7d', *self.command[:7]))
    ...
    def _decode_one(buf):
        self = command_lcmt()
        self.command = struct.unpack('>7d', buf.read(56))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if command_lcmt in parents: return 0
        tmphash = (0x507a292ea92a57d3) & 0xffffffffffffffff
