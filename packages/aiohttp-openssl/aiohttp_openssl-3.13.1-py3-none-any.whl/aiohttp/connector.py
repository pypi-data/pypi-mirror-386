...
import aiohappyeyeball
from aiohappyeyeball import AddrInfoType, SocketFactoryType
...
class TCPConnector(BaseConnector):
    ...
    def __init__(
        ...
        *,
        ...
        self._family = family
        self._local_addr_infos = aiohappyeyeball.addr_to_addr_infos(local_addr)
        ...
        **kwargs: Any,
        ...
        try:
            async with ceil_timeout(
                ...
                sock = await aiohappyeyeball.start_connection(
        ...
        *,
        ...
        while addr_infos:
            ...
            try:
                ...
                last_exc = exc
                aiohappyeyeball.pop_addr_infos_interleave(addr_infos, self._interleave)
                continue
            ...
            if req.is_ssl() and fingerprint:
                try:
                    ...
                    aiohappyeyeball.remove_addr_infos(addr_infos, bad_peer)
                    continue
