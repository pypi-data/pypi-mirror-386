...
const Navigation = {
            ...
            <div class="row">
                <div class="col-12">
                    <div id="ready_documents" class="d-flex justify-content-end mb-3">
                        <a href="/plugins/test-plan-exporter/documents-list/" class="btn btn-outline-primary">Готовые документы</a>
                    </div>
                </div>
            </div>
    ...
    generateDocument: async () => {
        try {
            ...
            Navigation.showResultMessage('success', `Документ принят в обработку. Смотрите результат на <a href="/plugins/test-plan-exporter/documents-list/">странице</a> скачиваний.`);
