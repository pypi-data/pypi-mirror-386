...
FOOTER_IMAGE = 'test_plan_megaexporter/img/report_footer_title.png'
...
class FontManager:
    ...
    _fonts: dict = {
        regular: 'test_plan_megaexporter/fonts/Inter-VariableFont.ttf',
        bold: 'test_plan_megaexporter/fonts/Inter-VariableFont.ttf',
        italic: 'test_plan_megaexporter/fonts/Inter-VariableFont.ttf',
        emoji: 'test_plan_megaexporter/fonts/Inter-VariableFont.ttf',
    }
