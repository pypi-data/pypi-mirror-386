...
class PeopleSchema(BrynQPanderaDataFrameModel):
    ...
    payroll_salary_yearly_payment_currency: Optional[Series[Float]] = pa.Field(coerce=True, nullable=True, description="Base salary (yearly)", alias="payroll.salary.yearlyPayment.currency")
