    ...
    try:
        ...
        with Image.open(source_icon) as img:
            ...
            for density, size in densities.items():
                ...
                # ALSO: Create adaptive icon XML to prevent white background
...
<adaptive-icon xmlns:android="http://schemas.android.com/apk/res/android">
    ...
    <foreground android:drawable="@mipmap/ic_launcher_foreground"/>
                ...
                # Only create this in the main mipmap folder to avoid duplicates
                if density == "mipmap-anydpi-v26":
                    adaptive_xml_dir = res_dir / density
                    adaptive_xml_dir.mkdir(parents=True, exist_ok=True)
                    adaptive_xml_path = adaptive_xml_dir / "ic_launcher.xml"
