...
class PipelineExecuteApi(object):
    ...
    def mark_manual_execution(self, body, account_identifier, org_identifier, project_identifier, plan_execution_id, callback_id, **kwargs):  # noqa: E501
        """Marks the Manual Execution as fail or resume  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mark_manual_execution(body, account_identifier, org_identifier, project_identifier, plan_execution_id, callback_id, async_req=True)
        >>> result = thread.get()
        ...
        :param str org_identifier: Organization Identifier for the Entity. (required)
        :param str project_identifier: Project Identifier for the Entity. (required)
        :param str plan_execution_id: The Pipeline Execution Id on which the manual execution action is required (required)
        :param str callback_id: Callback id on which the manual execution action is required (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.mark_manual_execution_with_http_info(body, account_identifier, org_identifier, project_identifier, plan_execution_id, callback_id, **kwargs)  # noqa: E501
        else:
            (data) = self.mark_manual_execution_with_http_info(body, account_identifier, org_identifier, project_identifier, plan_execution_id, callback_id, **kwargs)  # noqa: E501
            return data

    def mark_manual_execution_with_http_info(self, body, account_identifier, org_identifier, project_identifier, plan_execution_id, callback_id, **kwargs):  # noqa: E501
        """Marks the Manual Execution as fail or resume  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mark_manual_execution_with_http_info(body, account_identifier, org_identifier, project_identifier, plan_execution_id, callback_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'account_identifier', 'org_identifier', 'project_identifier', 'plan_execution_id', 'callback_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('plan_execution_id' not in params or
                params['plan_execution_id'] is None):
            raise ValueError("Missing the required parameter `plan_execution_id` when calling `mark_manual_execution`")  # noqa: E501
        # verify the required parameter 'callback_id' is set
        if ('callback_id' not in params or
                params['callback_id'] is None):
            raise ValueError("Missing the required parameter `callback_id` when calling `mark_manual_execution`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pipeline/api/pipeline/execute/manualExecution/{planExecutionId}/{callbackId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
