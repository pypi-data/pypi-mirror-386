...
class ImpactedTarget(object):
    ...
    def __init__(self, exemption_id=None, exemption_status=None, id=None, last_detected=None, name=None, num_occurrences=None, user_id=None, variant_name=None):  # noqa: E501
