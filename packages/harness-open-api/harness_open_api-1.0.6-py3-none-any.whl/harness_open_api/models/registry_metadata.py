...
class RegistryMetadata(object):
    ...
    def __init__(self, artifacts_count=None, description=None, downloads_count=None, identifier=None, labels=None, last_modified=None, package_type=None, path=None, registry_size=None, type=None, url=None):  # noqa: E501
