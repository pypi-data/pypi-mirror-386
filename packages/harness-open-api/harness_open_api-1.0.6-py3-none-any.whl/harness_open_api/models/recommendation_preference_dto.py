...
class RecommendationPreferenceDTO(object):
    ...
    def __init__(self, applied_recommendation_presets=None, child_recommendation=None, include_ignored_recommendation=None, look_back_period=None, parent_recommendation=None):  # noqa: E501
