...
class Budget(object):
    ...
    def __init__(self, account_id=None, actual_cost=None, alert_thresholds=None, budget_amount=None, budget_history=None, budget_monthly_breakdown=None, created_at=None, created_by=None, disable_currency_warning=None, email_addresses=None, end_time=None, forecast_cost=None, growth_rate=None, is_ng_budget=None, last_month_cost=None, last_updated_at=None, last_updated_by=None, name=None, ng_budget=None, notify_on_slack=None, parent_budget_group_id=None, period=None, scope=None, start_time=None, type=None, user_group_ids=None, uuid=None):  # noqa: E501
