...
class DockerArtifactDetail(object):
    ...
    def __init__(self, created_at=None, downloads_count=None, image_name=None, modified_at=None, package_type=None, pull_command=None, registry_path=None, size=None, url=None, version=None):  # noqa: E501
