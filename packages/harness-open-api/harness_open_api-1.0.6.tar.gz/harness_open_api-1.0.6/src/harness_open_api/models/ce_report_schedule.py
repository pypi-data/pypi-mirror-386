...
class CEReportSchedule(object):
    ...
    def __init__(self, account_id=None, created_at=None, created_by=None, description=None, enabled=None, last_updated_at=None, last_updated_by=None, name=None, next_execution=None, recipients=None, user_cron=None, user_cron_time_zone=None, uuid=None, views_id=None):  # noqa: E501
