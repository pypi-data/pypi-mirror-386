...
class AuditFilterProperties(object):
    ...
    def modules(self, modules):
        ...
        :type: list[str]
        """
        allowed_values = ["CD", "CI", "CV", "CF", "CE", "STO", "CHAOS", "AI_TEST_AUTOMATION", "SRM", "IACM", "CET", "IDP", "CODE", "SSCA", "CORE", "PMS", "TEMPLATESERVICE", "RMG", "GOVERNANCE", "PLATFORM", "SEI", "HAR", "DevopsEssentials", "FME", "DBOPS"]  # noqa: E501
