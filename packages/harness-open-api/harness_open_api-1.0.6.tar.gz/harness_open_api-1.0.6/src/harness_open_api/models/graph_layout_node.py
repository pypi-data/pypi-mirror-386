...
class GraphLayoutNode(object):
    ...
    def __init__(self, barrier_found=None, created_at=None, edge_layout_list=None, end_ts=None, execution_input_configured=None, failure_info=None, failure_info_dto=None, hidden=None, is_rollback_stage_node=None, module=None, module_info=None, name=None, node_execution_id=None, node_group=None, node_identifier=None, node_run_info=None, node_type=None, node_uuid=None, skip_info=None, start_ts=None, status=None, step_details=None, strategy_metadata=None):  # noqa: E501
