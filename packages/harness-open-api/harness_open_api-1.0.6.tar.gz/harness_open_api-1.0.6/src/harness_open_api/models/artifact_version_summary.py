...
class ArtifactVersionSummary(object):
    ...
    def __init__(self, image_name=None, package_type=None, ssca_artifact_id=None, ssca_artifact_source_id=None, sto_execution_id=None, sto_pipeline_id=None, version=None):  # noqa: E501
