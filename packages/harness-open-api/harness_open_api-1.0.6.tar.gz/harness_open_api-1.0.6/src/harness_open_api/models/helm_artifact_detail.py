...
class HelmArtifactDetail(object):
    ...
    def __init__(self, artifact=None, created_at=None, downloads_count=None, modified_at=None, package_type=None, pull_command=None, registry_path=None, size=None, url=None, version=None):  # noqa: E501
