...
class Registry(object):
    ...
    def __init__(self, allowed_pattern=None, blocked_pattern=None, cleanup_policy=None, config=None, created_at=None, description=None, identifier=None, labels=None, modified_at=None, package_type=None, scanners=None, url=None):  # noqa: E501
