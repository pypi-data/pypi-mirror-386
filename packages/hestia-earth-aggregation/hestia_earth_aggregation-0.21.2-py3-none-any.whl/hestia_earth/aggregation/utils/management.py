...
def filter_management(blank_nodes: list, start_year: int = None, end_year: int = None):
    def update_dates(blank_node: dict):
        ...
        return blank_node | (
            ...
            if start_year and start_date and start_date.year < (start_year - TIME_PERIOD) else {}
        ) | (
    ...
    return [
        ...
        if not start_year or not end_year or match_dates(v, start_year - TIME_PERIOD, end_year)
    ]
