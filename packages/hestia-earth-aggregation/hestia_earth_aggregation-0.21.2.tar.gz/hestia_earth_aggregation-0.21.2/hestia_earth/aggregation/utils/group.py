...
from .blank_node import filter_blank_nodes, should_aggregate_blank_node, group_by_term_id
...
def _filter_blank_nodes(node: dict, list_key: str, start_year: int, end_year: int):
    ...
    blank_nodes = _FILTER_BLANK_NODES.get(list_key, _filter_default)(blank_nodes, start_year, end_year)
    return [
