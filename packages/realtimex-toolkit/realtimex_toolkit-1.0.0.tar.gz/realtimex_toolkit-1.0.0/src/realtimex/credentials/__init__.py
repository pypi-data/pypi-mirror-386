...
from realtimex.credentials.manager import CredentialManager
from realtimex.credentials.models import CredentialBundle, CredentialType
...
async def get_credential(
    ...
    *,
    ...
    Example:
        >>> bundle = await get_credential("cred-123", api_key="your-api-key")
    ...
    try:
        bundle = await manager.get(credential_id, force_refresh=force_refresh)
