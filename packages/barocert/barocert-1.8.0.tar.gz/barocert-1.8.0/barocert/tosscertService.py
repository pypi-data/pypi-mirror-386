...
class TosscertService(BaseService):
    ...
    # 본인확인 요청
    def requestUserIdentity(self, clientCode, identity):
        ...
        if String.isNullorEmpty(identity):
            raise BarocertException(-99999999, "본인확인 서명요청 정보가 입력되지 않았습니다.")
        ...
        return self._httppost('/TOSS/UserIdentity/' + clientCode, postData)

    # 본인확인 상태확인
    def getUserIdentityStatus(self, clientCode, receiptID):
        ...
        return self._httpget('/TOSS/UserIdentity/' + clientCode + '/' + receiptID )

    # 본인확인 검증
    def verifyUserIdentity(self, clientCode, receiptID):
        ...
        return self._httppost('/TOSS/UserIdentity/Verify/' + clientCode + '/' + receiptID )
    ...
    def requestIdentity(self, clientCode, identity):
        ...
        return self._httppost('/TOSS/Identity/' + clientCode, postData)
    ...
    def getIdentityStatus(self, clientCode, receiptID):
        ...
        return self._httpget('/TOSS/Identity/' + clientCode + '/' + receiptID )
    ...
    def verifyIdentity(self, clientCode, receiptID):
        ...
        return self._httppost('/TOSS/Identity/Verify/' + clientCode + '/' + receiptID )
    ...
    def requestSign(self, clientCode, sign):
        ...
        return self._httppost('/TOSS/Sign/' + clientCode, postData)
    ...
    def getSignStatus(self, clientCode, receiptID):
        ...
        return self._httpget('/TOSS/Sign/' + clientCode + '/' + receiptID)
    ...
    def verifySign(self, clientCode, receiptID):
        ...
        return self._httppost('/TOSS/Sign/Verify/' + clientCode + '/' + receiptID)
    ...
    def requestMultiSign(self, clientCode, multiSign):
        ...
        return self._httppost('/TOSS/MultiSign/' + clientCode, postData)
    ...
    def getMultiSignStatus(self, clientCode, receiptID):
        ...
        return self._httpget('/TOSS/MultiSign/' + clientCode + '/' + receiptID)
    ...
    def verifyMultiSign(self, clientCode, receiptID):
        ...
        return self._httppost('/TOSS/MultiSign/Verify/' + clientCode + '/' + receiptID)
    ...
    def requestCMS(self, clientCode, cms):
        ...
        return self._httppost('/TOSS/CMS/' + clientCode, postData)
    ...
    def getCMSStatus(self, clientCode, receiptID):
        ...
        return self._httpget('/TOSS/CMS/' + clientCode + '/' + receiptID )
    ...
    def verifyCMS(self, clientCode, receiptID):
        ...
        return self._httppost('/TOSS/CMS/Verify/' + clientCode + '/' + receiptID )
...
class TossUserIdentity(object):
    def __init__(self, **kwargs):
        self.__dict__ = kwargs

class TossIdentity(object):
    def __init__(self, **kwargs):
        self.__dict__ = kwargs
        
class TossSign(object):
    def __init__(self, **kwargs):
        self.__dict__ = kwargs

class TossMultiSign(object):
    def __init__(self, **kwargs):
        self.__dict__ = kwargs

class TossMultiSignTokens(object):
    def __init__(self, **kwargs):
        self.__dict__ = kwargs

class TossCMS(object):
    def __init__(self, **kwargs):
        self.__dict__ = kwargs
