...
from wfx.utils.util import detect_container_environment, get_container_host, transform_localhost_url
...
class TestGetContainerHost:
    ...
    def test_returns_none_when_not_in_container(self):
        ...
        with patch("wfx.utils.util.detect_container_environment", return_value=None):
    ...
    def test_returns_docker_internal_when_resolvable(self):
        ...
        with (
            patch("wfx.utils.util.detect_container_environment", return_value="docker"),
    ...
    def test_returns_containers_internal_when_docker_internal_fails(self):
        ...
        with (
            patch("wfx.utils.util.detect_container_environment", return_value="podman"),
            patch("socket.getaddrinfo") as mock_getaddrinfo,
        ):
...
class TestTransformLocalhostUrl:
    ...
    def test_returns_original_url_when_not_in_container(self):
        ...
        with patch("wfx.utils.util.get_container_host", return_value=None):
    ...
    def test_transforms_localhost_to_docker_internal(self):
        ...
        with patch("wfx.utils.util.get_container_host", return_value="host.docker.internal"):
            url = "http://localhost:5001/api"
            result = transform_localhost_url(url)
    ...
    def test_transforms_localhost_to_containers_internal(self):
        ...
        with patch("wfx.utils.util.get_container_host", return_value="host.containers.internal"):
            url = "http://localhost:5001/api"
            result = transform_localhost_url(url)
    ...
    def test_transforms_localhost_to_gateway_ip_on_linux(self):
        ...
        with patch("wfx.utils.util.get_container_host", return_value="172.17.0.1"):
            url = "http://localhost:5001/api"
            result = transform_localhost_url(url)
