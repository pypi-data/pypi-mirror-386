...
if TYPE_CHECKING:
    from wfx.components.embeddings.similarity import EmbeddingSimilarityComponent
    from wfx.components.embeddings.text_embedder import TextEmbedderComponent
