...
class FfiRequest(google.protobuf.message.Message):
    """**How is the liveai-ffi working:
    We refer as the ffi server the Rust server that is running the LiveAI client implementation, and we
    refer as the ffi client the foreign language that commumicates with the ffi server. (e.g Python SDK, Unity SDK, etc...)

    We expose the Rust client implementation of liveai using the protocol defined here.
    ...
    **Useful things know when collaborating on the protocol:**
    ...
    This is the input of liveai_ffi_request function
...
class FfiResponse(google.protobuf.message.Message):
    """This is the output of liveai_ffi_request function."""
...
class LogRecord(google.protobuf.message.Message):
    ...
    target: builtins.str
    """e.g "liveai", "libwebrtc", "tokio-tungstenite", etc..."""
