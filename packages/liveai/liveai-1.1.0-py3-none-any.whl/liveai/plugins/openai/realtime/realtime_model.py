...
from liveai.agents import APIConnectionError, APIError, io, llm, utils
from liveai.agents.llm.tool_context import (
    get_function_info,
    get_raw_function_info,
    is_function_tool,
    is_raw_function_tool,
)
from liveai.agents.metrics import RealtimeModelMetrics
from liveai.agents.metrics.base import Metadata
from liveai.agents.types import (
    DEFAULT_API_CONNECT_OPTIONS,
    NOT_GIVEN,
    APIConnectOptions,
    NotGivenOr,
)
from liveai.agents.utils import is_given
...
from .utils import (
    ...
    liveai_item_to_openai_item,
    openai_item_to_liveai_item,
    ...
    def __init__(
        ...
        *,
        ...
        Examples:
            ...
            ```python
            from liveai.plugins.openai.realtime import RealtimeModel
            from openai.types import realtime
...
class RealtimeSession(
    ...
    async def _create_ws_conn(self) -> aiohttp.ClientWebSocketResponse:
        headers = {"User-Agent": "LiveAI Agents"}
        ...
        def _create_item(previous_msg_id: str | None, msg_id: str) -> None:
            ...
            events.append(
                ConversationItemCreateEvent(
                    ...
                    item=liveai_item_to_openai_item(chat_item),
    ...
    def push_video(self, frame: rtc.VideoFrame) -> None:
        ...
        oai_item = liveai_item_to_openai_item(message)
        self.send_event(
            ConversationItemCreateEvent(
                type="conversation.item.create",
                item=oai_item,
    ...
    def _handle_conversion_item_added(self, event: ConversationItemAdded) -> None:
        ...
        try:
            self._remote_chat_ctx.insert(
                event.previous_item_id, openai_item_to_liveai_item(event.item)
            )
