        ...
        def _create_item(previous_msg_id: str | None, msg_id: str) -> None:
            ...
            events.append(
                ConversationItemCreateEvent(
                    ...
                    item=_liveai_item_to_openai_item(chat_item),
    ...
    def _handle_conversion_item_created(self, event: ConversationItemCreatedEvent) -> None:
        ...
        try:
            self._remote_chat_ctx.insert(
                event.previous_item_id, _openai_item_to_liveai_item(event.item)
            )
...
def _liveai_item_to_openai_item(item: llm.ChatItem) -> ConversationItem:
...
def _openai_item_to_liveai_item(item: ConversationItem) -> llm.ChatItem:
