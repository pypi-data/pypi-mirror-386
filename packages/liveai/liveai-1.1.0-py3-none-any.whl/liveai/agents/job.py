...
from liveai.api.access_token import Claims
...
class JobContext:
    ...
    def api(self) -> api.LiveAIAPI:
        """Returns an LiveAIAPI for making API calls to LiveAI.
        ...
        LIVEAI_URL, LIVEAI_API_KEY, and LIVEAI_API_SECRET so this API is always
        usable inside job entrypoints.
        """
        return api.LiveAIAPI(session=http_context.http_session())
    ...
    def add_sip_participant(
        ...
        *,
        ...
        Make sure you have an outbound SIP trunk created in LiveAI.
        See https://docs.liveai.io/sip/trunk-outbound/ for more information.
        """
        if cli.CLI_ARGUMENTS is not None and cli.CLI_ARGUMENTS.console:
    ...
    def transfer_sip_participant(
        ...
        See https://docs.liveai.io/sip/transfer-cold/ for more information.
        """
        if cli.CLI_ARGUMENTS is not None and cli.CLI_ARGUMENTS.console:
            logger.warning(
...
class JobRequest:
    ...
    async def accept(
        ...
        *,
        ...
        """Accept the job request, and start the job if the LiveAI SFU assigns the job to our worker."""  # noqa: E501
        if not identity:
