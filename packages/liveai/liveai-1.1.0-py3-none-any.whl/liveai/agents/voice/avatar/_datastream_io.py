...
RPC_CLEAR_BUFFER = "la.clear_buffer"
RPC_PLAYBACK_FINISHED = "la.playback_finished"
AUDIO_STREAM_TOPIC = "la.audio_stream"


class DataStreamAudioOutput(AudioOutput):
    """
    AudioOutput implementation that streams audio to a remote avatar worker using LiveAI DataStream.
    """  # noqa: E501
...
class DataStreamAudioReceiver(AudioReceiver):
    """
    Audio receiver that receives streamed audio from a sender participant using LiveAI DataStream.
