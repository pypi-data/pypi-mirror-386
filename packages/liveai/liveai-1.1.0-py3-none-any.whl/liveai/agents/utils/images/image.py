...
def import_pil() -> None:
    try:
        ...
        raise ImportError(
            "You haven't included the 'images' optional dependencies. Please install the 'codecs' extra by running `pip install liveai-agents[images]`"  # noqa: E501
        ) from None
