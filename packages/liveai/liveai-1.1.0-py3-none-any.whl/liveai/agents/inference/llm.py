...
la_oai_debug = int(os.getenv("LA_OPENAI_DEBUG", 0))
...
class LLM(llm.LLM):
    def __init__(
        ...
        *,
        ...
        la_base_url = (
            base_url if base_url else os.environ.get("LIVEAI_INFERENCE_URL", DEFAULT_BASE_URL)
        )
...
class LLMStream(llm.LLMStream):
    ...
    async def _run(self) -> None:
        ...
        try:
            ...
            if self._provider:
                ...
                headers["X-LiveAI-Inference-Provider"] = self._provider
    ...
    def _parse_choice(
        ...
        # https://github.com/liveai/agents/issues/688
