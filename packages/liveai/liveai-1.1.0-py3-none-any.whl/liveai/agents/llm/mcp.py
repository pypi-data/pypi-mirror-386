...
try:
    ...
    raise ImportError(
        ...
        "To fix this, install the optional dependency: pip install 'liveai-agents[mcp]'"
    ) from e
...
class MCPServer(ABC):
    def __init__(self, *, client_session_timeout_seconds: float) -> None:
        ...
        self._la_tools: list[MCPTool] | None = None
    ...
    async def list_tools(self) -> list[MCPTool]:
        ...
        if not self._cache_dirty and self._la_tools is not None:
            return self._la_tools
