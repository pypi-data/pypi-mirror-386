...
def room_html(url: str, token: str, *, width: str, height: str) -> HTML:
    """
    Generate the HTML needed to embed a LiveAI room.

    Args:
        url (str): The LiveAI room URL.
        token (str): The LiveAI join token.
    ...
    """
    token_placeholder = "##liveai-token-placeholder##"
    url_placeholder = "##liveai-url-placeholder##"

    index_path = files("liveai.rtc.resources") / "jupyter-html" / "index.html"
...
def display_room(url: str, token: str, *, width: str = "100%", height: str = "110px") -> None:
    """
    Display a LiveAI room in a Jupyter notebook or Google Colab.
