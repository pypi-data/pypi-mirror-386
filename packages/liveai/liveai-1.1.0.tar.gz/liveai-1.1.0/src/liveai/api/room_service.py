...
from liveai.protocol.models import Room, ParticipantInfo
...
class RoomService(Service):
    """Client for LiveAI RoomService API
    ...
    laapi = api.LiveAIAPI()
    room_service = laapi.room
    ```

    Also see https://docs.liveai.io/home/server/managing-rooms/ and https://docs.liveai.io/home/server/managing-participants/
    """
    ...
    async def update_room_metadata(self, update: UpdateRoomMetadataRequest) -> Room:
        """Updates a room's [metadata](https://docs.liveai.io/home/client/data/room-metadata/).
    ...
    async def forward_participant(self, forward: ForwardParticipantRequest) -> None:
        ...
        This feature is only available for LiveAI Cloud/Private Cloud.
