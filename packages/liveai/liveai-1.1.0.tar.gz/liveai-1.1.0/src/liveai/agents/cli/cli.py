...
def run_app(
    ...
    *,
    ...
    @click.option(
        "--url",
        envvar="LIVEAI_URL",
        help="LiveAI server or Cloud project's websocket URL",
    )
    @click.option(
        "--api-key",
        envvar="LIVEAI_API_KEY",
        help="LiveAI server or Cloud project's API key",
    )
    @click.option(
        "--api-secret",
        envvar="LIVEAI_API_SECRET",
        help="LiveAI server or Cloud project's API secret",
    )
    @click.option(
        "--drain-timeout",
        type=int,
