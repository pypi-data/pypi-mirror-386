...
PROC_INITIALIZE_TIME = prometheus_client.Histogram(
    "la_agents_proc_initialize_duration_seconds",
...
RUNNING_JOB_GAUGE = prometheus_client.Gauge(
    "la_agents_active_job_count", "Active jobs", ["nodename"]
)

CHILD_PROC_GAUGE = prometheus_client.Gauge(
    "la_agents_child_process_count", "Total number of child processes", ["nodename"]
)
