...
class FFMPEG_info:
    ...
    def set(self):
        ...
        ffmpeg_installed = misc.askquestion(dialog_title='FFMPEG Check',
                                           Question='Is FFMPEG installed?')

        if ffmpeg_installed:
            ffmpeg_dir = misc.get_dir(dialog_title='Please select the directory where FFMPEG (binary) is installed:')
