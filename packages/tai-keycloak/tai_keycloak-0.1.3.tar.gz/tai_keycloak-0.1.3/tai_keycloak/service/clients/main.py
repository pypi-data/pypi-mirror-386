...
from .api import KeycloakAPIClient
from ..dtos import KeycloakConfig, User, Role, Group, Client, Realm
...
class KeycloakClient:
    ...
    def __init__(self, config: Optional[KeycloakConfig] = None):
        ...
        self._api_client: Optional[KeycloakAPIClient] = None
    ...
    @property
    def api(self) -> KeycloakAPIClient:
        """Cliente API para Keycloak"""
        if not self._api_client:
            self._api_client = KeycloakAPIClient(self.config)
