...
#ifndef vtkCommonMathSerDes_h
#define vtkCommonMathSerDes_h

#include "vtkCommonMathModule.h"

#define RegisterClasses_vtkCommonMath VTK_ABI_NAMESPACE_MANGLE(RegisterClasses_vtkCommonMath)
...
extern "C"
{
   ...
   */
  VTKCOMMONMATH_EXPORT int RegisterClasses_vtkCommonMath(void* serializer, void* deserializer, void* invoker, const char** error);
}

VTK_ABI_NAMESPACE_END
#endif
// VTKHeaderTest-Exclude: vtkCommonMathSerDes.h
