...
#ifndef vtkRenderingAnnotationSerDes_h
#define vtkRenderingAnnotationSerDes_h
...
extern "C"
{
   ...
   */
  VTKRENDERINGANNOTATION_EXPORT int RegisterClasses_vtkRenderingAnnotation(void* serializer, void* deserializer, void* invoker, const char** error);
}

VTK_ABI_NAMESPACE_END
#endif
// VTKHeaderTest-Exclude: vtkRenderingAnnotationSerDes.h
