...
#ifndef vtkRenderingUISerDes_h
#define vtkRenderingUISerDes_h

#include "vtkRenderingUIModule.h"

#define RegisterClasses_vtkRenderingUI VTK_ABI_NAMESPACE_MANGLE(RegisterClasses_vtkRenderingUI)
...
extern "C"
{
   ...
   */
  VTKRENDERINGUI_EXPORT int RegisterClasses_vtkRenderingUI(void* serializer, void* deserializer, void* invoker, const char** error);
}

VTK_ABI_NAMESPACE_END
#endif
// VTKHeaderTest-Exclude: vtkRenderingUISerDes.h
