...
#ifndef vtkRenderingLabelSerDes_h
#define vtkRenderingLabelSerDes_h

#include "vtkRenderingLabelModule.h"

#define RegisterClasses_vtkRenderingLabel VTK_ABI_NAMESPACE_MANGLE(RegisterClasses_vtkRenderingLabel)
...
extern "C"
{
   ...
   */
  VTKRENDERINGLABEL_EXPORT int RegisterClasses_vtkRenderingLabel(void* serializer, void* deserializer, void* invoker, const char** error);
}

VTK_ABI_NAMESPACE_END
#endif
// VTKHeaderTest-Exclude: vtkRenderingLabelSerDes.h
