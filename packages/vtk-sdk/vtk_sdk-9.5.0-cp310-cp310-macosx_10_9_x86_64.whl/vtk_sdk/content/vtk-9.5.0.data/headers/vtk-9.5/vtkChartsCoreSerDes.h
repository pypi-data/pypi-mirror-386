...
#ifndef vtkChartsCoreSerDes_h
#define vtkChartsCoreSerDes_h

#include "vtkChartsCoreModule.h"

#define RegisterClasses_vtkChartsCore VTK_ABI_NAMESPACE_MANGLE(RegisterClasses_vtkChartsCore)
...
extern "C"
{
   ...
   */
  VTKCHARTSCORE_EXPORT int RegisterClasses_vtkChartsCore(void* serializer, void* deserializer, void* invoker, const char** error);
}

VTK_ABI_NAMESPACE_END
#endif
// VTKHeaderTest-Exclude: vtkChartsCoreSerDes.h
