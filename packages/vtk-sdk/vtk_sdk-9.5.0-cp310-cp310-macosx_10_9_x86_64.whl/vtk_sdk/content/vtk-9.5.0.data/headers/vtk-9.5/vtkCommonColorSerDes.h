...
#ifndef vtkCommonColorSerDes_h
#define vtkCommonColorSerDes_h

#include "vtkCommonColorModule.h"

#define RegisterClasses_vtkCommonColor VTK_ABI_NAMESPACE_MANGLE(RegisterClasses_vtkCommonColor)
...
extern "C"
{
   ...
   */
  VTKCOMMONCOLOR_EXPORT int RegisterClasses_vtkCommonColor(void* serializer, void* deserializer, void* invoker, const char** error);
}

VTK_ABI_NAMESPACE_END
#endif
// VTKHeaderTest-Exclude: vtkCommonColorSerDes.h
