...
#ifndef vtkViewsContext2DSerDes_h
#define vtkViewsContext2DSerDes_h

#include "vtkViewsContext2DModule.h"

#define RegisterClasses_vtkViewsContext2D VTK_ABI_NAMESPACE_MANGLE(RegisterClasses_vtkViewsContext2D)
...
extern "C"
{
   ...
   */
  VTKVIEWSCONTEXT2D_EXPORT int RegisterClasses_vtkViewsContext2D(void* serializer, void* deserializer, void* invoker, const char** error);
}

VTK_ABI_NAMESPACE_END
#endif
// VTKHeaderTest-Exclude: vtkViewsContext2DSerDes.h
