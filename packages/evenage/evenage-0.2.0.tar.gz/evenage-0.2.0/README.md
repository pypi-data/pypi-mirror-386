...
- `evenage_agent_task_duration_seconds` — Task execution time
- `evenage_queue_depth` — Pending tasks per agent
- `evenage_tokens_total` — Token usage
- `evenage_errors_total` — Error counts
