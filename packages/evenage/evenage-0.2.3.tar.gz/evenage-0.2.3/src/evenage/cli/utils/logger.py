"""
Structured logging utilities for EvenAge CLI.
...
console = Console(theme=evenage_theme)
...
def print_table(data: list[dict], title: Optional[str] = None) -> None:
