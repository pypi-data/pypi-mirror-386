...
#define __pyx_kp_u_fb_api_wrapper___init __pyx_string_tab[2]
...
__Pyx_RefNannySetupContext("PyInit_fb_api_wrapper", 0);
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_fb_api_wrapper___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_fb_api_wrapper___init, sizeof(__pyx_k_fb_api_wrapper___init), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_fb_api_wrapper___init */
