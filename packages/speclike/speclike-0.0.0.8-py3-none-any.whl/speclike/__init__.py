...
import sys
from speclike.mod import mark as _mark
from speclike.mod import dispatch as _dispatch

sys.modules[__name__ + ".mark"] = _mark
sys.modules[__name__ + ".dispatch"] = _dispatch

globals()["mark"] = _mark
globals()["dispatch"] = _dispatch

from speclike.mod.mark import setup, invariant, before, after
from speclike.mod.dispatch import TestDispatcher, TestCase, case

__all__ = [
    "setup", "invariant", "before", "after",
    "TestDispatcher", "TestCase", "case",
    "mark", "dispatch", # type: ignore
]
