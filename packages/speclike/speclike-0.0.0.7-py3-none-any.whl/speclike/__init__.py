...
import sys
from speclike.mod import mark
from speclike.mod import dispatch

sys.modules[__name__ + ".mark"] = mark
sys.modules[__name__ + ".dispatch"] = dispatch

from .mod.mark import setup, invariant, before, after
from .mod.dispatch import TestDispatcher, TestCase, case
