...
class VASPStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the VASP step. It must be
    ...
    my_description = {
        "description": "An interface for VASP",
        "group": "Simulations",
        "name": "VASP",
    }
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return vasp_step.VASP(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return vasp_step.TkVASP(canvas=canvas, **kwargs)
