...
# -*- coding: utf-8 -*-
#
# vasp_step documentation build configuration file,
...
version = vasp_step.__version__
# The full version, including alpha/beta/rc tags.
release = vasp_step.__version__
...
htmlhelp_basename = 'vasp_stepdoc'
