...
class CreateInterceptor(_message.Message):
    __slots__ = ("display_name", "description", "trigger_point", "interceptor_type", "api_url", "config", "timeout_ms", "failure_policy", "request_template")
    ...
    def __init__(self, display_name: _Optional[str] = ..., description: _Optional[str] = ..., trigger_point: _Optional[_Union[TriggerPoint, str]] = ..., interceptor_type: _Optional[_Union[InterceptorType, str]] = ..., api_url: _Optional[str] = ..., config: _Optional[_Union[Config, _Mapping]] = ..., timeout_ms: _Optional[int] = ..., failure_policy: _Optional[_Union[FailurePolicy, str]] = ..., request_template: _Optional[str] = ...) -> None: ...

class Interceptor(_message.Message):
    __slots__ = ("id", "display_name", "description", "trigger_point", "interceptor_type", "api_url", "config", "timeout_ms", "failure_policy", "request_template", "secret_id", "secret_suffix", "enabled", "created_at", "updated_at", "last_executed_at")
    ...
    def __init__(self, id: _Optional[str] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., trigger_point: _Optional[_Union[TriggerPoint, str]] = ..., interceptor_type: _Optional[_Union[InterceptorType, str]] = ..., api_url: _Optional[str] = ..., config: _Optional[_Union[Config, _Mapping]] = ..., timeout_ms: _Optional[int] = ..., failure_policy: _Optional[_Union[FailurePolicy, str]] = ..., request_template: _Optional[str] = ..., secret_id: _Optional[str] = ..., secret_suffix: _Optional[str] = ..., enabled: bool = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., last_executed_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class UpdateInterceptor(_message.Message):
    __slots__ = ("display_name", "description", "trigger_point", "api_url", "config", "timeout_ms", "failure_policy", "request_template")
    DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    TRIGGER_POINT_FIELD_NUMBER: _ClassVar[int]
    API_URL_FIELD_NUMBER: _ClassVar[int]
    ...
    failure_policy: FailurePolicy
    request_template: str
    def __init__(self, display_name: _Optional[str] = ..., description: _Optional[str] = ..., trigger_point: _Optional[_Union[TriggerPoint, str]] = ..., api_url: _Optional[str] = ..., config: _Optional[_Union[Config, _Mapping]] = ..., timeout_ms: _Optional[int] = ..., failure_policy: _Optional[_Union[FailurePolicy, str]] = ..., request_template: _Optional[str] = ...) -> None: ...
