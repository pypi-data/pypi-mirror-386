...
class AuthMethod(_message.Message):
    __slots__ = ("connection_id", "connection_type", "provider", "auth_initiation_uri", "passwordless_type", "code_challenge_length", "enable_webauthn_auto_registration")
