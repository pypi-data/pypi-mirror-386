...
class WebAuthConfiguration(_message.Message):
    __slots__ = ("rp", "attestation", "authenticators", "authenticator_selection", "timeout", "enable_auto_registration")
    ...
    def __init__(self, rp: _Optional[_Union[WebAuthConfiguration.Rp, _Mapping]] = ..., attestation: _Optional[_Union[WebAuthConfiguration.Attestation, _Mapping]] = ..., authenticators: _Optional[_Union[WebAuthConfiguration.Authenticators, _Mapping]] = ..., authenticator_selection: _Optional[_Union[WebAuthConfiguration.AuthenticatorSelection, _Mapping]] = ..., timeout: _Optional[_Union[WebAuthConfiguration.Timeout, _Mapping]] = ..., enable_auto_registration: bool = ...) -> None: ...
