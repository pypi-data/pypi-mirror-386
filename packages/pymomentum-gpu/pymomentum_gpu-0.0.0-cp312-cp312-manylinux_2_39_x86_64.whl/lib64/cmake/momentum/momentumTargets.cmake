...
set_target_properties(momentum::common PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "MOMENTUM_WITH_SPDLOG=1;MOMENTUM_ENABLE_SIMD=1"
...
set_target_properties(momentum::simd PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "MOMENTUM_ENABLE_SIMD=1"
  INTERFACE_COMPILE_FEATURES "cxx_std_20"
  INTERFACE_COMPILE_OPTIONS "-march=native"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
...
# Create imported target momentum::rasterizer
add_library(momentum::rasterizer STATIC IMPORTED)
...
set_target_properties(momentum::rasterizer PROPERTIES
  ...
  INTERFACE_COMPILE_OPTIONS "-march=native"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "momentum::common;drjit;Eigen3::Eigen;Kokkos::kokkos;Microsoft.GSL::GSL"
)
