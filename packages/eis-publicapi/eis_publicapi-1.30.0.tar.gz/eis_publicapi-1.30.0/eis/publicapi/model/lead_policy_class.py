...
class LeadPolicyClass(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'premium_overrides': ([str],),  # noqa: E501
            'policy_objects': ([LeadPolicyObjectClass],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_version_id, account, premium_overrides, policy_objects, *args, **kwargs):  # noqa: E501
        """LeadPolicyClass - a model defined in OpenAPI

        Args:
            product_version_id (float): Unique identifier referencing the product version.
            account (str): Unique identifier for the object.
            premium_overrides ([str]): Premium override.
            policy_objects ([LeadPolicyObjectClass]): Policy objects.
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_version_id, account, premium_overrides, policy_objects, *args, **kwargs):  # noqa: E501
        """LeadPolicyClass - a model defined in OpenAPI
