...
class ProductDocumentClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, product_code, product_version_id, type, description, s3_key, content_type, product_slug, slug, version_number, filename, entity_type, created_at, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            entity_type (str): The entity type of the document.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, product_code, product_version_id, type, description, s3_key, content_type, product_slug, slug, version_number, filename, entity_type, created_at, *args, **kwargs):  # noqa: E501
        """ProductDocumentClass - a model defined in OpenAPI
