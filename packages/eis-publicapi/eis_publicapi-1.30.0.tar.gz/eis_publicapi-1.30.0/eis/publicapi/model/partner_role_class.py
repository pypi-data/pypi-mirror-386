...
class PartnerRoleClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, name, slug, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, name, slug, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PartnerRoleClass - a model defined in OpenAPI
