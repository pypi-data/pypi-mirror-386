...
class AddressCompletionResponseClass(ModelNormal):
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """AddressCompletionResponseClass - a model defined in OpenAPI

        Args:
            items (bool, date, datetime, dict, float, int, list, str, none_type): List of completion suggestions
