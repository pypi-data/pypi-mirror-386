...
class CompleteEisPaymentSetupRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, first_name, last_name, account_code, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, first_name, last_name, account_code, *args, **kwargs):  # noqa: E501
        """CompleteEisPaymentSetupRequestDto - a model defined in OpenAPI
