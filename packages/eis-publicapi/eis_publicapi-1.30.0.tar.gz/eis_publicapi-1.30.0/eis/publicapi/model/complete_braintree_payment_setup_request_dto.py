...
class CompleteBraintreePaymentSetupRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, first_name, last_name, nonce, lead_code, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, first_name, last_name, nonce, lead_code, *args, **kwargs):  # noqa: E501
        """CompleteBraintreePaymentSetupRequestDto - a model defined in OpenAPI
