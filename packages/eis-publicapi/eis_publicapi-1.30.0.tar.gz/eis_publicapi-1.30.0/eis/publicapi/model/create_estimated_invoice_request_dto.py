...
class CreateEstimatedInvoiceRequestDto(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            policy_objects ([PolicyObjectRequestDto]): The policy objects to calculate premium.. [optional]  # noqa: E501
            data ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Customer custom data for premium calculation. Necessary when no policyObjects are provided.. [optional]  # noqa: E501
            provider (str): Custom provider name. Necessary if data is provided.. [optional]  # noqa: E501
