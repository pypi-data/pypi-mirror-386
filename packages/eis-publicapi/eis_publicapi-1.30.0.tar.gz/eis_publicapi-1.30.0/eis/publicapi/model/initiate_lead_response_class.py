...
class InitiateLeadResponseClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, lead_code, psp, data, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            data (bool, date, datetime, dict, float, int, list, str, none_type): Payment system provider configuration data required for frontend payment form initialization.
    ...
    @convert_js_args_to_python_args
    def __init__(self, lead_code, psp, data, *args, **kwargs):  # noqa: E501
        """InitiateLeadResponseClass - a model defined in OpenAPI
