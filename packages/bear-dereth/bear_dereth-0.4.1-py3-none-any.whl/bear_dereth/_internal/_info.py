...
if TYPE_CHECKING:
    ...
    suppress = Lazy("contextlib").to("suppress")
    PackageNotFoundError = Lazy("importlib.metadata").to("PackageNotFoundError")
    distribution = Lazy("importlib.metadata").to("distribution")
    version = Lazy("importlib.metadata").to("version")
