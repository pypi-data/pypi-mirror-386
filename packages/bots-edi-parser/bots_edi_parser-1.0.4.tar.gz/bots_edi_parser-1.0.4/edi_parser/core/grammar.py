...
class edifact(Grammar):
    defaultsyntax = {
        'add_crlfafterrecord_sep': '\r\n',
        'allow_flexible_optional_order': True,  # allow optional segments (MIN=0) in any order within a LEVEL
        'charset': 'UNOA',
        'checkcharsetin': 'strict',  # strict, ignore or botsreplace (replace with char as set in bots.ini).
        'checkcharsetout': 'strict',  # strict, ignore or botsreplace (replace with char as set in bots.ini).
        'contenttype': 'application/EDIFACT',
        'decimaal': '.',
        'empty_segment_handling': 'skip',  # how to handle empty segments: 'error', 'skip', or 'warn'
        'envelope': 'edifact',
        'escape': '?',
        'field_sep': '+',
        'field_validation_mode': 'lenient',  # field validation: 'strict', 'lenient', or 'skip'
        'forceUNA': False,
        'merge': True,
        'record_sep': "'",
        'reserve': '*',
