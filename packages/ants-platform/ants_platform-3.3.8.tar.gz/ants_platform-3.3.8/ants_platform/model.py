...
class TextPromptClient(BasePromptClient):
    ...
    def get_langchain_prompt(self, **kwargs: Union[str, Any]) -> str:
        """Convert AntsPlatform prompt into string compatible with Langchain PromptTemplate.

        This method adapts the mustache-style double curly braces {{variable}} used in AntsPlatform
...
class ChatPromptClient(BasePromptClient):
    ...
    def compile(
        ...
        **kwargs: Union[str, Any],
                    ...
                    if isinstance(placeholder_value, list):
                        for msg in placeholder_value:
                            if (
                                ...
                                ants_platform_logger.warning(no_role_content_in_placeholder)
                    else:
                        compiled_messages.append(
                            ChatMessageDict(
                                role="NOT_GIVEN",
                        ...
                        ants_platform_logger.warning(placeholder_not_a_list)
                else:
        ...
        if unresolved_placeholders:
            ...
            ants_platform_logger.warning(unresolved_placeholders_message)
    ...
    def get_langchain_prompt(
        ...
        """Convert AntsPlatform prompt into string compatible with Langchain ChatPromptTemplate.

        It specifically adapts the mustache-style double curly braces {{variable}} used in AntsPlatform
        to the single curly brace {variable} format expected by Langchain.
