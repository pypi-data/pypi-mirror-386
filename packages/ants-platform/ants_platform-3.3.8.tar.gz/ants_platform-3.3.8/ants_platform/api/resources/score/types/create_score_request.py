...
class CreateScoreRequest(pydantic_v1.BaseModel):
    ...
    """
    The environment of the score. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'ants_platform'.
    """
    ...
    """
    Reference a score config on a score. The unique ants_platform identifier of a score config. When passing this field, the dataType and stringValue fields are automatically populated.
    """
