"""This module contains the LangfuseMedia class, which is used to wrap media objects for upload to AntsPlatform."""
...
class LangfuseMedia:
    ...
    def _reference_string(self) -> Optional[str]:
        ...
        return f"@@@ants_platformMedia:type={self._content_type}|id={self._media_id}|source={self._source}@@@"
    ...
    def parse_reference_string(reference_string: str) -> ParsedMediaReference:
        ...
        Example reference string:
            "@@@ants_platformMedia:type=image/jpeg|id=some-uuid|source=base64_data_uri@@@"
        ...
        Raises:
            ...
            ValueError: If the reference string does not start with "@@@ants_platformMedia:type=".
        ...
        if not reference_string.startswith("@@@ants_platformMedia:type="):
            raise ValueError(
                "Reference string does not start with '@@@ants_platformMedia:type='"
            )

        if not reference_string.endswith("@@@"):
            raise ValueError("Reference string does not end with '@@@'")

        content = reference_string[len("@@@ants_platformMedia:") :].rstrip("@@@")
    ...
    def resolve_media_references(
        *,
        ...
        Args:
            ...
            ants_platform_client: AntsPlatform client instance used to fetch media content.
            ...
            if isinstance(obj, str):
                ...
                for reference_string in reference_string_matches:
                    try:
                        ...
                        media_data = ants_platform_client.api.media.get(
