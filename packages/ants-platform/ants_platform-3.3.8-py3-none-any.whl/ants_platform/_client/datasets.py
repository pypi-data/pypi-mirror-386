...
import logging
from .span import AntsPlatformSpan
...
class DatasetItemClient:
    """Class for managing dataset items in AntsPlatform.
    ...
    Args:
        ...
        ants_platform (AntsPlatform): Instance of AntsPlatform client for API interactions.
    ...
    def __init__(self, dataset_item: DatasetItem, ants_platform: "AntsPlatform"):
        ...
        self.ants_platform = ants_platform
    ...
    def run(
        ...
        *,
    ...
    ) -> Generator[AntsPlatformSpan, None, None]:
        """Create a context manager for the dataset item run that links the execution to a AntsPlatform trace.
        ...
        Yields:
            span: A AntsPlatformSpan that can be used to trace the execution of the run.
        """
...
class DatasetClient:
    """Class for managing datasets in AntsPlatform.
