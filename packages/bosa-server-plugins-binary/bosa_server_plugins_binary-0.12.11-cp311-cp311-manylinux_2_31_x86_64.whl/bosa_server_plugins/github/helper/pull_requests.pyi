...
def get_pull_requests(owner: str, repo: str, auth_scheme: AuthenticationScheme, *, state: str | None = None, head: str | None = None, base: str | None = None, sort: str | None = None, direction: str | None = None, per_page: int | None = None, page: int | None = None) -> tuple[list[Any], Any]:
    ...
    """
def search_pull_requests(auth_scheme: AuthenticationScheme, cache_service: CacheService, *, repositories: list[str] | None = None, merged: bool | None = None, draft: bool | None = None, author: str | None = None, labels: list[str] | None = None, since: str | None = None, until: str | None = None, state: PrState | None = None, sort: PrOrderBy | None = None, direction: Direction | None = None, fields: list[PullRequestFields] | None = None, summarize: bool | None = False, callback_urls: list[str] | None = None) -> tuple | None:
