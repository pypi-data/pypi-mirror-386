...
⚠️ 这是Qlib工作流程中的关键步骤 - 用于标准化因子而非原始数据。
...
📌 路径格式:
- 绝对路径: "D:/data/factors_normalized.csv"
- 相对路径: "./exports/factors_norm.csv"
...
""",
            ...
            "examples": [
                {
                    "name": "标准化Alpha158因子",
                    "description": "对生成的因子进行截面Z-score标准化",
                    "input": {
                ...
                {
                    "name": "标准化并导出为CSV",
                    "description": "标准化因子并导出到CSV文件，便于检查数据质量",
                    "input": {
                        "data_id": "alpha158_raw",
                        "result_id": "alpha158_norm",
                        "processors": [
                ...
                },
                {
                    ...
                    "input": {
                        ...
                        "export_path": "./data/processed_factors.json",
                        "export_format": "json"
                    }
                }
            ]
