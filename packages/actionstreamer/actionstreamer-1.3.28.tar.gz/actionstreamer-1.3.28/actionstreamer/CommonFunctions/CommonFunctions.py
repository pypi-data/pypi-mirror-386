...
def send_signed_request_long_poll(ws_config: actionstreamer.Config.WebServiceConfig, method: str, url: str, path: str, headers: Dict[str, str] = None, parameters: Dict[str, str] = None, body: str = None, long_polling: bool = False, long_polling_timeout: int = 60) -> tuple[int, str]:
    """
