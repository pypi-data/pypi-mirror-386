...
class ServerConfig(BaseModel):
    ...
    force_redact_secrets: bool = Field(
        default=False,
        description="When true, secrets are ALWAYS redacted regardless of include_secrets parameter. "
        "This provides an additional security layer to prevent accidental secret exposure through MCP.",
    )
