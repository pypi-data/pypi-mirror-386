...
class EditDocumentJsonRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "message", "signers", "cc", "enableSigningOrder", "enableAuditTrailLocalization", "expiryDateType", "expiryValue", "reminderSettings", "disableEmails", "disableSMS", "brandId", "hideDocumentId", "labels", "disableExpiryAlert", "enablePrintAndSign", "enableReassign", "useTextTags", "textTagDefinitions", "documentInfo", "onBehalfOf", "documentDownloadOption", "metaData", "recipientNotificationSettings", "formGroups", "downloadFileName", "scheduledSendTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EditDocumentJsonRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EditDocumentJsonRequest from a dict"""
        if obj is None:
            return None
