...
class FloorplanLoader:
    ...
    def __init__(self, client: LightwheelClient, max_workers=4):
        ...
        self.usd_suffix = ".usd"
        self.logger = get_logger("lightwheel_sdk.loader.floorplan")
    ...
    def acquire_usd(
        ...
        *,
        ...
        split: str = None,
        image: str = None,
        layout_registry_names: list[str] = None,
    ):
        ...
        self._latest_future = self.executor.submit(
            ...
            split=split,
            image=image,
            layout_registry_names=layout_registry_names,
        )
    ...
    def get_usd(
        ...
        if version:
            ...
            if layout_registry_names is not None:
                data["layout_registry_names"] = layout_registry_names
        ...
        self.logger.info(f"get usd {usd_name}")
