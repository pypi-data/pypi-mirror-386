...
from ssh_auto_upgrade.ssh_config_manager import SSHConfigManager, check_root_login_status
...
def main():
    ...
    # 解析升级时间段
    try:
        upgrade_time_parts = args.upgrade_time.split('-')
        if len(upgrade_time_parts) != 2:
            raise ValueError("升级时间段格式错误")
        
        start_time_str = upgrade_time_parts[0]
        end_time_str = upgrade_time_parts[1]
