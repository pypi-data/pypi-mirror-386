...
class DataPack:
    ...
    def getTradeInformation(self, Symbols: str = ":all", InstrumentType: str = None, ReferenceDate: str = None):
        """
        Busca e retorna informações de negociações de renda fixa (Trade_FixedIncome) para o tipo de instrumento e data especificados.

        Este método localiza o arquivo JSON mais recente de Trade_FixedIncome para o tipo de instrumento informado (CRA, CRI, DEB) e para a data de referência desejada.
        O arquivo é obtido diretamente do Azure Blob Storage utilizando uma SAS dinâmica, garantindo segurança e atualização dos dados.
        ...
        Exemplos de uso:
            ...
            result = datapack.getTradeInformation(Symbols=":all", InstrumentType="DEB", ReferenceDate="D-1")

            # Filtra registros por ticker específico
            result = datapack.getTradeInformation(Symbols="TckrSymb:25H2095950", InstrumentType="CRA", ReferenceDate="20231020")
