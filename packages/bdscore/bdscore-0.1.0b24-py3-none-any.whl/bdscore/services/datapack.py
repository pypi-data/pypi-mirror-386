...
class DataPack:
    ...
    def getRates(self, Symbols, InitialDate, FinalDate=None, Fields=None, Interval=None, IgnDefault=None, Lang=None, Page=None, Rows=None, Format=None, IgnNull=None, isActive=None):
        """
        Obtém dados de indicadores de mercado para o período e filtros especificados.

        Retorna informações detalhadas sobre indicadores de mercado, com suporte a filtros por campo, data, e outros parâmetros.
        ...
        Exemplos de uso:
            result = datapack.getRates(Symbols=":all", InitialDate="D-5", FinalDate="D-1")
            df = result.data.to_df().head()
        """
        return self._request_endpoint(
            "getRates",
