# Assethandler Sdk-python

A Python SDK assethandler for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
from assethandler_sdk.types.common import UserRegisterInput
...
```python
from assethandler_sdk import BoilerSDKConfig
...
pytest --cov=assethandler_sdk --cov-report=html
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/assethandler-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/assethandler-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../assethandler-frontend) - Frontend assethandler
- [Boiler Backend](../assethandler-python-be-graphql) - Python GraphQL backend assethandler