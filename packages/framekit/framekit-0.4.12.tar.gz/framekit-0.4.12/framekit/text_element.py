...
# Global font cache to avoid repeated disk I/O
_FONT_CACHE: Dict[Tuple[str, int], ImageFont.FreeTypeFont] = {}


def _load_font_cached(font_path: Optional[str], size: int) -> ImageFont.FreeTypeFont:
    """Load font with caching to avoid repeated disk I/O.
    ...
    Returns:
        Cached or newly loaded font object
    """
    ...
    if font is None:
        # Try system fonts as fallback (macOS and Linux paths)
        fallback_paths = [
