...
from backlin.module_admin.service.log_service import OperationLogService, LoginLogService
from backlin.module_admin.entity.vo.log_vo import OperLogModel, LogininforModel
        ...
        async def wrapper(*args, **kwargs):
            ...
            if log_type == 'login':
                ...
                for i in operation_log:
                    texts.append(f"{i}: {type(operation_log[i])} - {operation_log[i]}")
                logger.debug("\n".join(texts))
