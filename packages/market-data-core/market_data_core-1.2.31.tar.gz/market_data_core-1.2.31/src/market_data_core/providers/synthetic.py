...
from ..configs.model import Dataset, Job, SyntheticProvider as SynthConfig
...
class SyntheticAdapter(Provider):
    ...
    def _resolve_symbols(self, symbols: Union[List[str], str]) -> List[str]:
    ...
    def fetch_live(self, dataset: Dataset, job: Job) -> Iterable[Bar]:
