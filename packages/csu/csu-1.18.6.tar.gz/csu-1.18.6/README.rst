...
.. |supported-implementations| image:: https://img.shields.io/pypi/implementation/csu.svg
    ...
    :target: https://pypi.org/project/csu
.. |commits-since| image:: https://img.shields.io/github/commits-since/ionelmc/python-csu/v1.18.6.svg
    :alt: Commits since latest release
    :target: https://github.com/ionelmc/python-csu/compare/v1.18.6...main
