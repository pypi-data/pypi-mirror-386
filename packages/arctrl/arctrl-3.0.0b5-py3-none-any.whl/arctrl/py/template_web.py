...
def get_templates(url: str | None=None) -> Async[Array[Template]]:
    ...
    def _arrow3788(__unit: None=None, url: Any=url) -> Async[Array[Template]]:
        def _arrow3787(_arg: str) -> Async[Array[Template]]:
            map_result: Array[Template] = Templates_fromJsonString(_arg)
            return singleton.Return(map_result)

        return singleton.Bind(download_file(url_1), _arrow3787)
