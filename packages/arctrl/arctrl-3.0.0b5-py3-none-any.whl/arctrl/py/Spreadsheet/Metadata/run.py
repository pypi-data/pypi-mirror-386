...
def to_sparse_table(run: ArcRun) -> SparseTable:
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr1213())), matrix.ColumnCount)
