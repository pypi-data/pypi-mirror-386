...
def encoder(id_map: Any | None, value: Factor) -> IEncodable:
    def f_1(value_1: Factor, id_map: Any=id_map, value: Any=value) -> IEncodable:
        ...
        def _arrow2332(value_2: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow2335(value_4: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow2336(oa: OntologyAnnotation, value_1: Any=value_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        def _arrow2337(comment: Comment, value_1: Any=value_1) -> IEncodable:
            return ISAJson_encoder(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2332, gen_id(value_1)), try_include("factorName", _arrow2335, value_1.Name), try_include("factorType", _arrow2336, value_1.FactorType), try_include_seq("comments", _arrow2337, default_arg(value_1.Comments, []))]))
    ...
    if id_map is not None:
        def _arrow2344(f_2: Factor, id_map: Any=id_map, value: Any=value) -> str:
            return gen_id(f_2)

        return encode(_arrow2344, f_1, value, id_map)
