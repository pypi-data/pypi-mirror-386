...
def ROCrate_encoder(oa: Material) -> IEncodable:
    ...
    def _arrow2610(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2614(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2615(value_5: MaterialType, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_5)

    def _arrow2616(oa_1: Material, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2610()), ("@type", list_1_1(singleton(ObjectExpr2611()))), ("additionalType", ObjectExpr2612()), try_include("name", _arrow2614, oa.Name), try_include("type", _arrow2615, oa.MaterialType), try_include_list_opt("characteristics", ROCrate_encoder_2, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2616, oa.DerivesFrom), ("@context", context_jsonvalue)]))
...
def _arrow2624(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2623(get: IGetters) -> Material:
            ...
            def _arrow2619(__unit: None=None) -> str | None:
                object_arg_3: IOptionalGetter = get.Optional
                return object_arg_3.Field("name", string)

            def _arrow2620(__unit: None=None) -> MaterialType | None:
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("type", ROCrate_decoder_1)

            def _arrow2621(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2622(__unit: None=None) -> FSharpList[Material] | None:
                arg_13: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_6: IOptionalGetter = get.Optional
                return object_arg_6.Field("derivesFrom", arg_13)

            return Material(_arrow2618(), _arrow2619(), _arrow2620(), _arrow2621(), _arrow2622())

        return object(_arrow2623)

    return decode(None)


ROCrate_decoder: Decoder_1[Material] = _arrow2624()
...
def ISAJson_encoder(id_map: Any | None, c: Material) -> IEncodable:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> IEncodable:
        ...
        def _arrow2628(value: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2630(value_2: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2631(oa_1: MaterialAttributeValue, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_1)

        def _arrow2632(c_1: Material, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder(id_map, c_1)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2628, ROCrate_genID(oa)), try_include("name", _arrow2630, oa.Name), try_include("type", ISAJson_encoder_1, oa.MaterialType), try_include_list_opt("characteristics", _arrow2631, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2632, oa.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2634(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return ROCrate_genID(m_1)

        return encode(_arrow2634, f, c, id_map)
...
def _arrow2641(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2640(get: IGetters) -> Material:
            ...
            def _arrow2637(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ISAJson_decoder_1)

            def _arrow2638(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2639(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2635(), _arrow2636(), _arrow2637(), _arrow2638(), _arrow2639())

        return Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2640)

    return decode(None)


ISAJson_decoder: Decoder_1[Material] = _arrow2641()
