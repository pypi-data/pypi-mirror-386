...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, oa: Protocol) -> IEncodable:
    ...
    def _arrow2554(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2557(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2558(oa_1: OntologyAnnotation, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2560(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2562(value_6: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2564(value_8: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2565(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2554()), ("@type", list_1_1(singleton(ObjectExpr2555()))), try_include("name", _arrow2557, oa.Name), try_include("protocolType", _arrow2558, oa.ProtocolType), try_include("description", _arrow2560, oa.Description), try_include("uri", _arrow2562, oa.Uri), try_include("version", _arrow2564, oa.Version), try_include_list_opt("components", ROCrate_encoder_1, oa.Components), try_include_list_opt("comments", _arrow2565, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2578(get: IGetters) -> Protocol:
    def _arrow2570(__unit: None=None) -> FSharpList[Component]:
        ...
        list_2: FSharpList[Component] = default_arg(_arrow2567(), empty())
        ...
        list_4 = append(default_arg(_arrow2568(), empty()), list_2)
        def _arrow2569(__unit: None=None) -> FSharpList[Component] | None:
        ...
        return append(default_arg(_arrow2569(), empty()), list_4)

    components: FSharpList[Component] | None = Option_fromValueWithDefault(empty(), _arrow2570())
    ...
    def _arrow2573(__unit: None=None) -> OntologyAnnotation | None:
    ...
    def _arrow2577(__unit: None=None) -> FSharpList[Comment] | None:
        arg_19: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_2)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Protocol(_arrow2571(), _arrow2572(), _arrow2573(), _arrow2574(), _arrow2575(), _arrow2576(), None, components, _arrow2577())


ROCrate_decoder: Decoder_1[Protocol] = object(_arrow2578)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, id_map: Any | None, oa: Protocol) -> IEncodable:
    def f(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2582(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2584(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2585(oa_2: OntologyAnnotation, oa_1: Any=oa_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2587(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2589(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2591(value_8: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2592(value_10: ProtocolParameter, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, value_10)

        def _arrow2593(c: Component, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, c)

        def _arrow2594(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2582, ROCrate_genID(study_name, assay_name, process_name, oa_1)), try_include("name", _arrow2584, oa_1.Name), try_include("protocolType", _arrow2585, oa_1.ProtocolType), try_include("description", _arrow2587, oa_1.Description), try_include("uri", _arrow2589, oa_1.Uri), try_include("version", _arrow2591, oa_1.Version), try_include_list_opt("parameters", _arrow2592, oa_1.Parameters), try_include_list_opt("components", _arrow2593, oa_1.Components), try_include_list_opt("comments", _arrow2594, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2596(p_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(study_name, assay_name, process_name, p_1)

        return encode(_arrow2596, f, oa, id_map)
...
def _arrow2606(get: IGetters) -> Protocol:
    ...
    def _arrow2599(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow2603(__unit: None=None) -> FSharpList[ProtocolParameter] | None:
        arg_13: Decoder_1[FSharpList[ProtocolParameter]] = list_1_2(ISAJson_decoder_1)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("parameters", arg_13)

    def _arrow2604(__unit: None=None) -> FSharpList[Component] | None:
        arg_15: Decoder_1[FSharpList[Component]] = list_1_2(ISAJson_decoder_2)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("components", arg_15)

    def _arrow2605(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ISAJson_decoder_3)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Protocol(_arrow2597(), _arrow2598(), _arrow2599(), _arrow2600(), _arrow2601(), _arrow2602(), _arrow2603(), _arrow2604(), _arrow2605())


ISAJson_decoder: Decoder_1[Protocol] = object(_arrow2606)
