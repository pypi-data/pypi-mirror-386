...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2691(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2695(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2696(x: IEncodable, oa: Any=oa) -> IEncodable:
        return x

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2691()), ("@type", list_1_2(singleton(ObjectExpr2692()))), ("additionalType", ObjectExpr2693()), try_include("name", _arrow2695, oa.Name), try_include_list("additionalProperties", _arrow2696, additional_properties), ("@context", context_jsonvalue)]))
...
class ObjectExpr2707(Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]]):
    def Decode(self, s: IDecoderHelpers_1[Any], json: Any) -> FSharpResult_2[tuple[MaterialAttributeValue | None, FactorValue | None], tuple[str, ErrorReason_1[__A_]]]:
        def _arrow2702(__unit: None=None) -> str:
        ...
        if (_arrow2702() if s.has_property("additionalType", json) else "") == "FactorValue":
...
ROCrate_additionalPropertyDecoder: Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]] = ObjectExpr2707()

def _arrow2711(get: IGetters) -> Sample:
    ...
    def _arrow2710(__unit: None=None) -> FSharpList[Source] | None:
        arg_15: Decoder_1[FSharpList[Source]] = list_1_3(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("derivesFrom", arg_15)

    return Sample(_arrow2708(), _arrow2709(), pattern_input[0], pattern_input[1], _arrow2710())


ROCrate_decoder: Decoder_1[Sample] = object(_arrow2711)
...
def ISAJson_encoder(id_map: Any | None, oa: Sample) -> IEncodable:
    def f(oa_1: Sample, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2715(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2717(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2718(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        def _arrow2719(fv: FactorValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, fv)

        def _arrow2720(oa_3: Source, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, oa_3)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2715, ROCrate_genID(oa_1)), try_include("name", _arrow2717, oa_1.Name), try_include_list_opt("characteristics", _arrow2718, oa_1.Characteristics), try_include_list_opt("factorValues", _arrow2719, oa_1.FactorValues), try_include_list_opt("derivesFrom", _arrow2720, oa_1.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2722(s_1: Sample, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2722, f, oa, id_map)
...
def _arrow2728(get: IGetters) -> Sample:
    ...
    def _arrow2725(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    def _arrow2726(__unit: None=None) -> FSharpList[FactorValue] | None:
        arg_7: Decoder_1[FSharpList[FactorValue]] = list_1_3(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("factorValues", arg_7)

    def _arrow2727(__unit: None=None) -> FSharpList[Source] | None:
        arg_9: Decoder_1[FSharpList[Source]] = list_1_3(ISAJson_decoder_3)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("derivesFrom", arg_9)

    return Sample(_arrow2723(), _arrow2724(), _arrow2725(), _arrow2726(), _arrow2727())


ISAJson_decoder: Decoder_1[Sample] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2728)
