...
def encoder(assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2943(__unit: None=None, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2945(value_1: str, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2947(value_3: str, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2948(oa: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2949(oa_1: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2950(oa_2: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2951(dm: DataMap, assay: Any=assay) -> IEncodable:
        return encoder_4(dm)

    def _arrow2952(table: ArcTable, assay: Any=assay) -> IEncodable:
        return encoder_5(table)

    def _arrow2953(person: Person, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2954(comment: Comment, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2943()), try_include("Title", _arrow2945, assay.Title), try_include("Description", _arrow2947, assay.Description), try_include("MeasurementType", _arrow2948, assay.MeasurementType), try_include("TechnologyType", _arrow2949, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2950, assay.TechnologyPlatform), try_include("DataMap", _arrow2951, assay.DataMap), try_include_seq("Tables", _arrow2952, assay.Tables), try_include_seq("Performers", _arrow2953, assay.Performers), try_include_seq("Comments", _arrow2954, assay.Comments)]))
...
def _arrow2966(get: IGetters) -> ArcAssay:
    def _arrow2956(__unit: None=None) -> str:
    ...
    def _arrow2965(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(decoder_4)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("Comments", arg_19)

    return ArcAssay.create(_arrow2956(), _arrow2957(), _arrow2958(), _arrow2959(), _arrow2960(), _arrow2961(), _arrow2962(), _arrow2963(), _arrow2964(), _arrow2965())


decoder: Decoder_1[ArcAssay] = object(_arrow2966)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2970(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        value: str = assay.Identifier
    ...
    def _arrow2972(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2974(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2975(oa: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2976(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2977(oa_2: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2978(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2979(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2980(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2981(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2970()), try_include("Title", _arrow2972, assay.Title), try_include("Description", _arrow2974, assay.Description), try_include("MeasurementType", _arrow2975, assay.MeasurementType), try_include("TechnologyType", _arrow2976, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2977, assay.TechnologyPlatform), try_include_seq("Tables", _arrow2978, assay.Tables), try_include("DataMap", _arrow2979, assay.DataMap), try_include_seq("Performers", _arrow2980, assay.Performers), try_include_seq("Comments", _arrow2981, assay.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcAssay]:
    def _arrow2993(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcAssay:
        def _arrow2983(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)
        ...
        return ArcAssay.create(_arrow2983(), _arrow2984(), _arrow2985(), _arrow2986(), _arrow2987(), _arrow2988(), _arrow2989(), _arrow2990(), _arrow2991(), _arrow2992())
...
def ROCrate_encoder(assay_name: str | None, a: ArcAssay) -> IEncodable:
    ...
    def _arrow2997(__unit: None=None, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
    ...
    def _arrow3001(__unit: None=None, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
    ...
    def _arrow3004(value_5: str, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
    ...
    def _arrow3006(value_7: str, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
    ...
    def _arrow3007(oa: OntologyAnnotation, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderPropertyValue(oa)

    def _arrow3008(oa_1: OntologyAnnotation, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow3009(oa_2: OntologyAnnotation, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_2)

    def _arrow3010(oa_3: Person, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_1(oa_3)

    def _arrow3011(oa_4: Data, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_2(oa_4)

    def _arrow3013(__unit: None=None, assay_name: Any=assay_name, a: Any=a) -> Callable[[Process], IEncodable]:
        assay_name_1: str | None = a.Identifier
        def _arrow3012(oa_5: Process) -> IEncodable:
            return ROCrate_encoder_3(assay_name, assay_name_1, oa_5)

        return _arrow3012

    def _arrow3014(comment: Comment, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_4(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2997()), ("@type", list_1_1(singleton(ObjectExpr2998()))), ("additionalType", ObjectExpr2999()), ("identifier", _arrow3001()), ("filename", ObjectExpr3002()), try_include("title", _arrow3004, a.Title), try_include("description", _arrow3006, a.Description), try_include("measurementType", _arrow3007, a.MeasurementType), try_include("technologyType", _arrow3008, a.TechnologyType), try_include("technologyPlatform", _arrow3009, a.TechnologyPlatform), try_include_seq("performers", _arrow3010, a.Performers), try_include_list("dataFiles", _arrow3011, data_files), try_include_list("processSequence", _arrow3013(), processes), try_include_seq("comments", _arrow3014, a.Comments), ("@context", context_jsonvalue)]))
...
def _arrow3025(get: IGetters) -> ArcAssay:
    def _arrow3016(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)

    identifier: str = default_arg(_arrow3016(), create_missing_identifier())
    ...
    def _arrow3022(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("technologyPlatform", OntologyAnnotation_ROCrate_decoderDefinedTerm)

    def _arrow3023(__unit: None=None) -> Array[Person] | None:
        arg_16: Decoder_1[Array[Person]] = resize_array(ROCrate_decoder_2)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("performers", arg_16)

    def _arrow3024(__unit: None=None) -> Array[Comment] | None:
        arg_18: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_3)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_18)

    return ArcAssay(identifier, _arrow3018(), _arrow3019(), _arrow3020(), _arrow3021(), _arrow3022(), tables, None, _arrow3023(), _arrow3024())


ROCrate_decoder: Decoder_1[ArcAssay] = object(_arrow3025)
...
def ISAJson_encoder(study_name: str | None, id_map: Any | None, a: ArcAssay) -> IEncodable:
    def f(a_1: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> IEncodable:
        ...
        def _arrow3026(ps: FSharpList[Process], a_1: Any=a_1) -> IEncodable:
            return encoder_9(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow3026, Option_fromValueWithDefault(empty(), processes))
        ...
        def _arrow3029(__unit: None=None, a_1: Any=a_1) -> IEnumerable_1[Comment]:
            def _arrow3028(__unit: None=None) -> IEnumerable_1[Comment]:
                ...
                return append(singleton_1(Comment.create("title", value_9(a_1.Title))) if (a_1.Title is not None) else empty_1(), delay(_arrow3027))

            return append(a_1.Comments if (len(a_1.Comments) > 0) else empty_1(), delay(_arrow3028))

        comments: FSharpList[Comment] = to_list(delay(_arrow3029))
        ...
        def _arrow3033(value_5: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow3034(oa_2: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow3035(oa_3: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow3037(value_7: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow3039(__unit: None=None, a_1: Any=a_1) -> Callable[[Process], IEncodable]:
            assay_name: str | None = a_1.Identifier
            def _arrow3038(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_2(study_name, assay_name, id_map, oa_4)

            return _arrow3038

        def _arrow3040(comment: Comment, a_1: Any=a_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("filename", ObjectExpr3031()), try_include("@id", _arrow3033, ROCrate_genID(a_1)), try_include("measurementType", _arrow3034, a_1.MeasurementType), try_include("technologyType", _arrow3035, a_1.TechnologyType), try_include("technologyPlatform", _arrow3037, map(mapping, a_1.TechnologyPlatform)), encoced_data_files, encoded_materials, encoded_characteristics, encoded_units, try_include_list("processSequence", _arrow3039(), processes), try_include_seq("comments", _arrow3040, comments)]))
    ...
    if id_map is not None:
        def _arrow3042(a_2: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> str:
            return ROCrate_genID(a_2)

        return encode(_arrow3042, f, a, id_map)
...
def _arrow3048(get: IGetters) -> ArcAssay:
    def _arrow3043(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Assay_tryIdentifierFromFileName, _arrow3043()), create_missing_identifier())
    def mapping(arg_4: FSharpList[Process]) -> Array[ArcTable]:
        a: ArcTables = ARCtrl_ArcTables__ArcTables_fromProcesses_Static_62A3309D(arg_4)
        return a.Tables
    ...
    tables: Array[ArcTable] | None = map(mapping, _arrow3044())
    ...
    def _arrow3047(__unit: None=None) -> OntologyAnnotation | None:
    ...
    return ArcAssay(identifier, title, description, _arrow3045(), _arrow3046(), _arrow3047(), tables, None, None, comments_1)


ISAJson_decoder: Decoder_1[ArcAssay] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3048)
