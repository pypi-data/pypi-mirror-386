...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow471(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr470(IRequiredGetter):
            ...
            return ObjectExpr470()

        self.required: IRequiredGetter = _arrow471()
        ...
        def _arrow477(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr476(IMultipleOptionalGetter):
            ...
            return ObjectExpr476()

        self.multiple_optional: IMultipleOptionalGetter = _arrow477()
        def _arrow481(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
        ...
        self.overflow: IOverflowGetter = _arrow481()
