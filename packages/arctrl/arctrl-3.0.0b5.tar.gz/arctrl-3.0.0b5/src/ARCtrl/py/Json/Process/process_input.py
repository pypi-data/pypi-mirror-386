...
def _arrow2679(Item: Sample) -> ProcessInput:
    return ProcessInput(1, Item)


def _arrow2680(Item_1: Source) -> ProcessInput:
    return ProcessInput(0, Item_1)


def _arrow2681(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2682(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2679, ROCrate_decoder_1), map(_arrow2680, ROCrate_decoder_2), map(_arrow2681, ROCrate_decoder_3), map(_arrow2682, ROCrate_decoder_4)]))
...
def _arrow2684(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2685(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2686(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2687(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2684, ISAJson_decoder_1), map(_arrow2685, ISAJson_decoder_2), map(_arrow2686, ISAJson_decoder_3), map(_arrow2687, ISAJson_decoder_4)]))
