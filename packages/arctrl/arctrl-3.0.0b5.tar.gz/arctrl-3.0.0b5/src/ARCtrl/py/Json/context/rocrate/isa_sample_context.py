...
IContext_reflection = _expr1874

def _arrow1881(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1875()), ("bio", ObjectExpr1876()), ("Sample", ObjectExpr1877()), ("name", ObjectExpr1878()), ("additionalProperties", ObjectExpr1879())])
...
context_jsonvalue: IEncodable = _arrow1881()
