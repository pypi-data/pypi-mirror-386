...
def _arrow1917(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1891()), ("Study", ObjectExpr1892()), ("identifier", ObjectExpr1893()), ("title", ObjectExpr1894()), ("additionalType", ObjectExpr1895()), ("description", ObjectExpr1896()), ("submissionDate", ObjectExpr1897()), ("publicReleaseDate", ObjectExpr1898()), ("publications", ObjectExpr1899()), ("people", ObjectExpr1901()), ("assays", ObjectExpr1902()), ("dataFiles", ObjectExpr1905()), ("filename", ObjectExpr1906()), ("comments", ObjectExpr1909()), ("processSequence", ObjectExpr1911()), ("studyDesignDescriptors", ObjectExpr1913())])
...
context_jsonvalue: IEncodable = _arrow1917()
