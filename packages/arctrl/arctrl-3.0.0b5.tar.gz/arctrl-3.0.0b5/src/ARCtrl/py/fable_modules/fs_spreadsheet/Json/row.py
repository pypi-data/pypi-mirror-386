...
def encode(row: FsRow) -> IEncodable:
    def _arrow310(__unit: None=None, row: Any=row) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("number", _arrow310()), ("cells", seq(map(mapping, row.Cells)))])
