...
class FsWorksheet:
    ...
    def Columns(self, __unit: None=None) -> IEnumerable_1[FsColumn]:
        ...
        def mapping(tupled_arg: tuple[int, IEnumerable_1[FsCell]]) -> FsColumn:
            ...
            def _arrow229(__unit: None=None, tupled_arg: Any=tupled_arg) -> FsRangeAddress:
                ...
                cells_1: IEnumerable_1[FsCell] = sort_by(projection_1, tupled_arg[1], ObjectExpr226())
                def _arrow227(__unit: None=None) -> int:
                    c_2: FsCell = head(cells_1)
                    return c_2.RowNumber

                def _arrow228(__unit: None=None) -> int:
                    c_3: FsCell = last(cells_1)
                    return c_3.RowNumber

                tupled_arg_1 = (FsAddress(_arrow227(), column_index), FsAddress(_arrow228(), column_index))
                return FsRangeAddress(tupled_arg_1[0], tupled_arg_1[1])

            return FsColumn(_arrow229(), self_1.CellCollection)
        ...
        class ObjectExpr231:
            ...
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow230(x: int, y: int) -> bool:
                    return x == y
        ...
        return map(mapping, group_by(projection, self_1._cells.GetCells(), ObjectExpr231()))
    ...
    def Copy(self, __unit: None=None) -> FsWorksheet:
        ...
        def _arrow232(__unit: None=None) -> Array[FsRow]:
            n: Array[FsRow] = []
        ...
        def _arrow233(__unit: None=None) -> Array[FsTable]:
            n_1: Array[FsTable] = []
        ...
        return FsWorksheet(self_1.Name, _arrow232(), _arrow233(), fcc)
    ...
    def RemoveRowAt(self, row_index: int) -> None:
        ...
        with get_enumerator(filter(predicate, self_1._rows)) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                ignore(remove_in_place(enumerator.System_Collections_Generic_IEnumerator_1_get_Current(), self_1._rows, ObjectExpr234()))
    ...
    def SortRows(self, __unit: None=None) -> None:
        ...
        sorted: Array[FsRow] = list(sort_by(projection, self_1._rows, ObjectExpr235()))
        clear(self_1._rows)
    ...
    def GetMaxRowIndex(self, __unit: None=None) -> FsRow:
        ...
        return max_by(projection, self_1.Rows, ObjectExpr236())
    ...
    def RescanRows(self, __unit: None=None) -> None:
        ...
        rows: Any = of_seq(map(mapping, self_1._rows), ObjectExpr237())
        ...
        class ObjectExpr239:
            @property
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow238(x_1: int, y_1: int) -> bool:
                    return x_1 == y_1
        ...
        iterate(action_1, group_by(projection, self_1._cells.GetCells(), ObjectExpr239()))
