...
class ARC(ArcInvestigation):
    ...
    def try_load_async(arc_path: str) -> Async[FSharpResult_2[ARC, Array[str]]]:
        def _arrow3962(__unit: None=None) -> Async[FSharpResult_2[ARC, Array[str]]]:
            def _arrow3961(_arg: Array[str]) -> Async[FSharpResult_2[ARC, Array[str]]]:
                arc: ARC = ARC.from_file_paths(to_array(_arg))
                contracts: Array[Contract] = arc.GetReadContracts()
                def _arrow3960(_arg_1: FSharpResult_2[Array[Contract], Array[str]]) -> Async[FSharpResult_2[ARC, Array[str]]]:
                ...
                return singleton.Bind(full_fill_contract_batch_async(arc_path, contracts), _arrow3960)

            return singleton.Bind(get_all_file_paths_async(arc_path), _arrow3961)

        return singleton.Delay(_arrow3962)

    def GetAssayRemoveContracts(self, assay_identifier: str) -> Array[Contract]:
        this: ARC = self
        class ObjectExpr3964:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3963(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(assay_identifier, this.AssayIdentifiers, ObjectExpr3964()):
        ...
        def _arrow3967(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3966(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3965(__unit: None=None) -> IEnumerable_1[Contract]:
                    return map(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract, studies)

                return append(singleton_1(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(this)), delay(_arrow3965))

            return append(singleton_1(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow3966))

        return to_array(delay(_arrow3967))
    ...
    def GetAssayRenameContracts(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        this: ARC = self
        class ObjectExpr3969:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3968(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(old_assay_identifier, this.AssayIdentifiers, ObjectExpr3969()):
            raise Exception("ARC does not contain assay with given name")
        ...
        def _arrow3971(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3970(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton_1(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow3970))

        return to_array(delay(_arrow3971))
    ...
    def GetStudyRenameContracts(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        this: ARC = self
        class ObjectExpr3973:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3972(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(old_study_identifier, this.StudyIdentifiers, ObjectExpr3973()):
        ...
        renamed_paths: Array[str] = map_1(mapping, paths, None)
        this.SetFilePaths(renamed_paths)
        def _arrow3975(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3974(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton_1(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow3974))

        return to_array(delay(_arrow3975))
    ...
    def WriteAsync(self, arc_path: str) -> Async[None]:
        this: ARC = self
        def _arrow3977(__unit: None=None) -> Async[None]:
            def _arrow3976(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
            ...
            return singleton.Bind(this.TryWriteAsync(arc_path), _arrow3976)

        return singleton.Delay(_arrow3977)

    def UpdateAsync(self, arc_path: str) -> Async[None]:
        this: ARC = self
        def _arrow3979(__unit: None=None) -> Async[None]:
            def _arrow3978(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryUpdateAsync(arc_path), _arrow3978)

        return singleton.Delay(_arrow3979)

    def RemoveAssayAsync(self, arc_path: str, assay_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3981(__unit: None=None) -> Async[None]:
            def _arrow3980(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRemoveAssayAsync(arc_path, assay_identifier), _arrow3980)

        return singleton.Delay(_arrow3981)

    def RenameAssayAsync(self, arc_path: str, old_assay_identifier: str, new_assay_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3983(__unit: None=None) -> Async[None]:
            def _arrow3982(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRenameAssayAsync(arc_path, old_assay_identifier, new_assay_identifier), _arrow3982)

        return singleton.Delay(_arrow3983)

    def RemoveStudyAsync(self, arc_path: str, study_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3985(__unit: None=None) -> Async[None]:
            def _arrow3984(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRemoveStudyAsync(arc_path, study_identifier), _arrow3984)

        return singleton.Delay(_arrow3985)

    def RenameStudyAsync(self, arc_path: str, old_study_identifier: str, new_study_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3987(__unit: None=None) -> Async[None]:
            def _arrow3986(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRenameStudyAsync(arc_path, old_study_identifier, new_study_identifier), _arrow3986)

        return singleton.Delay(_arrow3987)

    @staticmethod
    def load_async(arc_path: str) -> Async[ARC]:
        def _arrow3989(__unit: None=None) -> Async[ARC]:
            def _arrow3988(_arg: FSharpResult_2[ARC, Array[str]]) -> Async[ARC]:
            ...
            return singleton.Bind(ARC.try_load_async(arc_path), _arrow3988)

        return singleton.Delay(_arrow3989)
    ...
    def MakeDataFilesAbsolute(self, __unit: None=None) -> None:
        this: ARC = self
        class ObjectExpr3990:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        files_paths: Any = of_seq(this.FileSystem.Tree.ToFilePaths(), ObjectExpr3990())
        ...
        def update_column_option(data_name_function: Callable[[Data], str], col: CompositeColumn | None=None) -> None:
            ...
            if col is not None:
                def _arrow3991(__unit: None=None, data_name_function: Any=data_name_function, col: Any=col) -> bool:
    ...
    def GetUpdateContracts(self, skip_update_fs: bool | None=None) -> Array[Contract]:
        ...
        if this.StaticHash == 0:
            ...
            def _arrow4016(__unit: None=None) -> IEnumerable_1[Contract]:
                hash_1: int = this.GetLightHashCode() or 0
                def _arrow4015(__unit: None=None) -> IEnumerable_1[Contract]:
                    this.StaticHash = hash_1 or 0
                    def _arrow3996(s: ArcStudy) -> IEnumerable_1[Contract]:
                        hash_2: int = s.GetLightHashCode() or 0
                        def _arrow3995(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value is not None:
                                if DataMap__get_StaticHash(match_value) == 0:
                                    ...
                                    def _arrow3994(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                def _arrow3992(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_2, safe_hash(dm_2))
                                    return empty()

                                return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow3992))

                            elif pattern_matching_result == 1:
                                def _arrow3993(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_3, safe_hash(dm_3))
                                    return empty()

                                return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow3993))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow3995))

                    def _arrow4014(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow4001(a: ArcAssay) -> IEnumerable_1[Contract]:
                            hash_3: int = a.GetLightHashCode() or 0
                            def _arrow4000(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_1 is not None:
                                    if DataMap__get_StaticHash(match_value_1) == 0:
                                        ...
                                        def _arrow3999(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    def _arrow3997(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_6, safe_hash(dm_6))
                                        return empty()

                                    return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow3997))

                                elif pattern_matching_result_1 == 1:
                                    def _arrow3998(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_7, safe_hash(dm_7))
                                        return empty()

                                    return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow3998))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton_1(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow4000))

                        def _arrow4013(__unit: None=None) -> IEnumerable_1[Contract]:
                            def _arrow4006(w: ArcWorkflow) -> IEnumerable_1[Contract]:
                                hash_4: int = ArcWorkflow__GetLightHashCode(w) or 0
                                def _arrow4005(__unit: None=None) -> IEnumerable_1[Contract]:
                                    ...
                                    if match_value_2 is not None:
                                        if DataMap__get_StaticHash(match_value_2) == 0:
                                            ...
                                            def _arrow4004(__unit: None=None) -> bool:
                                    ...
                                    if pattern_matching_result_2 == 0:
                                        def _arrow4002(__unit: None=None) -> IEnumerable_1[Contract]:
                                            DataMap__set_StaticHash_Z524259A4(dm_10, safe_hash(dm_10))
                                            return empty()

                                        return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForWorkflow_Z721C83C5(dm_10, ArcWorkflow__get_Identifier(w))), delay(_arrow4002))

                                    elif pattern_matching_result_2 == 1:
                                        def _arrow4003(__unit: None=None) -> IEnumerable_1[Contract]:
                                            DataMap__set_StaticHash_Z524259A4(dm_11, safe_hash(dm_11))
                                            return empty()

                                        return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForWorkflow_Z721C83C5(dm_11, ArcWorkflow__get_Identifier(w))), delay(_arrow4003))

                                    elif pattern_matching_result_2 == 2:
                                        return empty()


                                return append(ARCtrl_ArcWorkflow__ArcWorkflow_ToCreateContract_6FCE9E49(w, True) if (ArcWorkflow__get_StaticHash(w) == 0) else (singleton_1(ARCtrl_ArcWorkflow__ArcWorkflow_ToUpdateContract(w)) if (ArcWorkflow__get_StaticHash(w) != hash_4) else empty()), delay(_arrow4005))

                            def _arrow4012(__unit: None=None) -> IEnumerable_1[Contract]:
                                def _arrow4011(r: ArcRun) -> IEnumerable_1[Contract]:
                                    hash_5: int = r.GetLightHashCode() or 0
                                    def _arrow4010(__unit: None=None) -> IEnumerable_1[Contract]:
                                        ...
                                        if match_value_3 is not None:
                                            if DataMap__get_StaticHash(match_value_3) == 0:
                                                ...
                                                def _arrow4009(__unit: None=None) -> bool:
                                        ...
                                        if pattern_matching_result_3 == 0:
                                            def _arrow4007(__unit: None=None) -> IEnumerable_1[Contract]:
                                                DataMap__set_StaticHash_Z524259A4(dm_14, safe_hash(dm_14))
                                                return empty()

                                            return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForRun_Z721C83C5(dm_14, r.Identifier)), delay(_arrow4007))

                                        elif pattern_matching_result_3 == 1:
                                            def _arrow4008(__unit: None=None) -> IEnumerable_1[Contract]:
                                                DataMap__set_StaticHash_Z524259A4(dm_15, safe_hash(dm_15))
                                                return empty()

                                            return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForRun_Z721C83C5(dm_15, r.Identifier)), delay(_arrow4008))

                                        elif pattern_matching_result_3 == 2:
                                            return empty()


                                    return append(ARCtrl_ArcRun__ArcRun_ToCreateContract_6FCE9E49(r, True) if (r.StaticHash == 0) else (singleton_1(ARCtrl_ArcRun__ArcRun_ToUpdateContract(r)) if (r.StaticHash != hash_5) else empty()), delay(_arrow4010))

                                return collect(_arrow4011, this.Runs)

                            return append(collect(_arrow4006, this.Workflows), delay(_arrow4012))

                        return append(collect(_arrow4001, this.Assays), delay(_arrow4013))

                    return append(collect(_arrow3996, this.Studies), delay(_arrow4014))

                return append(singleton_1(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(this)) if (this.StaticHash != hash_1) else empty(), delay(_arrow4015))

            return to_array(delay(_arrow4016))
    ...
    def GetGitInitContracts(self, branch: str | None=None, repository_address: str | None=None, default_gitignore: bool | None=None, default_gitattributes: bool | None=None) -> Array[Contract]:
        ...
        def _arrow4020(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow4019(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow4018(__unit: None=None) -> IEnumerable_1[Contract]:
                    def _arrow4017(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton_1(gitattributes_contract) if default_gitattributes_1 else empty(), delay(_arrow4017))

                return append(singleton_1(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow4018))

            return append(singleton_1(Init_createInitContract_6DFDD678(branch)), delay(_arrow4019))

        return to_array(delay(_arrow4020))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_1(s_1: ArcStudy) -> Any:
            ...
            def _arrow4028(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow4027(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow4026(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow4025(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow4024(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow4023(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow4022(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton_1(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton_1(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow4022))

                                return append(singleton_1(text_value), delay(_arrow4023))

                            return collect(_arrow4024, table.Values)

                        return collect(_arrow4025, s_1.Tables)

                    return append(singleton_1(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow4026))

                return append(singleton_1(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow4027))

            class ObjectExpr4029:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow4028)), ObjectExpr4029())

        class ObjectExpr4030:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_2(a: ArcAssay) -> Any:
            ...
            def _arrow4037(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow4036(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow4035(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow4034(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow4033(kv_1: Any) -> IEnumerable_1[str]:
                                text_value_1: str = kv_1[1].ToFreeTextCell().AsFreeText
                                def _arrow4032(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow4031(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton_1(((((("" + assay_foldername) + "/") + "protocols") + "/") + text_value_1) + "")

                                    return append(singleton_1(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow4031))

                                return append(singleton_1(text_value_1), delay(_arrow4032))

                            return collect(_arrow4033, table_1.Values)

                        return collect(_arrow4034, a.Tables)

                    return append(singleton_1(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow4035))

                return append(singleton_1(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow4036))

            class ObjectExpr4038:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow4037)), ObjectExpr4038())

        class ObjectExpr4039:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr4021()), union_many(map_1(mapping_1, registered_studies, None), ObjectExpr4030()), union_many(map_1(mapping_2, registered_assays, None), ObjectExpr4039())]), ObjectExpr4040())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow4041(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not starts_with_exact(n_1, ".")

                return FileSystemTree.filter_folders(_arrow4041)(tree_1)

            else: 
                return tree_1


        def _arrow4043(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow4042(n: str) -> bool:
                return not starts_with_exact(n, ".")

            return FileSystemTree.filter_files(_arrow4042)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow4043()), FileSystemTree.from_file_paths([]))
    ...
    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr4044())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow4045(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not starts_with_exact(n_1, ".")

                return FileSystemTree.filter_folders(_arrow4045)(tree_1)

            else: 
                return tree_1


        def _arrow4047(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow4046(n: str) -> bool:
                return not starts_with_exact(n, ".")

            return FileSystemTree.filter_files(_arrow4046)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow4047()), FileSystemTree.from_file_paths([]))
    ...
    def DefaultContracts() -> Any:
        ...
        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr4048())
    ...
    def GetValidationPackagesConfigWriteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        ...
        if not contains_2(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr4051()):
    ...
    def GetValidationPackagesConfigDeleteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr4053:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow4052(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains_2(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr4053()):
            def predicate(p: str) -> bool:
...
def ARCAux_getArcInvestigationFromContracts(contracts: Array[Contract]) -> ArcInvestigation:
    ...
    def _arrow4056(x: ArcInvestigation, y: ArcInvestigation, contracts: Any=contracts) -> bool:
        return equals(x, y)

    if (len(match_value) == 1) if (not equals_with(_arrow4056, match_value, None)) else False:
