...
StudyInfo_reflection = _expr1108
...
def StudyInfo_ToSparseTable_1680536E(study: ArcStudy) -> SparseTable:
    ...
    class ObjectExpr1110:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1109(x: str, y: str) -> bool:
                return x == y
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr1110())), matrix.ColumnCount)
...
def to_rows(study: ArcStudy, assays: FSharpList[ArcAssay] | None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
    ...
    def _arrow1128(__unit: None=None, study: Any=study, assays: Any=assays) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
        def _arrow1127(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
            def _arrow1126(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                def _arrow1125(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                    def _arrow1124(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                        def _arrow1123(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                            def _arrow1122(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                def _arrow1121(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                    def _arrow1120(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                        def _arrow1119(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                            def _arrow1118(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                def _arrow1117(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                    def _arrow1116(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                        return to_rows_6("Study Person", of_seq(study.Contacts))

                                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY CONTACTS"]))), delay(_arrow1116))

                                                return append_1(to_rows_5("Study Protocol", protocols), delay(_arrow1117))

                                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY PROTOCOLS"]))), delay(_arrow1118))

                                        return append_1(to_rows_4("Study Assay", assays_1), delay(_arrow1119))

                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY ASSAYS"]))), delay(_arrow1120))

                                return append_1(to_rows_3("Study Factor", factors), delay(_arrow1121))

                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY FACTORS"]))), delay(_arrow1122))

                        return append_1(to_rows_2("Study Publication", of_seq(study.Publications)), delay(_arrow1123))

                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY PUBLICATIONS"]))), delay(_arrow1124))

                return append_1(to_rows_1("Study Design", of_seq(study.StudyDesignDescriptors)), delay(_arrow1125))

            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY DESIGN DESCRIPTORS"]))), delay(_arrow1126))

        return append_1(StudyInfo_toRows_1680536E(study), delay(_arrow1127))

    return delay(_arrow1128)
