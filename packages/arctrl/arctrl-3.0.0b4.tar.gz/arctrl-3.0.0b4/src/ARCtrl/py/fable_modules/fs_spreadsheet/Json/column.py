...
def _arrow326(builder: IGetters) -> tuple[int | None, IEnumerable_1[FsCell]]:
    n: int | None
    object_arg: IOptionalGetter = builder.Optional
    n = object_arg.Field("number", int_1)
    def _arrow325(__unit: None=None) -> IEnumerable_1[FsCell] | None:
    ...
    return (n, default_arg(_arrow325(), empty()))


decode: Decoder_1[tuple[int | None, IEnumerable_1[FsCell]]] = object(_arrow326)
