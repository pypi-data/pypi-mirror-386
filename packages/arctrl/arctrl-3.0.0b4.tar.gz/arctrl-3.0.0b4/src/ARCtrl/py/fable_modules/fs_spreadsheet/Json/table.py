...
def encode(sheet: FsTable) -> IEncodable:
    def _arrow320(__unit: None=None, sheet: Any=sheet) -> IEncodable:
    ...
    def _arrow322(__unit: None=None, sheet: Any=sheet) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("name", _arrow320()), ("range", _arrow322())])
