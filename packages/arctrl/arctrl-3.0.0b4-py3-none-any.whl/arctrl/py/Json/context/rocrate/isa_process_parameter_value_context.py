...
def _arrow1839(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1829()), ("additionalType", ObjectExpr1830()), ("ProcessParameterValue", ObjectExpr1831()), ("category", ObjectExpr1832()), ("categoryCode", ObjectExpr1833()), ("value", ObjectExpr1834()), ("valueCode", ObjectExpr1835()), ("unit", ObjectExpr1836()), ("unitCode", ObjectExpr1837())])
