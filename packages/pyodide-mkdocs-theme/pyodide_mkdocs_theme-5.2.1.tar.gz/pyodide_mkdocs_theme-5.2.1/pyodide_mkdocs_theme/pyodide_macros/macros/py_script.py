...
from ..files_extractors.concrete_extractors import GenericExtractor, PythonExtractor, SqlExtractor
...
def section(env:MaestroMacros):
    ...
    * This macro DOES NOT WORK with content built from different python files. Use the
    ...
    def _section(
        ...
        _, file_data = kls.get_file_extractor_for(env, py_name)
...
def composition_factory(env:MaestroMacros, func, ExtractorClass:Type[GenericExtractor], lang:str):
    ...
    def _composed(
        ...
        _, extractor = ExtractorClass.get_file_extractor_for(env, exo_name)
