...
The module provides:
- RadiatorType: Enumeration for radiator types and orientations
- Refrigerant: Refrigerant fluid properties and thermodynamic cycle calculations
- HeatPump: Heat pump system model with refrigerant cycle analysis
- WaterRadiator: Abstract base class for water radiators
