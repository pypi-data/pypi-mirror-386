"""Example: evaluate using all pre-existing behaviors from the server dataset."""
...
def main() -> None:
    ...
    # Evaluate against all behaviors from the server dataset
    ...
    out = Path(f"redteam_all_intents_{handle.id}.json")
