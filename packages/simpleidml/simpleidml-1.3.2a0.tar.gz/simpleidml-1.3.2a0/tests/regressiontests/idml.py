...
""")
                ...
                # Graphic.xml
                with prefixed_f.open("Resources/Graphic.xml") as f:
                    graphic = etree.fromstring(f.read())
                    self.assertEqual(graphic.xpath('Gradient/GradientStop')[0].get('StopColor'), 'FOOColor/u81')
