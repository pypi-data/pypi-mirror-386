...
#ifndef BN_OPENSSL_DISABLE
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecpublic_key_ssl_mb8,(
        BIGNUM* pa_pubx[8],
        BIGNUM* pa_puby[8],
        BIGNUM* pa_pubz[8],
...
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecpublic_key_mb8,(
        int64u* pa_pubx[8],
        int64u* pa_puby[8],
        int64u* pa_pubz[8],
...
#ifndef BN_OPENSSL_DISABLE
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecdh_ssl_mb8,(
...
*/
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecdsa_sign_setup_mb8,(
...
*/
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecdsa_sign_complete_mb8,(
        int8u* pa_sign_r[8],
        int8u* pa_sign_s[8],
...
*/
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecdsa_sign_mb8,(
        int8u* pa_sign_r[8],
        int8u* pa_sign_s[8],
        const int8u* const pa_msg[8],
        const int64u* const pa_eph_skey[8],
...
*/
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecdsa_verify_mb8,(
...
#ifndef BN_OPENSSL_DISABLE
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecdsa_sign_setup_ssl_mb8,(
...
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecdsa_sign_complete_ssl_mb8,(
        int8u* pa_sign_r[8],
        int8u* pa_sign_s[8],
        const int8u* const pa_msg[8],
...
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecdsa_sign_ssl_mb8,(
        int8u* pa_sign_r[8],
        int8u* pa_sign_s[8],
        const int8u* const pa_msg[8],
        const BIGNUM* const pa_eph_skey[8],
...
/* clang-format off */
MBXAPI(mbx_status, mbx_nistp384_ecdsa_verify_ssl_mb8,(
