...
from match_predicting_pub.api.models.training_result_dto import TrainingResultDTO  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TrainingResultDTO:
        ...
        if include_optional:
            return TrainingResultDTO(
                training_request = match_predicting_pub.api.models.training_request_dto.TrainingRequestDTO(
                    competition_ids = [
                        56
                        ], 
                    seasons = [
                    ...
                    number_of_epochs = 56, 
                    learning_rate = 1.337, 
                    training_network = match_predicting_pub.api.models.training_network_dto.TrainingNetworkDTO(
                        network_version = 56, 
