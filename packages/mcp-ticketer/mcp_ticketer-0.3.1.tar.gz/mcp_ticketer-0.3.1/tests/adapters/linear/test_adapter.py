...
from mcp_ticketer.core.models import Comment, Epic, Priority, SearchQuery, Task, TicketState
...
class TestLinearAdapterInit:
    ...
    def test_init_with_api_key_and_team_id(self):
        ...
        assert adapter.api_key == "Bearer test-api-key"
    ...
    def test_init_with_env_api_key(self):
        ...
        assert adapter.api_key == "Bearer env-api-key"
...
class TestLinearAdapterValidation:
    ...
    def test_validate_credentials_missing_team_info(self):
        ...
        adapter = LinearAdapter.__new__(LinearAdapter)
        adapter.api_key = "Bearer test-api-key"
