...
DEFAULT_TTL = core_settings.agent_cache_ttl
DEFAULT_MAX_SIZE = core_settings.agent_cache_max_size
DEFAULT_CLEANUP_INTERVAL = core_settings.agent_cache_cleanup_interval
