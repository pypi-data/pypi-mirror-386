...
class JenkinsSign(object):
    ...
    def docker_jenkins_job(self, job, repo_content, image_name, image_tag, arches, build_id):
        parameters = {"REPO_CONTENT": repo_content, "IMAGE_NAME": image_name, "IMAGE_TAG": image_tag, "ARCHES": arches, \
                      "BUILD_ID": build_id}
