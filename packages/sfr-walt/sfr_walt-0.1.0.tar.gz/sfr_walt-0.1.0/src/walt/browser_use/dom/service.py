...
from walt.browser_use.dom.views import (
	DOMBaseNode,
	DOMElementNode,
	DOMState,
	DOMTextNode,
...
class DomService:
	def __init__(self, page: 'Page', js_file: str = 'buildDomTree.js'):
		self.page = page
		self.xpath_cache = {}

		self.js_code = resources.read_text('walt.browser_use.dom', js_file)
