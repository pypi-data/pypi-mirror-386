...
QUARTERLY_METRICS = {
    "Q1": {"revenue": 4110000, "jobs": 195, "failure_rate": 0.18, "scrap_rate": 0.12, "oee": 0.58},
    "Q2": {"revenue": 3450000, "jobs": 162, "failure_rate": 0.21, "scrap_rate": 0.15, "oee": 0.53},
    "Q3": {"revenue": 3200000, "jobs": 148, "failure_rate": 0.16, "scrap_rate": 0.11, "oee": 0.56},
    "Q4": {"revenue": 3350000, "jobs": 155, "failure_rate": 0.15, "scrap_rate": 0.10, "oee": 0.58}
}
...
for quarter in QUARTERS:
    ...
    for _ in range(target_jobs):
        ...
        will_fail_first_article = random.random() < failure_rate
...
print("\n" + "=" * 80)
print(f"✓ Created 13 CNC operations files for {COMPANY_NAME}")
print("=" * 80)
...
for q in ["Q1", "Q2", "Q3", "Q4"]:
    ...
    print(f"  {q}: RM{m['revenue']:,.0f} revenue, {m['jobs']} jobs, {m['failure_rate']*100:.0f}% failure rate, {m['scrap_rate']*100:.0f}% scrap")
...
print("\nTotal: ~7,500+ operational records across 4 quarters (All in RM)")
print("=" * 80)
print("\nKey Insights Embedded:")
print("  - 18-21% first-article failure rate (Q1-Q2) improving to 15-16% (Q3-Q4)")
print("  - 60-70% of scrap is preventable with proper validation")
print("  - Cost overruns averaging 20-30% vs estimates")
print("  - Revenue decline: -16% Q1→Q2, stabilizing Q3-Q4")
print("  - Customer churn: Lost 5 customers, gained 7 new ones")
print("  - OEE improvement: 53% (Q2 low) to 58% (Q4)")
print("=" * 80)
