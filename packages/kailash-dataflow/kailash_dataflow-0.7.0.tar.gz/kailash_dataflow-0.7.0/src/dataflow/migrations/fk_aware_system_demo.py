...
from .fk_aware_e2e_workflows import E2EWorkflowPatternFactory, create_comprehensive_fk_workflow
...
class FKAwareSystemDemo:
    ...
    async def _validate_core_components(self) -> Dict[str, bool]:
        ...
        try:
            from .fk_safe_migration_executor import FKMigrationStage, FKSafeMigrationExecutor
        ...
        try:
            from .fk_aware_model_integration import FKAwareModelIntegrator, FKAwareModelTracker
