...
class DataFlow:
    ...
    def discover_schema(self, use_real_inspection: bool = True) -> Dict[str, Any]:
        ...
        if use_real_inspection:
            ...
            try:
                ...
                from ..adapters.exceptions import ConnectionError as DataFlowConnectionError
    ...
    def _trigger_postgresql_migration_system(
        ...
        try:
            ...
            from ..migrations.auto_migration_system import ColumnDefinition, TableDefinition
    ...
    async def _get_async_database_connection(self):
        ...
        from ..testing.tdd_support import get_database_manager, get_test_context, is_tdd_mode
