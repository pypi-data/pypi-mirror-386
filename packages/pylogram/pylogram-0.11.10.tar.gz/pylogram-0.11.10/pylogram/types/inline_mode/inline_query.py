...
from pylogram import types, enums
...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~pylogram.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <pylogram.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pylogram.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~pylogram.types.InlineQueryResult`):
