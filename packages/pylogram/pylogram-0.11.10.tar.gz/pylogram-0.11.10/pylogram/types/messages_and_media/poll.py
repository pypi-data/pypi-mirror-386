...
import pylogram
from pylogram import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~pylogram.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~pylogram.types.MessageEntity`, *optional*):
