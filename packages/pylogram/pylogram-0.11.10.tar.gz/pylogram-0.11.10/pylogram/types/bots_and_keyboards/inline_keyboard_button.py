...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~pylogram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~pylogram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~pylogram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~pylogram.types.CallbackGame`, *optional*):
