...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pylogram.Client.search_global_count`.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pylogram". Get the first 50 results
                async for message in app.search_global("pylogram", limit=50):
                    print(message.text)
