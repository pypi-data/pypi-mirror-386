...
from pylogram.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pylogram.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pylogram.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = await app.get_inline_bot_results("pylogrambot")
                print(results)
        """
