...
class CodeExecutorConfig(CodeMieToolConfig):
    ...
    security_threshold: SecurityIssueSeverity = Field(
        ...
        description="Security policy severity threshold. "
                    "Violations at or above this level will be blocked. "
    ...
    @classmethod
    def validate_security_threshold(cls, v) -> SecurityIssueSeverity:
        ...
        if isinstance(v, str):
            ...
            if v_upper not in threshold_map:
                raise ValueError(
                    f"Invalid security_threshold: {v}. Must be one of: SAFE, LOW, MEDIUM, HIGH"
                )
