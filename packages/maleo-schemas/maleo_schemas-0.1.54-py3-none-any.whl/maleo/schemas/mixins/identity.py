...
class PlaceOfBirth(BaseModel, Generic[OptDateT]):
    place_of_birth: OptDateT = Field(..., description="Place of Birth")


class PlaceOfBirths(BaseModel, Generic[OptListOfDatesT]):
    place_of_births: OptListOfDatesT = Field(..., description="Place of Births")
