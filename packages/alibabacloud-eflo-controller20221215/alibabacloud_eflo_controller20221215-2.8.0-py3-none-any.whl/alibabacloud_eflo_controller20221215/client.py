...
class Client(OpenApiClient):
    ...
    *\
    ...
    def get_hyper_node_with_options(
        self,
        request: eflo_controller_20221215_models.GetHyperNodeRequest,
        runtime: util_models.RuntimeOptions,
    ) -> eflo_controller_20221215_models.GetHyperNodeResponse:
        """
        @summary 查询节点列表
    ...
    async def get_hyper_node_with_options_async(
        self,
        request: eflo_controller_20221215_models.GetHyperNodeRequest,
        runtime: util_models.RuntimeOptions,
    ) -> eflo_controller_20221215_models.GetHyperNodeResponse:
    ...
    def get_hyper_node(
        ...
        """
        runtime = util_models.RuntimeOptions()
        return self.get_hyper_node_with_options(request, runtime)

    async def get_hyper_node_async(
        self,
        request: eflo_controller_20221215_models.GetHyperNodeRequest,
    ) -> eflo_controller_20221215_models.GetHyperNodeResponse:
        """
        ...
        """
        runtime = util_models.RuntimeOptions()
        return await self.get_hyper_node_with_options_async(request, runtime)
