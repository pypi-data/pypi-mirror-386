...
class GetHyperNodeRequest(TeaModel):
    def __init__(
        self,
        hyper_node_id: str = None,
    ):
...
class GetHyperNodeResponseBodyNodesDisks(TeaModel):
    def __init__(
        self,
        category: str = None,
        disk_id: str = None,
...
class GetHyperNodeResponseBodyNodesNetworks(TeaModel):
    def __init__(
        self,
        bond_name: str = None,
        ip: str = None,
...
class GetHyperNodeResponseBodyNodes(TeaModel):
    def __init__(
        self,
        disks: List[GetHyperNodeResponseBodyNodesDisks] = None,
        hostname: str = None,
        image_id: str = None,
        image_name: str = None,
        networks: GetHyperNodeResponseBodyNodesNetworks = None,
        node_id: str = None,
        status: str = None,
        user_data: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Disks') is not None:
            for k in m.get('Disks'):
                temp_model = GetHyperNodeResponseBodyNodesDisks()
                self.disks.append(temp_model.from_map(k))
        if m.get('Hostname') is not None:
            self.hostname = m.get('Hostname')
        if m.get('ImageId') is not None:
        ...
        if m.get('ImageName') is not None:
            self.image_name = m.get('ImageName')
        if m.get('Networks') is not None:
            temp_model = GetHyperNodeResponseBodyNodesNetworks()
            self.networks = temp_model.from_map(m['Networks'])
        if m.get('NodeId') is not None:
            self.node_id = m.get('NodeId')
        if m.get('Status') is not None:
...
class GetHyperNodeResponseBody(TeaModel):
    def __init__(
        self,
        cluster_id: str = None,
        cluster_name: str = None,
        ...
        node_group_id: str = None,
        node_group_name: str = None,
        nodes: List[GetHyperNodeResponseBodyNodes] = None,
        request_id: str = None,
        resource_group_id: str = None,
        status: str = None,
        zone_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Nodes') is not None:
            for k in m.get('Nodes'):
                temp_model = GetHyperNodeResponseBodyNodes()
                self.nodes.append(temp_model.from_map(k))
        if m.get('RequestId') is not None:
            self.request_id = m.get('RequestId')
        if m.get('ResourceGroupId') is not None:
...
class GetHyperNodeResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetHyperNodeResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetHyperNodeResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
