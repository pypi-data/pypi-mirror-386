...
class HTCContents(object):
    ...
    def add_section(self, section_name, members={}, section=None,
                    allow_duplicate=False,
                    begin_comments='', end_comments='',
        ...
        if section_name == "output":
            ...
            section = HTCSection(section_name, begin_comments=begin_comments,
...
class HTCSection(HTCContents):
    ...
    def __init__(self, name, begin_comments="", end_comments="",
        ...
        self.pre_comments = pre_comments.strip(" \t")
        self.post_comments = post_comments.strip(" \t")
