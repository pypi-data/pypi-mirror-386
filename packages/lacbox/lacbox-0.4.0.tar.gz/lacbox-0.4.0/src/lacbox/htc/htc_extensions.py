...
class HTCDefaults(object):
    ...
    def add_mann_turbulence(self, L=29.4, ae23=1, Gamma=3.9, seed=1001, high_frq_compensation=True,
                            ...
                            dont_scale=False,
                            std_scaling=None):
        """Add Mann turbulence block to htc file.

        Args:
            L (int/float, optional): Length scale. Defaults to 29.4.
            ae23 (int/int, optional): Alpha-epsilon^(2/3). Defaults to 1.
            Gamma (int/float, optional): Anisotropic parameter. Defaults to 3.9.
            seed (int, optional): Random seed. Defaults to 1001.
            high_frq_compensation (bool, optional): Include high-frequency
                compensation? Defaults to True.
            filenames (list/str, optional): If list, 3-element list of paths to
                u, v, w turbulence files. If string, turbulence files will become
                '$STRING_s$SEED$C'. Defaults to None, i.e., names will be
                autogenerated from parameters.
            no_grid_points (tuple, optional): 3-element tuple of grid size for
                turbulence boxes. Defaults to (16384, 32, 32).
            box_dimension (tuple, optional): Size of the turbulence box in meters.
                Defaults to (6000, 100, 100).
            dont_scale (bool, optional): Whether to scale the turbulence box to
                the desired turbulence intensity. Defaults to False.
            std_scaling (list/tuple, optional): 3-element iterable of standard 
                deviations, used for optional scaling. Defaults to None, i.e., no
                std_scaling.
        """
