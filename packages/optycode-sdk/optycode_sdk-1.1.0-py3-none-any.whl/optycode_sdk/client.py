...
class OptycodeAPI:
    ...
    def log_data_async(self, user_question: str, model_answer: str, model_id: str, session_id= None, model_input= None, question_id= None, rag_elements= None, attachment=None, timeout=0.01):
        payload = {
            "timestamp": datetime.now().isoformat(),
            "question": user_question,
            "answer": model_answer,
