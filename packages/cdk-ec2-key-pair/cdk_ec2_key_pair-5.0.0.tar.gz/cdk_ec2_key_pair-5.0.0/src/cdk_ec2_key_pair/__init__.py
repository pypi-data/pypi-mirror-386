...
class KeyPair(
    ...
    @builtins.property
    @jsii.member(jsii_name="privateKeySecret")
    def private_key_secret(self) -> _aws_cdk_aws_secretsmanager_ceddda9d.ISecret:
        '''The private key secret in AWS Secrets Manager.'''
        return typing.cast(_aws_cdk_aws_secretsmanager_ceddda9d.ISecret, jsii.get(self, "privateKeySecret"))
    ...
    @builtins.property
    @jsii.member(jsii_name="publicKeySecret")
    def public_key_secret(
        self,
        ...
        '''
        return typing.cast(typing.Optional[_aws_cdk_aws_secretsmanager_ceddda9d.ISecret], jsii.get(self, "publicKeySecret"))
