    ...
    def get_stake_info(self) -> dict[str, Any]:
        ...
        def _normalize(entries: list[dict[str, Any]]) -> tuple[list[dict[str, Any]], int, dict[str, int]]:
            ...
            for entry in entries:
                ...
                normalized_entry["amountSun"] = amount_value
                normalized_entry["amountTrx"] = str(Decimal(amount_value) / Decimal(1_000_000))
        ...
        return {
            ...
            "totalFrozenIncludeDelegatedInSun": tron_power,
