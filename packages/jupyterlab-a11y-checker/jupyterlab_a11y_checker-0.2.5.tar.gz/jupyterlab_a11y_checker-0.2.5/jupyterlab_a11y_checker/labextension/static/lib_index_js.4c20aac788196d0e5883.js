...
async function detectHeadingOneIssue(rawMarkdown, cellIndex, cellType, cells) {
    ...
    if (firstCell.model.type === 'markdown') {
        ...
        const firstToken = tokens.find((t) => t && t.type !== 'space' && (t.raw || '').trim().length > 0);
...
//# sourceMappingURL=lib_index_js.4c20aac788196d0e5883.js.map