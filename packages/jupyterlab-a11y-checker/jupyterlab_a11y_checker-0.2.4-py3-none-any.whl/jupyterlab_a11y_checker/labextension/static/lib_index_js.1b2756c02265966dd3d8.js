...
async function fetchImageAsBase64(imageUrl) {
    ...
    // Enforce client-side blob size cap (10 MiB default)
    const maxBytes = 10 * 1024 * 1024;
    if (typeof imageBlob.size === 'number' && imageBlob.size > maxBytes) {
        throw new Error(`Image exceeds size limit (${imageBlob.size} bytes > ${maxBytes} bytes)`);
    }
...
//# sourceMappingURL=lib_index_js.1b2756c02265966dd3d8.js.map