        ...
        if os.path.isdir(path):
            ...
            for i in range(num_to_delete):
                try:
                    ...
                    # Catch anything unexpected (non-OSError)
                    print(f"Unexpected error deleting file {files[i]}: {e}")
        ...
        if os.path.isdir(path):
            ...
            for i in range(num_to_delete):
                try:
                    ...
                    # Catch any other unexpected errors (non-OSError types)
                    print(f"Unexpected error deleting folder {folders[i]}: {e}")
