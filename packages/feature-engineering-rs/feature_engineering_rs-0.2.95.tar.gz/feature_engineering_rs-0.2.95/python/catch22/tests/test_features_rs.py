...
def load_benchmark_datasets():
    ...
    benchmark_datasets = {}
    inputs_folder_path = 'python/catch22/tests/validation/inputs/*'
...
def load_expected_outputs():
    ...
    expected_outputs = {}
    outputs_folder_path = 'python/catch22/tests/validation/expected_outputs/*'
...
def compute_new_features():
    ...
    for dset in datasets:
        ...
        res = catch22_all_f(test_data, catch24=True, normalize=True)
