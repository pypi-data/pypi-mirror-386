...
def load_benchmark_datasets():
    ...
    benchmark_datasets = {}
    inputs_folder_path = 'python/tsfeatures/tests/validation/inputs/*'
...
def load_expected_outputs():
    ...
    expected_outputs = {}
    outputs_folder_path = 'python/tsfeatures/tests/validation/expected_outputs/*'
...
def compute_new_features():
    ...
    for dset in datasets:
        ...
        res = tsfeatures_all_f(test_data, normalize=False, freq=12)
...
def test_features(dset, exp_out, new_out):
    ...
    assert len(exp_out.keys()) == 14, f"Expected 14 features in expected output for dataset: {dset}."
    assert len(new_out.keys()) == 14, f"Expected 14 features in new output for dataset: {dset}."
