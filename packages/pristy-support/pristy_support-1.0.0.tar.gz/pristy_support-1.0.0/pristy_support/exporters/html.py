    ...
    <div class="container">
        ...
        <div class="toc">
            ...
            <ul>
                ...
                {% endif %}
                {% if data.logs %}
                <li><a href="#logs-analysis">Logs Analysis</a></li>
                {% endif %}
                {% if data.config %}
                <li><a href="#configuration-review">Configuration Review</a></li>
                {% endif %}
            </ul>
        </div>
        ...
        <div class="section" id="database-statistics">
            ...
            <h3>Group and Site Statistics</h3>
            <div class="metric">
                <div class="metric-card">
        ...
        <div class="section" id="configuration-review">
            ...
            <h3>Pristy Applications Configuration</h3>
