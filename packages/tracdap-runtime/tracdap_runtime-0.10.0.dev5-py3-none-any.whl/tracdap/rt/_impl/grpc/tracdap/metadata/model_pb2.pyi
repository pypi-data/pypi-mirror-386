...
class ModelResource(_message.Message):
    __slots__ = ("resourceType", "protocol", "subProtocol", "system", "label", "resourceProps")
    class ResourcePropsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: str
    ...
    LABEL_FIELD_NUMBER: _ClassVar[int]
    RESOURCEPROPS_FIELD_NUMBER: _ClassVar[int]
    resourceType: _resource_pb2.ResourceType
    protocol: str
    subProtocol: str
    system: ModelSystemDetails
    label: str
    resourceProps: _containers.MessageMap[str, _type_pb2.Value]
    def __init__(self, resourceType: _Optional[_Union[_resource_pb2.ResourceType, str]] = ..., protocol: _Optional[str] = ..., subProtocol: _Optional[str] = ..., system: _Optional[_Union[ModelSystemDetails, _Mapping]] = ..., label: _Optional[str] = ..., resourceProps: _Optional[_Mapping[str, _type_pb2.Value]] = ...) -> None: ...
