...
class FlowNode(_message.Message):
    __slots__ = ("nodeType", "parameters", "inputs", "outputs", "resources", "nodeSearch", "nodeResourceSearch", "nodeAttrs", "nodeProps", "label")
    ...
    NODERESOURCESEARCH_FIELD_NUMBER: _ClassVar[int]
    ...
    nodeResourceSearch: _model_pb2.ModelResource
