...
#
# 4.0 250911 - changed exception logging
...
from lanmonitor.lanmonfuncs import next_summary_dt, RTN_PASS, RTN_WARNING, RTN_FAIL, RTN_CRITICAL
...
class notif_class:
    ...
    def __init__(self):
        ...
        self.next_summary = next_summary_dt()
    ...
    def log_event (self, dict):
        ...
        Passed in dict keys:
            ...
            rslt
                ...
                (RTN_DISREGARD events are not passed to the notification handlers)
    ...
    def each_loop(self):
        ...
        for key in inst_dict:
            if inst_dict[key]:                  # Will be False if failed in setup()
