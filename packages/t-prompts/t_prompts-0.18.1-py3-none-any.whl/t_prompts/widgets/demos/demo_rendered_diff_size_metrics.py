"""Demo: RenderedPromptDiff - Major Project Restructure

This demo shows how RenderedPromptDiff visualizes text-level changes in a
major project overhaul, demonstrating size metrics for significant text changes.

Run with:
    python -m t_prompts.widgets.demos.demo_rendered_diff_size_metrics

Or use in a notebook:
    from t_prompts.widgets.demos.demo_rendered_diff_size_metrics import create_rendered_diff_size_metrics_demo
    create_rendered_diff_size_metrics_demo()
"""

from t_prompts import dedent, diff_rendered_prompts, prompt
...
def create_rendered_diff_size_metrics_demo():
    """Create a RenderedPromptDiff showing a major project restructure."""
...
if __name__ == "__main__":
    run_preview(__file__, create_rendered_diff_size_metrics_demo)
