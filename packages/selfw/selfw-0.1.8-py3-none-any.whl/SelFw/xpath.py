...
def agregar_clase_valid(xpath, driver, timeout=10):
    """
    Añade la clase 'valid' a un elemento localizado por XPath sin eliminar otras clases.
    ...
    try:
        ...
        # Ejecuta JavaScript para añadir la clase 'valid'
