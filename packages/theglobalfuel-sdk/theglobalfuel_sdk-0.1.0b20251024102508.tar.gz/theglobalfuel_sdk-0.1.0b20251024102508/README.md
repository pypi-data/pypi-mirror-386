# Theglobalfuel Sdk-python

A Python SDK theglobalfuel for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
from theglobalfuel_sdk.types.common import UserRegisterInput
...
```python
from theglobalfuel_sdk import BoilerSDKConfig
...
pytest --cov=theglobalfuel_sdk --cov-report=html
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/theglobalfuel-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/theglobalfuel-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../theglobalfuel-frontend) - Frontend theglobalfuel
- [Boiler Backend](../theglobalfuel-python-be-graphql) - Python GraphQL backend theglobalfuel