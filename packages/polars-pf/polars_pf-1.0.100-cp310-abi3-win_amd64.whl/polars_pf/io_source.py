    ...
    try:
        ...
        def source_generator(
            ...
            try:
                ...
                ptable = pframe.create_table(new_request, getTableId())
                try:
                    ...
                    logger and logger(
                        LogLevel.Info,
                        f"PFrame {frame_id} table with path {table_path} disposed",
                    )
