...
ElementResponseModel ElementResponseModelFromString(
  ...
  } else if (element_response_upper == "OSKAR_DIPOLE_COS2" ||
             element_response_upper == "OSKARDIPOLECOS2") {
    element_response_enum = everybeam::ElementResponseModel::kOSKARDipoleCos2;
