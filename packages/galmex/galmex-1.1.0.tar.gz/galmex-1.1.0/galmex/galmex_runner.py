...
class GalaxyMorphometrics:
    ...
    def subtract_background(self):
        ...
        return bkg_median, bkg_std, bkg_image, image_nobkg
    ...
    def detect_objects(self):
        ...
        return catalog, first_segmentation, main_id
    ...
    def petrosian_analysis(self):
        ...
        # Compute R50
        r50,_,_ = rp_calc.calculate_fractional_radius(
                aperture=aperture,
                step=step
            )
        ...
        return rp, r50, radius, eta, growth_curve, eta_flag
    ...
    def generate_simulated_images(self):
        n = self.config["initial_settings"].get("nsim", 10)
    ...
    def measure_asymmetry(self):
        ...
        def compute_asym(image):
            ...
            half = len(asy_img) // 2
            asym = Asymmetry(asy_img, segmentation=mask_mini, noise=noise)

            if formula == "pixel-wise":
                A_total, A_gal, A_noise, center, center_noise, niter_gal, niter_noise = asym.get_conselice_asymmetry(method="absolute", pixel_comparison="simple", max_iter=50)
            elif formula == "correlation":
                A, r_max, center, niter = asym.get_ferrari_asymmetry(corr_type="spearman", pixel_comparison="simple", max_iter=50)
            else:
    ...
    def measure_m20(self):
        ...
        return m20, round(m20_xc), round(m20_yc)
...
#        header_label.pack(pady=(20, 10))
        ...
        self.sep_fw_var = tk.IntVar(value = 3)
        ...
        self.sep_fh_var = tk.IntVar(value = 3)
