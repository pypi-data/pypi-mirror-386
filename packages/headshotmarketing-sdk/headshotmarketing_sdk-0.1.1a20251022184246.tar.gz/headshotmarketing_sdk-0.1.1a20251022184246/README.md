# Headshotmarketing Sdk-python

A Python SDK headshotmarketing for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from headshotmarketing_sdk import BoilerSDK, BoilerSDKConfig
from headshotmarketing_sdk.types.common import UserRegisterInput
...
```python
from headshotmarketing_sdk import BoilerSDKConfig
...
pytest --cov=headshotmarketing_sdk --cov-report=html
```
...
# Run with coverage
pytest --cov=headshotmarketing_sdk
...
```bash
mypy src/headshotmarketing_sdk
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/headshotmarketing-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/headshotmarketing-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../headshotmarketing-frontend) - Frontend headshotmarketing
- [Boiler Backend](../headshotmarketing-python-be-graphql) - Python GraphQL backend headshotmarketing