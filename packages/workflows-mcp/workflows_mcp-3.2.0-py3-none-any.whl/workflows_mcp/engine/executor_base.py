...
def create_default_registry() -> ExecutorRegistry:
    ...
    """
    from .executor_workflow import ExecuteWorkflowExecutor
    from .executors_core import ShellExecutor
    from .executors_file import CreateFileExecutor, RenderTemplateExecutor, ReadFileExecutor
    ...
    registry.register(ExecuteWorkflowExecutor())  # ADR-006: Returns Execution, not BlockOutput
