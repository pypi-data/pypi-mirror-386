#!/usr/bin/env python3
"""
xwnode Core Tests Runner
======================

Simple script to run xwnode core tests independently.
...
def main():
    """Run the xwnode core tests."""
    try:
        # Setup environment first
        project_root, src_path = setup_environment()
        
        current_dir = Path(__file__).parent
        test_file = current_dir / "test_xwnode_core.py"
        
        print("🧪 Running xwnode Core Tests")
        print("=" * 40)
