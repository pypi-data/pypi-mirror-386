...
class EasyGUI:
    """
    EasyGUI — Beginner-friendly Python GUI wrapper using DearPyGui v2.x.
    Features:
      - Tag-based widgets
      ...
      - Supports font size for labels and buttons
    """
    ...
    def __init__(self, title="EasyGUI", size=(600, 400), bg_color=[50,50,50],
        ...
        self._tags = {}
        self._fonts = {}  # font cache by size
    ...
    def _get_font(self, size):
        ...
        if size not in self._fonts:
            self._fonts[size] = dpg.add_font(dpg.get_default_font(), size)
    ...
    def add_label(self, text, tag=None, fg=None, font_size=16):
        ...
        dpg.bind_item_font(lbl, self._get_font(font_size))
        self._tags[tag] = lbl
        return lbl
    ...
    def add_button(self, text, callback, args_tags=None, args=None, fg=None, bg=None, font_size=14, tag=None):
        ...
        dpg.bind_item_font(btn, self._get_font(font_size))
        self._tags[tag] = btn
        return btn
