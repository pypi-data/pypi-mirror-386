...
from elabapi_python.models.compound_create_request import CompoundCreateRequest  # noqa: E501
...
class TestCompoundCreateRequest(unittest.TestCase):
    ...
    def testCompoundCreateRequest(self):
        ...
        # model = elabapi_python.models.compound_create_request.CompoundCreateRequest()  # noqa: E501
        pass
