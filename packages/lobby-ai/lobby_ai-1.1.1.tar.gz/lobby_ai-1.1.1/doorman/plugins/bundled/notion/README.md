...
Integration with Notion API for knowledge management and documentation

## Installation

1. Copy this plugin directory to your Doorman plugins folder:
   ```bash
   cp -r notion ~/.doorman/plugins/
   ```
...
1. Edit `notion_plugin.py` with your custom logic
2. Update `plugin.toml` if you change capabilities or requirements
3. Test with: `doorman plugins test notion`
