...
Integration with Zapier API for workflow automation and app connections

## Installation

1. Copy this plugin directory to your Doorman plugins folder:
   ```bash
   cp -r zapier ~/.doorman/plugins/
   ```
...
1. Edit `zapier_plugin.py` with your custom logic
2. Update `plugin.toml` if you change capabilities or requirements
3. Test with: `doorman plugins test zapier`
