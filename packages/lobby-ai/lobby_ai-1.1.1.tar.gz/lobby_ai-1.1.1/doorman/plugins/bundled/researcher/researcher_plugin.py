"""
Researcher Agent Plugin for Doorman.
...
class Plugin(AgentPlugin):
    """Main plugin class for researcher agent."""

    def __init__(self, config: Dict[str, Any]):
        super().__init__(config)

        # Plugin configuration
        self.specialization = config.get("specialization", "researcher")
    ...
    def get_sprite_config(self) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "color_scheme": self.config.get("color_scheme", "green"),
            "accessories": ["magnifying_glass", "books"],
        }
