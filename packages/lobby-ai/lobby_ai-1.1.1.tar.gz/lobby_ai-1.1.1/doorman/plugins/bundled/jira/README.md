...
Integration with Jira API for issue tracking and project management

## Installation

1. Copy this plugin directory to your Doorman plugins folder:
   ```bash
   cp -r jira ~/.doorman/plugins/
   ```
...
1. Edit `jira_plugin.py` with your custom logic
2. Update `plugin.toml` if you change capabilities or requirements
3. Test with: `doorman plugins test jira`
