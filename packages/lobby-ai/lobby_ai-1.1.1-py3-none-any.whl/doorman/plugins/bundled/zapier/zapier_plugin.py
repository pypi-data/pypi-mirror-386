"""
Zapier Tool Plugin for Doorman.
...
class Plugin(ToolPlugin):
    """Main plugin class for zapier tool."""

    def __init__(self, config: Dict[str, Any]):
        super().__init__(config)

        # Tool configuration
        self.tool_name = config.get("tool_name", "zapier")
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            "name": self.tool_name,
            "description": "Tool for zapier-related operations",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "operation": {
