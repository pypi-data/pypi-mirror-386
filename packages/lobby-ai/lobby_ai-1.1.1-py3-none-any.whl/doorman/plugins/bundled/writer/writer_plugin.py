"""
Writer Agent Plugin for Doorman.
...
class Plugin(AgentPlugin):
    """Main plugin class for writer agent."""

    def __init__(self, config: Dict[str, Any]):
        super().__init__(config)

        # Plugin configuration
        self.specialization = config.get("specialization", "writer")
    ...
    def get_sprite_config(self) -> Optional[Dict[str, Any]]:
        ...
        return {
            "archetype": "writer",
            "color_scheme": self.config.get("color_scheme", "teal"),
            "accessories": ["coffee", "notebook"],
        }
