...
from durableagent.state import AgentState
...
class TestAgentStateCorrelationId:
    ...
    def test_add_assistant_message_with_correlation_id(self) -> None:
        ...
        message_metadata: Dict[str, object] = state.conversation_history[-1].additional_properties or {}
    ...
    def test_get_state_does_not_duplicate_agent_responses(self) -> None:
        state = AgentState()
