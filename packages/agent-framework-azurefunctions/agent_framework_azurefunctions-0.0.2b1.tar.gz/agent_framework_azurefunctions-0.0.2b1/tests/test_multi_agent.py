...
class TestMultiAgentInit:
    ...
    def test_init_with_agents_list(self):
    ...
    def test_init_with_agent_without_name(self):
...
class TestAddAgentMethod:
    ...
    def test_add_agent_to_empty_app(self):
    ...
    def test_add_agent_with_duplicate_name_raises_error(self):
    ...
    def test_add_agent_to_app_with_existing_agents(self):
    ...
    def test_add_agent_without_name_raises_error(self):
