...
def create(name):
    ...
    archivos = {
        ...
        "app/components/http/domain/entities/response.py": 'microservice/http_entity_response.txt',
        "app/components/http/domain/repositories/http_repository.py": 'microservice/http_repository.txt',
        "app/components/http/infrastructure/repositories/http_repository_impl.py": 'microservice/http_repository_impl.txt',
        "app/components/http/infrastructure/repositories/responser.py": 'microservice/http_infrastructure_responser.txt',
        "app/components/http/infrastructure/customer_service.py": 'microservice/http_customer_service.txt',
