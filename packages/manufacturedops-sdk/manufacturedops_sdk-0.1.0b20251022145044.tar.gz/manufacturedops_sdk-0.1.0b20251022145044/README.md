# Manufacturedops Sdk-python

A Python SDK manufacturedops for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
pip install manufacturedops-sdk
...
```python
import asyncio
from manufacturedops_sdk import BoilerSDK, BoilerSDKConfig
from manufacturedops_sdk.types.common import UserRegisterInput
...
```python
from manufacturedops_sdk import BoilerSDKConfig
...
pytest --cov=manufacturedops_sdk --cov-report=html
```
...
# Run with coverage
pytest --cov=manufacturedops_sdk
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/manufacturedops-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/manufacturedops-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../manufacturedops-frontend) - Frontend manufacturedops
- [Boiler Backend](../manufacturedops-python-be-graphql) - Python GraphQL backend manufacturedops