...
def config_show() -> None:
    ...
    display.console.print(f"[yellow]User ID:[/yellow] {config.user_id}")
    display.console.print(f"[yellow]Environment:[/yellow] {config.environment}")
    display.console.print(f"[yellow]Show Thinking:[/yellow] {config.display.show_thinking}")
    display.console.print(f"[yellow]Show Tools:[/yellow] {config.display.show_tools}")
        ...
        while True:
            ...
            if user_input.startswith("/"):
                if user_input == "/exit":
                    ...
                    display.console.print(f"[yellow]User:[/yellow] {config.user_id}\n")
                    continue
                else:
