...
from wagtailmodelsearch.signal_handlers import register_signal_handlers


class ModelSearchAppConfig(AppConfig):
    name = "wagtailmodelsearch"
    label = "wagtailmodelsearch"
    verbose_name = "Wagtail ModelSearch"
    ...
    def ready(self):
        ...
        if connection.vendor == "postgresql":
            ...
            from wagtailmodelsearch.backends.database.postgres.weights import (
                set_weights,
            )
