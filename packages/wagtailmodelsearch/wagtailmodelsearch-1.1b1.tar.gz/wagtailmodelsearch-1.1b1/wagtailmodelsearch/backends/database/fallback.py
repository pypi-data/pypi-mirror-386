...
from wagtailmodelsearch.query import And, Boost, MatchAll, Not, Or, Phrase, PlainText
from wagtailmodelsearch.utils import AND, OR
...
# * 'wagtailmodelsearch.backends.database.fallback' is specified directly as the search backend
...
# This line allows using 'wagtailmodelsearch.backends.database.fallback' as the backend, bypassing the automatic selection of the backend that would get run if the user chose 'wagtailmodelsearch.backends.database'
