...
INSTALLED_APPS = [
    "wagtailmodelsearch.test.testapp",
    "wagtailmodelsearch",
    "taggit",
...
ROOT_URLCONF = "wagtailmodelsearch.test.urls"
...
MODELSEARCH_BACKENDS = {
    "default": {
        "BACKEND": {
            "db": "wagtailmodelsearch.backends.database",
            "elasticsearch7": "wagtailmodelsearch.backends.elasticsearch7",
            "elasticsearch8": "wagtailmodelsearch.backends.elasticsearch8",
            "elasticsearch9": "wagtailmodelsearch.backends.elasticsearch9",
            "opensearch2": "wagtailmodelsearch.backends.opensearch2",
            "opensearch3": "wagtailmodelsearch.backends.opensearch3",
        }[SEARCH_BACKEND]
    }
}
