...
from wagtailmodelsearch.query import MATCH_ALL, Fuzzy, Phrase
...
try:
    ...
    from wagtailmodelsearch.backends.elasticsearch7 import Elasticsearch7SearchBackend
except ImportError:
...
class TestElasticsearch7SearchBackend(ElasticsearchCommonSearchBackendTests, TestCase):
    backend_path = "wagtailmodelsearch.backends.elasticsearch7"
...
@unittest.skipIf(ELASTICSEARCH_VERSION[0] != 7, "Elasticsearch 7 required")
@mock.patch(
    "wagtailmodelsearch.backends.elasticsearch7.Elasticsearch7SearchBackend.client_class"
)
