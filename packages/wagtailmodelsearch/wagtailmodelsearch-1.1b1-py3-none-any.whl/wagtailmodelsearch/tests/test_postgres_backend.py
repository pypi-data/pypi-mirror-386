...
from wagtailmodelsearch.query import Phrase
...
@override_settings(
    MODELSEARCH_BACKENDS={
        "default": {
            "BACKEND": "wagtailmodelsearch.backends.database.postgres.postgres",
        }
    }
)
class TestPostgresSearchBackend(BackendTests, TestCase):
    backend_path = "wagtailmodelsearch.backends.database.postgres.postgres"
