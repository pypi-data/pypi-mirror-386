...
**data** | [**DtoBatchAlgorithmExecutionResponse**](DtoBatchAlgorithmExecutionResponse.md) |  | [optional] 
...
dto_generic_response_dto_batch_algorithm_execution_response_form_dict = dto_generic_response_dto_batch_algorithm_execution_response.from_dict(dto_generic_response_dto_batch_algorithm_execution_response_dict)
```
