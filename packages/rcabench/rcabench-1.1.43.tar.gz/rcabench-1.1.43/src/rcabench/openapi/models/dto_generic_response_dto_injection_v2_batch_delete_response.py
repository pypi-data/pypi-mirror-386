...
class DtoGenericResponseDtoInjectionV2BatchDeleteResponse(BaseModel):
    ...
    data: Optional[DtoInjectionV2BatchDeleteResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoInjectionV2BatchDeleteResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
