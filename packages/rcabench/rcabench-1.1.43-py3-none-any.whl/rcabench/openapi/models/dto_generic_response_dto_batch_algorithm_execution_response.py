...
class DtoGenericResponseDtoBatchAlgorithmExecutionResponse(BaseModel):
    ...
    data: Optional[DtoBatchAlgorithmExecutionResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoBatchAlgorithmExecutionResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
