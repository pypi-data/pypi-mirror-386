...
application_service_page_fields = [
    "id",
    "name",
    "created",
    "org_id",
...
def update_application_configs(  # noqa
    ...
    client_injection_login_form_password_navigation_delay=None,
    **kwargs,
):
    ...
    if client_injection_login_form_password_navigation_delay is not None:
        login_config = _get_login_config()
        form_config = login_config.setdefault("form_config", {})
        form_config["password_navigation_delay_ms"] = (
            client_injection_login_form_password_navigation_delay
        )
