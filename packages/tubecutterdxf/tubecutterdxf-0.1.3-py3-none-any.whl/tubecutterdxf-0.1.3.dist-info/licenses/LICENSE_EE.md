# The TubeCutterDXF Enterprise License (the “Enterprise License”)

Copyright (c) 2024-present Quinton Wiebe.

With regard to the TubeCutterDXF Software:

This software and associated documentation files (the "Software") may only be used in production, if
you (and any entity that you represent) hold a valid TubeCutterDXF Enterprise license corresponding to your
usage. Subject to the foregoing sentence, you are free to modify this Software and publish patches
to the Software. You agree that Quinton Wiebe and/or its licensors (as applicable) retain all right, title and
interest in and to all such modifications and/or patches, and all such modifications and/or patches
may only be used, copied, modified, displayed, distributed, or otherwise exploited with a valid TubeCutterDXF
...
agree that Quinton Wiebe and/or its licensors (as applicable) retain all right, title and interest in and to
...
For all third party components incorporated into the TubeCutterDXF Software, those components are licensed
