# Copyright (C) 2024-2025, Quinton Wiebe
...
class CutBrick:
    def __init__(self, OD, offsetX, offsetA, cutLength, numRadialCuts, spacingA, pitch, instances, variableCutLength=False, cutIncrease=0, variablePitch=False, pitchIncrease=0, continuous=False):
        self.type = 'CutBrick'
        self.OD = OD
        self.offsetX = offsetX
        self.offsetA = offsetA
        ...
        self.pitchIncrease = pitchIncrease
        self.instances = instances
        self.continuous = continuous
...
class CutPattern:
    ...
    def draw(self):
        ...
        for cut in self._cuts:
            linecount += cut.draw(self._dxf)
        
        print(f'Drew {linecount} lines')
        return linecount
