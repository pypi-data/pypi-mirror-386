...
@click.pass_context
def query(ctx, database: str, collection: str, filter: Optional[str], sort: Optional[str], 
          limit: int, offset: int, fields: Optional[str]):
...
@click.pass_context
def insert(ctx, database: str, collection: str, data: str, schema: Optional[str], validate: bool):
...
@click.pass_context
def candles(ctx, pair: str, period: str, start: Optional[str], end: Optional[str], 
...
@click.option("--sort-order", default="asc", type=click.Choice(["asc", "desc"]), help="Sort order")
@click.pass_context
def trades(ctx, pair: str, start: Optional[str], end: Optional[str], 
           limit: int, offset: int, sort_order: str):
