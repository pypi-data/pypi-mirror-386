...
class ScreenAreaSelector:
    ...
    AREA_OPTIONS = [
        ('chat_panel', 'Chat Panel - Entire Copilot chat panel'),
        ...
        ('chat_display_bottom_text', 'Chat Display Bottom Text - Bottom text showing model name')
    ]
...
class InteractiveGuide:
    ...
    def on_area_configured(self, area: AreaSelection):
