...
class Application:
    ...
    def __init__(self):
        if not self._initialized:
            ...
            # size
            self.executor_worker_size = config_default.get("executor_worker_size", 10)
            self.executor_down_size = config_default.get("executor_down_size", 20)
            self.executor_merge_size = config_default.get("executor_merge_size", 5)
