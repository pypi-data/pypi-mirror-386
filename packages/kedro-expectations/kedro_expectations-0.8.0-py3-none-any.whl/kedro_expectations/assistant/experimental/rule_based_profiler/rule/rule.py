...
if TYPE_CHECKING:
    ...
    from kedro_expectations.assistant.experimental.rule_based_profiler.domain_builder import (
        DomainBuilder,
    )
    from kedro_expectations.assistant.experimental.rule_based_profiler.expectation_configuration_builder import (  # noqa: E501 # FIXME CoP
