...
from kedro_expectations.assistant.experimental.rule_based_profiler.semantic_type_filter import (
...
class ColumnDomainBuilder(DomainBuilder):
    ...
    def get_filtered_column_names(  # noqa: C901 # FIXME CoP
        ...
        if semantic_type_filter_module_name is None:
            semantic_type_filter_module_name = "kedro_expectations.assistant.experimental.rule_based_profiler.helpers.simple_semantic_type_filter"  # noqa: E501 # FIXME CoP
