...
if TYPE_CHECKING:
    ...
    from kedro_expectations.assistant.experimental.rule_based_profiler.rule.rule import Rule
    from kedro_expectations.assistant.experimental.rule_based_profiler.rule_based_profiler import (
        RuleBasedProfiler,
    )
