...
class ApiMetricsReportingDTOV2(BaseModel):
    """
    ApiMetricsReportingDTOV2
    """ # noqa: E501
    aggregations: Optional[List[ApiMetricsReportingAggregationDTOV2]] = None
    ...
    __properties: ClassVar[List[str]] = ["aggregations", "applicationId", "applicationName", "applicationPublicId", "organizationId", "organizationName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiMetricsReportingDTOV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiMetricsReportingDTOV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "aggregations": [ApiMetricsReportingAggregationDTOV2.from_dict(_item) for _item in obj["aggregations"]] if obj.get("aggregations") is not None else None,
