...
class TestApiPolicyWaiversApplicableToViolationDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiPolicyWaiversApplicableToViolationDTO:
        """Test ApiPolicyWaiversApplicableToViolationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiPolicyWaiversApplicableToViolationDTO`
        """
        model = ApiPolicyWaiversApplicableToViolationDTO()
        if include_optional:
            return ApiPolicyWaiversApplicableToViolationDTO(
                active_waivers = [
                    sonatype_iq_api_client.models.api_policy_waiver_dto.ApiPolicyWaiverDTO(
