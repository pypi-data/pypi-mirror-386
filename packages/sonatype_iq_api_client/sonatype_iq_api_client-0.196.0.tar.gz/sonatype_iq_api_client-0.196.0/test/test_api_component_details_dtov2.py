...
class TestApiComponentDetailsDTOV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiComponentDetailsDTOV2:
        """Test ApiComponentDetailsDTOV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiComponentDetailsDTOV2`
        """
        model = ApiComponentDetailsDTOV2()
        if include_optional:
            return ApiComponentDetailsDTOV2(
