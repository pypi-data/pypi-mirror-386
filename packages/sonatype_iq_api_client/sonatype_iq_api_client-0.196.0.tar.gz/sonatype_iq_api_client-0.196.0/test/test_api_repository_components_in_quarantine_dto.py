...
class TestApiRepositoryComponentsInQuarantineDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiRepositoryComponentsInQuarantineDTO:
        """Test ApiRepositoryComponentsInQuarantineDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiRepositoryComponentsInQuarantineDTO`
        """
        model = ApiRepositoryComponentsInQuarantineDTO()
        if include_optional:
            return ApiRepositoryComponentsInQuarantineDTO(
                components = [
