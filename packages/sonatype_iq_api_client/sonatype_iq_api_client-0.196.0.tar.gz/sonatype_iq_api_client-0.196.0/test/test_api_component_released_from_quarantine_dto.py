...
class TestApiComponentReleasedFromQuarantineDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiComponentReleasedFromQuarantineDTO:
        """Test ApiComponentReleasedFromQuarantineDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiComponentReleasedFromQuarantineDTO`
        """
        model = ApiComponentReleasedFromQuarantineDTO()
        if include_optional:
            return ApiComponentReleasedFromQuarantineDTO(
                component_released_from_quarantine = sonatype_iq_api_client.models.api_repository_component_policy_violation_dto.ApiRepositoryComponentPolicyViolationDTO(
