...
class TestApiPolicyViolationStageDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiPolicyViolationStageDTO:
        """Test ApiPolicyViolationStageDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiPolicyViolationStageDTO`
        """
        model = ApiPolicyViolationStageDTO()
        if include_optional:
            return ApiPolicyViolationStageDTO(
