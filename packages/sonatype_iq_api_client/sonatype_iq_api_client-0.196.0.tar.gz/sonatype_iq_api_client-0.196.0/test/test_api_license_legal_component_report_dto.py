...
class TestApiLicenseLegalComponentReportDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiLicenseLegalComponentReportDTO:
        """Test ApiLicenseLegalComponentReportDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiLicenseLegalComponentReportDTO`
        """
        model = ApiLicenseLegalComponentReportDTO()
        if include_optional:
            return ApiLicenseLegalComponentReportDTO(
                component = sonatype_iq_api_client.models.api_license_legal_component_dto.ApiLicenseLegalComponentDTO(
