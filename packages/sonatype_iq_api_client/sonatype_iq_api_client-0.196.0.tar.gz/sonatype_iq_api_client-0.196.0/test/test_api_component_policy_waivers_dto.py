...
class TestApiComponentPolicyWaiversDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiComponentPolicyWaiversDTO:
        """Test ApiComponentPolicyWaiversDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiComponentPolicyWaiversDTO`
        """
        model = ApiComponentPolicyWaiversDTO()
        if include_optional:
            return ApiComponentPolicyWaiversDTO(
                component_policy_waivers = [
