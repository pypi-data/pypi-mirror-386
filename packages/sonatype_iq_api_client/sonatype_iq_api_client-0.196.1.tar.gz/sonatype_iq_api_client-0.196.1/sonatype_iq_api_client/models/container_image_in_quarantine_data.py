...
class ContainerImageInQuarantineData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["applicationId", "applicationName", "applicationPublicId", "openTime", "policyViolationCount", "repositoryId", "repositoryPublicId", "scanId", "threatLevel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContainerImageInQuarantineData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContainerImageInQuarantineData from a dict"""
        if obj is None:
            return None
