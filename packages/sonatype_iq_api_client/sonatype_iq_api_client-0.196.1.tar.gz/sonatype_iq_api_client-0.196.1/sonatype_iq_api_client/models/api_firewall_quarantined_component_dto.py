...
class ApiFirewallQuarantinedComponentDto(BaseModel):
    """
    ...
    quarantine_date: Optional[StrictStr] = Field(default=None, alias="quarantineDate")
    ...
    __properties: ClassVar[List[str]] = ["componentIdentifier", "displayName", "hash", "matchState", "pathname", "policyName", "quarantineDate", "quarantined", "repositoryId", "repositoryName", "threatLevel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiFirewallQuarantinedComponentDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiFirewallQuarantinedComponentDto from a dict"""
        if obj is None:
            return None
