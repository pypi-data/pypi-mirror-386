...
class TestApiApplicationViolationDTOV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiApplicationViolationDTOV2:
        """Test ApiApplicationViolationDTOV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiApplicationViolationDTOV2`
        """
        model = ApiApplicationViolationDTOV2()
        if include_optional:
            return ApiApplicationViolationDTOV2(
