...
class TestApiApplicationWaiverDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiApplicationWaiverDTO:
        """Test ApiApplicationWaiverDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiApplicationWaiverDTO`
        """
        model = ApiApplicationWaiverDTO()
        if include_optional:
            return ApiApplicationWaiverDTO(
