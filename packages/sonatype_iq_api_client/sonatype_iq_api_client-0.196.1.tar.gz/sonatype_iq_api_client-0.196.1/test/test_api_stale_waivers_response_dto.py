...
class TestApiStaleWaiversResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiStaleWaiversResponseDTO:
        """Test ApiStaleWaiversResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiStaleWaiversResponseDTO`
        """
        model = ApiStaleWaiversResponseDTO()
        if include_optional:
            return ApiStaleWaiversResponseDTO(
                stale_waivers = [
                    sonatype_iq_api_client.models.api_stale_waiver_dto.ApiStaleWaiverDTO(
                        comment = '', 
                        constraint_facts = [
