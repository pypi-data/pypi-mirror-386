...
class TestApiEnhancedPolicyViolationDTOV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiEnhancedPolicyViolationDTOV2:
        """Test ApiEnhancedPolicyViolationDTOV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiEnhancedPolicyViolationDTOV2`
        """
        model = ApiEnhancedPolicyViolationDTOV2()
        if include_optional:
            return ApiEnhancedPolicyViolationDTOV2(
