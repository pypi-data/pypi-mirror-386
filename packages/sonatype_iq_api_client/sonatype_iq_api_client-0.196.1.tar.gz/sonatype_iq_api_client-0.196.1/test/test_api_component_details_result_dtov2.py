...
class TestApiComponentDetailsResultDTOV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiComponentDetailsResultDTOV2:
        """Test ApiComponentDetailsResultDTOV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiComponentDetailsResultDTOV2`
        """
        model = ApiComponentDetailsResultDTOV2()
        if include_optional:
