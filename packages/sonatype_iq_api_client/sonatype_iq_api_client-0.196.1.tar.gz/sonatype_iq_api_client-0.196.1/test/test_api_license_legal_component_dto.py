...
class TestApiLicenseLegalComponentDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiLicenseLegalComponentDTO:
        """Test ApiLicenseLegalComponentDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiLicenseLegalComponentDTO`
        """
        model = ApiLicenseLegalComponentDTO()
        if include_optional:
            return ApiLicenseLegalComponentDTO(
