...
class TestApiRepositoryComponentPolicyViolationDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiRepositoryComponentPolicyViolationDTO:
        """Test ApiRepositoryComponentPolicyViolationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiRepositoryComponentPolicyViolationDTO`
        """
        model = ApiRepositoryComponentPolicyViolationDTO()
        if include_optional:
            return ApiRepositoryComponentPolicyViolationDTO(
