...
def _log_header(package_name: str, logfile_file: str | Path) -> str:
...
def set_up_logging(
    ...
    logfile_file: Path = Path("spark3d_batch.log"),
    ...
    logger.info(_log_header(package_name, logfile_file))
...
def main():
    ...
    if not set_up_logging(
        ...
        logfile_file=Path("spark3d_batch.log"),
