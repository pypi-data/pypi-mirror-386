...
>🧩 **Magic Chef** is a lightweight Python library that **automatically** detects and decodes encrypted or encoded text . It identifies the encryption type and returns a **clean JSON response** containing the decoding type and the final text.
...
> ⚠️ *Note:* This is an early version of the library.
