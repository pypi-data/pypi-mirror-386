...
Welcome to `lumeo` contributor's guide.
...
If you experience bugs or general issues with `lumeo`, please have a look
...
You can help improve `lumeo` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`lumeo` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `lumeo`'s files. While this mechanism can
...
```
conda create -n lumeo python=3 six virtualenv pytest pytest-cov
conda activate lumeo
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/lumeo.git
   cd lumeo
   ```
...
5. Install [pre-commit]:
   ...
   `lumeo` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/lumeo
[issue tracker]: https://github.com/<USERNAME>/lumeo/issues
