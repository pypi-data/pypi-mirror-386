...
"""Application.infrastructure_services.infrastructure_configuration
Where: Application layer value objects for infrastructure coordination.
What: Defines immutable configuration records for services, performance, cache, and security.
Why: Centralises infrastructure defaults so application orchestration stays declarative and testable.
"""
