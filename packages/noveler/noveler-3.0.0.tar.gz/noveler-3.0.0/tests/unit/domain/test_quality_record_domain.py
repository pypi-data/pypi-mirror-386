...
class TestQualityScore:
    ...
    def test_quality_score_is_passing(self) -> None:
        ...
        assert passing_score.is_passing(80)
        assert not failing_score.is_passing(80)
        assert not failing_score.is_passing(80)
...
class TestQualityCheckResult:
    ...
    def test_is_high_quality(self) -> None:
        ...
        from decimal import Decimal
        assert high_quality_result.is_high_quality(Decimal("85"))
        assert not low_quality_result.is_high_quality(Decimal("85"))
