#!/usr/bin/env python3
# File: src/noveler/presentation/mcp/plugins/check_style_plugin.py
# Purpose: Plugin wrapper for check_style tool
# Context: Phase 2 plugin migration - Readability/Grammar tools group
"""Check style plugin for MCP."""
...
class CheckStylePlugin(MCPToolPlugin):
    """Plugin wrapper for check_style tool."""
    ...
    def get_handler(self) -> Callable[[dict[str, Any]], Any]:
        """Return the check_style handler function."""
        from noveler.presentation.mcp.adapters import handlers

        return handlers.check_style
