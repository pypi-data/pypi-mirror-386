...
class HTTPValidationErrorJudgmentType(BaseModel):
    detail: Annotated[
        list[ValidationErrorJudgmentType] | None, Field(title="Detail")
    ] = None
...
class TraceSpanJudgmentType(BaseModel):
    ...
    usage: TraceUsageJudgmentType | None = None
    duration: Annotated[float | None, Field(title="Duration")] = None
    expected_tools: Annotated[
        list[ToolJudgmentType] | None, Field(title="Expected Tools")
    ] = None
    additional_metadata: Annotated[
        dict[str, Any] | None, Field(title="Additional Metadata")
    ] = None
...
class ScoringResultJudgmentType(BaseModel):
    ...
    scorers_data: Annotated[
        list[ScorerDataJudgmentType] | None, Field(title="Scorers Data")
    ]
    name: Annotated[str | None, Field(title="Name")] = None
    data_object: Annotated[
        Union[TraceSpanJudgmentType, ExampleJudgmentType] | None,
