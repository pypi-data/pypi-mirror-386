...
class JudgmentApiClient:
    ...
    def add_to_evaluation_queue(self, payload: Dict[str, Any]):
        return self._do_request("POST", TRAJECTORY_ADD_TO_RUN_EVAL_QUEUE_API_URL, payload)
    ...
    def check_experiment_type(self, eval_name: str, project_name: str, is_trace: bool):
        ...
        return self._do_request("POST", TRAJECTORY_CHECK_EXPERIMENT_TYPE_API_URL, payload)
    ...
    def check_eval_run_name_exists(self, eval_name: str, project_name: str):
        ...
        return self._do_request("POST", TRAJECTORY_EVAL_RUN_NAME_EXISTS_API_URL, payload)
