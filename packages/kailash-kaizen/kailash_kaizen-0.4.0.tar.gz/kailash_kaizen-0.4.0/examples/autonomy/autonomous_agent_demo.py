...
Requirements:
- OPENAI_API_KEY in /Users/esperie/repos/dev/kailash_python_sdk/.env
...
def main():
    ...
    print(f"   - Max Cycles: 10")
    print(f"   - Tool Registry: {tool_count} tools")
    print(f"   - Convergence: Objective (while(tool_calls_exist))")
    print()
    ...
    print(f"   - Test 1 (Simple Question): PASS")
    print()
    print("=" * 80)
