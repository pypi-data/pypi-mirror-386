    ...
    def process_sequential(self, file_paths: List[str]) -> BatchResult:
        ...
        for i, file_path in enumerate(file_paths, 1):
            ...
            try:
                ...
                print(f"   ✅ Success: {len(result['text'])} chars, ${result['cost']:.3f}")
        ...
        async def process_one(file_path: str, index: int) -> Dict[str, Any]:
            ...
            async with semaphore:
                ...
                try:
                    ...
                    print(f"   ✅ Completed {index}: {len(result['text'])} chars, ${result['cost']:.3f}")
...
def compare_batch_strategies():
    ...
    if speedup > 1.5:
        ...
        print(f"   ⚠️  Sequential sufficient for small batches")
