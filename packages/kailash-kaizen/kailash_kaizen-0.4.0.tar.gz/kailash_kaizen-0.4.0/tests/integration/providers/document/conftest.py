...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "landing_ai: Tests requiring Landing AI API key"
    )
    config.addinivalue_line(
        "markers", "openai: Tests requiring OpenAI API key"
    )
    config.addinivalue_line(
        "markers", "ollama: Tests requiring Ollama running locally"
    )
    config.addinivalue_line(
        "markers", "slow: Tests that take longer to run"
    )
    config.addinivalue_line(
        "markers", "cost: Tests that incur API costs"
    )
