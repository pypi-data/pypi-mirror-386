...
class TestNLQueryToDataFlowExecution:
    ...
    def test_nl_query_to_dataflow_execution(
        ...
        result = agent.query("Show me all users in the Engineering department")
    ...
    def test_nl_query_with_age_filter(
        ...
        result = agent.query("Find users over 30 years old")
    ...
    def test_nl_query_aggregation(
        ...
        result = agent.query("Count how many users are in each department")
...
class TestEndToEndAIPipeline:
    ...
    def test_complete_ai_pipeline(
        ...
        query_result = nl_agent.query("Show me all users")
