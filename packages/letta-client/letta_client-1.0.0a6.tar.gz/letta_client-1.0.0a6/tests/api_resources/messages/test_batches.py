...
from letta_sdk.types.messages import (
    BatchJob,
    BatchListResponse,
...
class TestBatches:
    ...
    def test_method_list_messages(self, client: LettaSDK) -> None:
        batch = client.messages.batches.list_messages(
            batch_id="batch_id",
        )
        assert_matches_type(BatchListMessagesResponse, batch, path=["response"])
    ...
    def test_raw_response_list_messages(self, client: LettaSDK) -> None:
        response = client.messages.batches.with_raw_response.list_messages(
            batch_id="batch_id",
        )
    ...
    def test_streaming_response_list_messages(self, client: LettaSDK) -> None:
        with client.messages.batches.with_streaming_response.list_messages(
            batch_id="batch_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list_messages(self, client: LettaSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `batch_id` but received ''"):
            client.messages.batches.with_raw_response.list_messages(
                batch_id="",
            )
...
class TestAsyncBatches:
    ...
    async def test_method_list_messages(self, async_client: AsyncLettaSDK) -> None:
        batch = await async_client.messages.batches.list_messages(
            batch_id="batch_id",
        )
        assert_matches_type(BatchListMessagesResponse, batch, path=["response"])
    ...
    async def test_raw_response_list_messages(self, async_client: AsyncLettaSDK) -> None:
        response = await async_client.messages.batches.with_raw_response.list_messages(
            batch_id="batch_id",
        )
    ...
    async def test_streaming_response_list_messages(self, async_client: AsyncLettaSDK) -> None:
        async with async_client.messages.batches.with_streaming_response.list_messages(
            batch_id="batch_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list_messages(self, async_client: AsyncLettaSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `batch_id` but received ''"):
            await async_client.messages.batches.with_raw_response.list_messages(
                batch_id="",
            )
