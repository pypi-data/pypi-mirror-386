...
class TestBlocks:
    ...
    def test_method_list_agents(self, client: LettaSDK) -> None:
        block = client.blocks.list_agents(
            block_id="block_id",
        )
        assert_matches_type(BlockListAgentsResponse, block, path=["response"])
    ...
    def test_raw_response_list_agents(self, client: LettaSDK) -> None:
        response = client.blocks.with_raw_response.list_agents(
            block_id="block_id",
        )
    ...
    def test_streaming_response_list_agents(self, client: LettaSDK) -> None:
        with client.blocks.with_streaming_response.list_agents(
            block_id="block_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list_agents(self, client: LettaSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `block_id` but received ''"):
            client.blocks.with_raw_response.list_agents(
                block_id="",
            )
...
class TestAsyncBlocks:
    ...
    async def test_method_list_agents(self, async_client: AsyncLettaSDK) -> None:
        block = await async_client.blocks.list_agents(
            block_id="block_id",
        )
        assert_matches_type(BlockListAgentsResponse, block, path=["response"])
    ...
    async def test_raw_response_list_agents(self, async_client: AsyncLettaSDK) -> None:
        response = await async_client.blocks.with_raw_response.list_agents(
            block_id="block_id",
        )
    ...
    async def test_streaming_response_list_agents(self, async_client: AsyncLettaSDK) -> None:
        async with async_client.blocks.with_streaming_response.list_agents(
            block_id="block_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list_agents(self, async_client: AsyncLettaSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `block_id` but received ''"):
            await async_client.blocks.with_raw_response.list_agents(
                block_id="",
            )
