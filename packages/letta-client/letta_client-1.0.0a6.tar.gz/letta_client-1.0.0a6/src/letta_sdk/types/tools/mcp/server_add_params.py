...
__all__ = ["ServerAddParams", "StdioServerConfig", "SseServerConfig", "StreamableHTTPServerConfig"]
...
ServerAddParams: TypeAlias = Union[StdioServerConfig, SseServerConfig, StreamableHTTPServerConfig]
