...
class TestBlocks:
    ...
    def test_method_list(self, client: Letta) -> None:
        block = client.identities.blocks.list(
    ...
    def test_raw_response_list(self, client: Letta) -> None:
        response = client.identities.blocks.with_raw_response.list(
            identity_id="identity-123e4567-e89b-42d3-8456-426614174000",
        )
    ...
    def test_streaming_response_list(self, client: Letta) -> None:
        with client.identities.blocks.with_streaming_response.list(
            identity_id="identity-123e4567-e89b-42d3-8456-426614174000",
        ) as response:
    ...
    def test_path_params_list(self, client: Letta) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `identity_id` but received ''"):
            client.identities.blocks.with_raw_response.list(
                identity_id="",
            )
...
class TestAsyncBlocks:
    ...
    async def test_method_list(self, async_client: AsyncLetta) -> None:
        block = await async_client.identities.blocks.list(
            identity_id="identity-123e4567-e89b-42d3-8456-426614174000",
        )
        assert_matches_type(BlockListResponse, block, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncLetta) -> None:
        response = await async_client.identities.blocks.with_raw_response.list(
            identity_id="identity-123e4567-e89b-42d3-8456-426614174000",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncLetta) -> None:
        async with async_client.identities.blocks.with_streaming_response.list(
            identity_id="identity-123e4567-e89b-42d3-8456-426614174000",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncLetta) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `identity_id` but received ''"):
            await async_client.identities.blocks.with_raw_response.list(
                identity_id="",
            )
