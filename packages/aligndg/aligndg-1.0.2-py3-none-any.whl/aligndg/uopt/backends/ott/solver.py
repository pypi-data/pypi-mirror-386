...
from aligndg.uopt._types import ProblemKind_t, QuadInitializer_t, SinkhornInitializer_t
from aligndg.uopt.backends.ott._utils import (
    _instantiate_geodesic_cost,
    alpha_to_fused_penalty,
    check_shapes,
    ensure_2d,
)
from aligndg.uopt.backends.ott.output import GraphOTTOutput, OTTOutput
from aligndg.uopt.base.problems._utils import TimeScalesHeatKernel
from aligndg.uopt.base.solver import OTSolver
from aligndg.uopt.costs import get_cost
from aligndg.uopt.utils.tagged_array import TaggedArray
        ...
        **kwargs: Any,
        ...
        if rank > -1:
            ...
            if eps is not None and eps > 0.0:
                print("We recommend setting `epsilon`=0 for the low-rank solver.")
            initializer = "rank2" if initializer is None else initializer
