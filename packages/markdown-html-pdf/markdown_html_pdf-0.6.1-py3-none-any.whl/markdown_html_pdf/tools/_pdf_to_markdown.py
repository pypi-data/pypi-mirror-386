...
def pdf_to_markdown(input_pdf_path: str | pathlib.Path, output_md_path: str | pathlib.Path | None = None) -> str | None:
    """
    Convert PDF to Markdown using comprehensive extraction with LLM vision analysis.

    Args:
        input_pdf_path: Path to input PDF file
        output_md_path: Path to output Markdown file, or None to return content

    Returns:
        Markdown content as string if output_md_path is None, otherwise None
    """
    ...
    # Create output directory if it doesn't exist (only if saving to file)
    ...
    if output_md_path is not None:
        ...
        print("📝 Output will be returned as string")
    ...
    # Write final markdown file or return content
    ...
    if output_md_path is not None:
        ...
        print("💾 Output returned as string")
