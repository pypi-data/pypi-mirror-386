...
from yta_editor_utils.selection_mask import SelectionMaskGenerator
...
class SelectionMaskProcessorCPU(_NodeProcessorCPU):
    ...
    def process(
        ...
        original_input = SelectionMaskGenerator.utils.numpy_to_float32(original_input)
        processed_input = SelectionMaskGenerator.utils.numpy_to_float32(processed_input)
        selection_mask_input = SelectionMaskGenerator.utils.numpy_to_float32(selection_mask_input)
        ...
        return SelectionMaskGenerator.utils.numpy_to_uint8(final)