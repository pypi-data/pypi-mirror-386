...
def place_order(
    ...
    isLeverage: Union[str, None] = None,
    ...
    tpOrderType: Union[str, None] = None,
    slOrderType: Union[str, None] = None,
) -> PlaceOrderResponse:
    """Place a new order and validate response. Matches MCP Tool schema."""
