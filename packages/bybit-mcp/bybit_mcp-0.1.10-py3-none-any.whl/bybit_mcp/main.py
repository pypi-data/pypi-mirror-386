        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "limit": {
                        "type": "integer",
                        "description": "Maximum number of candlesticks to return (OPTIONAL). Range: 1-1000. If not specified, API will use a reasonable default based on the interval. Does not accept an end parameter when limit is also provided",
                        "minimum": 1,
                        "maximum": 1000,
                    }, },
                "required": ["symbol"],
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "limit": {
                        "type": "integer",
                        "description": "Maximum number of candlesticks to return (OPTIONAL). Range: 1-1000. Does not accept an end parameter when limit is also provided",
                        "minimum": 1,
                        "maximum": 1000,
                    }, },
                "required": ["symbol"],
