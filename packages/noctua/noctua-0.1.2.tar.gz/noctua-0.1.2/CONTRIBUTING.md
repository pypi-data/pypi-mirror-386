# Contributing to noctua-py

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
noctua-py. These guidelines are not strict rules.
...
The noctua-py team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the noctua-py technical leads
...
[issues]: https://github.com/geneontology/noctua-py/issues/
[pulls]: https://github.com/geneontology/noctua-py/pulls/
