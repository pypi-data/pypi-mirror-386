...
from hestia_earth.utils.tools import non_empty_list, safe_parse_float, flatten, to_precision
...
def validate_water_salinity(site: dict, list_key: str):
    site_type_valid = site.get('siteType') in WATER_SITE_TYPES
    nodes = site.get(list_key, [])
    waterSalinity = get_node_value(find_term_match(nodes, 'waterSalinity', {}), default=None)
