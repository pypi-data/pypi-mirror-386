...
class AttrData:
    ...
    def __init__(self, name, class_name, attr_info=None):
        ...
        self.alarm_event_detect = False
        self.archive_event_implemented = False
        self.archive_event_detect = False
        self.change_event_implemented = False
        self.change_event_detect = False
    ...
    def build_from_dict(self, attr_dict):
        ...
        self.alarm_event_detect = attr_dict.pop("alarm_event_detect", False)
        self.archive_event_implemented = attr_dict.pop(
            "archive_event_implemented", False
        )
        self.archive_event_detect = attr_dict.pop("archive_event_detect", False)
        self.change_event_implemented = attr_dict.pop("change_event_implemented", False)
        self.change_event_detect = attr_dict.pop("change_event_detect", False)
    ...
    def from_attr_info(self, attr_info):
        ...
        self.alarm_event_detect = extra_info.get("alarm_event_detect", False)
        self.archive_event_implemented = extra_info.get(
            "archive_event_implemented", False
        )
        self.archive_event_detect = extra_info.get("archive_event_detect", False)
        self.change_event_implemented = extra_info.get(
            "change_event_implemented", False
        )
        self.change_event_detect = extra_info.get("change_event_detect", False)
