# Healthybowl Sdk-python

A Python SDK healthybowl for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from healthybowl_sdk import BoilerSDK, BoilerSDKConfig
from healthybowl_sdk.types.common import UserRegisterInput
...
```python
from healthybowl_sdk import BoilerSDKConfig
...
pytest --cov=healthybowl_sdk --cov-report=html
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/healthybowl-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/healthybowl-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../healthybowl-frontend) - Frontend healthybowl
- [Boiler Backend](../healthybowl-python-be-graphql) - Python GraphQL backend healthybowl
- testing 