"""
Delete Bridge implementation for Recorder operations.

This module provides the bridge layer for deleting recordings,
...
class DeleteBridge(BaseBridge):
    """Bridge for deleting recordings using CFFI."""
    
    def __init__(self, bridge_lib_path: str):
        """
        Initialize the Delete Bridge.
    ...
    def _define_functions(self) -> None:
        """Define the CFFI interface for delete operations."""
        self._ffi.cdef("""
