"""
Stop Bridge implementation for Recorder operations.

This module provides the bridge layer for stopping recordings,
...
class StopBridge(BaseBridge):
    """Bridge for stopping recordings using CFFI."""
