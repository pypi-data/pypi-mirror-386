"""
Create Bridge implementation for Recorder operations.

This module provides the bridge layer for creating recordings,
...
class CreateBridge(BaseBridge):
    """Bridge for creating recordings using CFFI."""
    ...
    def _define_functions(self) -> None:
        """Define the CFFI interface for create operations."""
        self._ffi.cdef("""
