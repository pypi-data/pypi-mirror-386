...
# Default binds to 0.0.0.0 (all interfaces) for remote access
insyt-audit-web --daemon

# Optional: Specify custom host/port
insyt-audit-web --daemon --port 8080
...
# Option B: Foreground mode (for local development or monitoring)
insyt-audit-web

# Option C: Localhost-only access (more secure if not accessing remotely)
insyt-audit-web --host 127.0.0.1

# Option D: Old method (less reliable, deprecated)
