# Contributing to noctua-mcp

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
noctua-mcp. These guidelines are not strict rules.
...
The noctua-mcp team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the noctua-mcp technical leads
...
[issues]: https://github.com/geneontology/noctua-mcp/issues/
[pulls]: https://github.com/geneontology/noctua-mcp/pulls/
