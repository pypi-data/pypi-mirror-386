...
# Length is measured in nm and time in seconds.
...
class Container:
    ...
    class TriMesh:
        ...
        def total_volume(self):
            ...
            return np.sum(tri_volumes)
        
        @property
        def total_area(self):
            """
            Compute the total surface area of the container by summing triangle areas.
            Returns:
                float: Total surface area.
            """
            tri_areas = self.calculate_tri_areas()
