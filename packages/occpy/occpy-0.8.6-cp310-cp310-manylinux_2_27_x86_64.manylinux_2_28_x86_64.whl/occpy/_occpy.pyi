...
class ElasticTensor:
    ...
    def compute_directional_properties(self, n_theta: int = 50, n_phi: int = 50) -> "std::tuple<std::vector<double, std::allocator<double> >, std::vector<double, std::allocator<double> >, std::vector<std::vector<double, std::allocator<double> >, std::allocator<std::vector<double, std::allocator<double> > > >, std::vector<std::vector<double, std::allocator<double> >, std::allocator<std::vector<double, std::allocator<double> > > > >": ...
...
class Mult:
    ...
    @staticmethod
    def component_name_to_lm(name: str) -> "std::pair<int, int>":
...
class DMAConfig:
    ...
    @property
    def atom_radii(self) -> "ankerl::unordered_dense::v4_5_0::detail::table<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, double, ankerl::unordered_dense::v4_5_0::hash<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, void>, std::equal_to<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > >, std::allocator<std::pair<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, double> >, ankerl::unordered_dense::v4_5_0::bucket_type::standard, ankerl::unordered_dense::v4_5_0::detail::default_container_t, false>":
