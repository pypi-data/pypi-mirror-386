...
class PrescriptionData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["source", "external_rx_number", "external_system_slug", "patient_ref", "prescriber_ref", "medication_ref", "number_of_refills", "quantity_value", "quantity_uom_code", "days_supply", "written_date", "substitutions_code", "sig_text"]
