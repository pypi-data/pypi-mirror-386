...
class PrescriptionChangeRequest(BaseModel):
    ...
    change_request_code: Optional[StrictStr] = Field(default=None, description="The NCPDP SCRIPT change request code")
    change_request_sub_code: Optional[StrictStr] = Field(default=None, description="The NCPDP SCRIPT change request sub code")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "change_request_code": obj.get("change_request_code"),
            "change_request_sub_code": obj.get("change_request_sub_code"),
