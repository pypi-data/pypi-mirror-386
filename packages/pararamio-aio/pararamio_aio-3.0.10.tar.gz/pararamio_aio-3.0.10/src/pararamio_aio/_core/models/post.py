...
from pararamio_aio._core.api_schemas.responses import FileUploadFields, PostResponseItem
...
if TYPE_CHECKING:
    ...
    from pararamio_aio._core.api_schemas.responses import Mention, UserLink
