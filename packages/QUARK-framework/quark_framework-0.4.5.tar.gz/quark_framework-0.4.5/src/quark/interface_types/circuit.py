...
class Circuit:
    ...
    def qasm_version(self) -> str:
        ...
        # self._qasm_version == None is used to indicate that the version has not been
        # read yet. If no version is specified in the qasm string self._qasm_version will be
        # set to the empty string. The public property qasm_version however will be None in
        # this case.
        return None if not self._qasm_version else self._qasm_version

    def _read_qasm_version(self) -> str:
