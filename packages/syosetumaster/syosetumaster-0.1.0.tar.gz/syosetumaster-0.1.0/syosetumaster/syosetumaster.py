...
from translate_gpt_IO import Translate_GPT_IO as Client, _set_api_key
from translate_gpt_IO.gpt_IO import _set_batch_dir
...
class SyosetuMaster():
    ...
    def select_syosetu(self, syosetu: Syosetu) -> None:
        """ append syosetu in selected_syosetu_list
        """
        
        self.selected_syosetu_list.append(syosetu)
        return None
    

    def print_selected_syosetu_list(self) -> None:
        """ print selected_syosetu_list.
        """
        
        for syosetu in self.selected_syosetu_list:
            print("title : " + syosetu.get_syosetu_title())
            print("syosetu_id : " + syosetu.get_syosetu_id())
            print("-------------------------")
        return None
    ...
    def crawl_syosetsu(self, mode: str = "all") -> None:
        ...
        if mode == "all":
            ...
            syosetu_list = self.selected_syosetu_list
        else:
            return None
