...
class AssumeRoleCredentialProvider(betterproto2.Message):
    ...
    role_arn: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    The ARN of the role to assume.
    """

    role_session_name: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    ...
    external_id: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
...
class IamRolesAnywhereCredentialProvider(betterproto2.Message):
    ...
    trust_anchor_arn: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
    ...
    profile_arn: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
    The IAM Roles Anywhere profile ARN configured in your AWS account.
    """

    role_session_name: "str" = betterproto2.field(7, betterproto2.TYPE_STRING)
    """
