...
class ReverseTunnel(betterproto2.Message):
    ...
    * When set to ``false``, connections remain open for potential reuse.
    ...
    request_path: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
...
class Validation(betterproto2.Message):
    ...
    node_id_format: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    ...
    * Plain strings: Use a static expected value.
    ...
    cluster_id_format: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    ...
    * ``validation_result``: Either ``allowed`` or ``denied``.
    ...
    dynamic_metadata_namespace: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
