# awslaus quantum ledger datauase mcp server
...
```bash
pip install awslabs-quantum-ledger-database-mcp-server
```

Or use with uvx:

```bash
uvx awslabs-quantum-ledger-database-mcp-server
```

## Usage

```bash
awslabs-quantum-ledger-database-mcp-server
```
