...
def create_aiexec_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Aiexec initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Aiexec", "Setting up basic configuration"),
        ...
        ("Launching Aiexec", "Starting server and final setup"),
    ]
...
def create_aiexec_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Aiexec shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
