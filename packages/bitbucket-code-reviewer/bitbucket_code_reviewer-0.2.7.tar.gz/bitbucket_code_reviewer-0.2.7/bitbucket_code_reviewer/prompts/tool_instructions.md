...
```json
{
  "summary": "Reviewed 5 files refactoring user authentication. Validated error handling and type safety. All changes follow established patterns.",
  "severity_counts": {
    "critical": 0,
    "major": 0,
    "minor": 0,
...
- summary: Brief 2-4 sentence review summary (REQUIRED, string)
  - Sentence 1: What was reviewed (file count, change type)
  - Sentence 2: What was validated
  - Sentence 3: Outcome/reasoning
  - Do NOT mention issue count (will be added automatically)
...
**SUMMARY is ALWAYS REQUIRED**: Even if you find no issues, you must provide a summary explaining what was reviewed and why no issues were found.
