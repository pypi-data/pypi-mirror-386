# coding:utf-8
from ..site_packages.qtcompat.QtCore import QCoreApplication, QEvent, Qt, QSize, QRect
from ..site_packages.qtcompat.QtWidgets import QWidget, QMainWindow, QDialog
