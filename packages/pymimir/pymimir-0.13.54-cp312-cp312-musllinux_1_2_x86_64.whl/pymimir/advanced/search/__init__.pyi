...
class KPKCLiftedApplicableActionGenerator(IApplicableActionGenerator):
    @staticmethod
    def create(problem: pymimir.advanced.formalism.Problem, event_handler: IKPKCLiftedApplicableActionGeneratorEventHandler | None = None, binding_event_handler: ISatisficingBindingGeneratorEventHandler | None = None) -> KPKCLiftedApplicableActionGenerator: ...
