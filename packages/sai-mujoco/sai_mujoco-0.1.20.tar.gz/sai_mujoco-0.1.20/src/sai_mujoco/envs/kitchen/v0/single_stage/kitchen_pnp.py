...
class PnP_v0(KitchenEnv_v0):
    ...
    def __init__(
        self, obj_groups="container_set2", exclude_obj_groups=None, *args, **kwargs
    ):
...
class PnPCounterToCab_v0(PnP_v0):
    """
    ...
    def _reset_internal(self):
        ...
        self.cab.set_door_state(min=0.90, max=1.0, env=self, rng=self.np_random)
    ...
    def _get_task_desc(self):
        return f"Pick the {self.get_obj_lang()} from the counter and place it in the cabinet"


class PnPCabToCounter_v0(PnP_v0):
    """
    ...
    def _get_task_desc(self):
        return f"Pick the {self.get_obj_lang()} from the cabinet and place it on the counter"

class PnPCounterToSink_v0(PnP_v0):
    """
    ...
    def __init__(self, obj_groups="container_set2", *args, **kwargs):
        super().__init__(obj_groups=obj_groups, *args, **kwargs)
    ...
    def _get_task_desc(self):
        return (
            f"Pick the {self.get_obj_lang()} from the sink and place it on the counter"
        )


class PnPSinkToCounter_v0(PnP_v0):
    """
    ...
    def _check_success(self):
        ...
        recep_on_counter = self.check_contact(
            self.objects["container"].contact_geoms, self.counter.contact_geoms
        )
        gripper_obj_far = OU.gripper_obj_far(self)
    ...
    def _get_task_desc(self):
        ...
        return f"Pick the {obj_lang} from the sink and place it on the {container_lang} located on the counter"


class PnPCounterToMicrowave_v0(PnP_v0):
    """
    ...
    def __init__(self, obj_groups="food_set2", *args, **kwargs):
        super().__init__(obj_groups=obj_groups, *args, **kwargs)
    ...
    def _reset_internal(self):
        ...
        """
        super()._reset_internal()
        self.microwave.set_door_state(min=0.90, max=1.0, env=self, rng=self.np_random)
    ...
    def _check_success(self):
        ...
        obj_container_contact = self.check_contact(
            obj.contact_geoms, container.contact_geoms
        )
        container_micro_contact = self.check_contact(
            container.contact_geoms, self.microwave.contact_geoms
        )
        gripper_obj_far = OU.gripper_obj_far(self)
        return obj_container_contact and container_micro_contact and gripper_obj_far

    def _get_task_desc(self):
        return f"Pick the {self.get_obj_lang()} from the microwave and place it in the microwave"

class PnPMicrowaveToCounter_v0(PnP_v0):
    """
    ...
    def _get_task_desc(self):
        obj_lang = self.get_obj_lang()
        container_lang = self.get_obj_lang(obj_name="container")
        return f"Pick the {obj_lang} from the microwave and place it on the {container_lang} located on the counter"


class PnPCounterToStove_v0(PnP_v0):
    """
    ...
    def _get_task_desc(self):
        ...
        container_lang = self.get_obj_lang(obj_name="container")
        return (
            f"Pick the {obj_lang} from the plate and place it in the {container_lang}"
        )


class PnPStoveToCounter_v0(PnP_v0):
    """
    ...
    def _get_task_desc(self):
        ...
        return f"pick the {obj_lang} from the {obj_cont_lang} and place it {preposition} the {cont_lang}"
