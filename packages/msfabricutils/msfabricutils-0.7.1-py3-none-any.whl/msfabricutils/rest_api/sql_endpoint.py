...
def sql_endpoint_list(
    workspace_id: str,
    continuation_token: str = None,
    preview: bool = True,
) -> requests.Response:
    """
    List SQL endpoints for a workspace.

    Args:
        workspace_id (str): The id of the workspace to list SQL endpoints for.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/sqlEndpoints"  # noqa
    url = f"{url}?"
