...
def ml_model_create(
    ...
    Args:
        workspace_id (str): The id of the workspace to create the ml model in.
        display_name (str): The display name of the ml model.
        description (str | None): The description of the ml model.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/mlModels"  # noqa
    url = f"{url}?"
    url = url.rstrip("&?")
...
def ml_model_get(
    ...
    Args:
        workspace_id (str): The id of the workspace to get the ml model from.
        ml_model_id (str): The id of the ml model to get.
        preview (bool): Whether to preview the request. You will be asked to confirm the request before it is executed. Defaults to True.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/mlModels/{ml_model_id}"  # noqa
    url = f"{url}?"
    url = url.rstrip("&?")
...
def ml_model_update(
    ...
    Args:
        workspace_id (str): The id of the workspace to update the ml model in.
        display_name (str | None): The display name of the ml model.
        description (str | None): The description of the ml model.
        preview (bool): Whether to preview the request. You will be asked to confirm the request before it is executed. Defaults to True.
...
def ml_model_delete(
    ...
    Args:
        workspace_id (str): The id of the workspace to delete the ml model from.
        ml_model_id (str): The id of the ml model to delete.
        preview (bool): Whether to preview the request. You will be asked to confirm the request before it is executed. Defaults to True.
