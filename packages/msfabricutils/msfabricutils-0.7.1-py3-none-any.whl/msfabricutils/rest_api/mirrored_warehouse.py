...
def mirrored_warehouse_list(
    ...
    Args:
        workspace_id (str): The id of the workspace to list mirrored warehouses for.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/mirroredWarehouses"  # noqa
    url = f"{url}?"
