...
from msfabricutils.rest_api import dashboard_list
...
@app.command(help="List dashboards for a workspace.", rich_help_panel="Dashboard")
def list(
    workspace_id: Annotated[
        ...
        typer.Option(
            ...
            show_default=False,
            help="The id of the workspace to list dashboards for.",
        ),
    ],
