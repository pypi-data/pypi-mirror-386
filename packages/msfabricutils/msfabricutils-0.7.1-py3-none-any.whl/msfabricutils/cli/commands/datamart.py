...
from msfabricutils.rest_api import datamart_list
...
@app.command(help="List datamarts for a workspace.", rich_help_panel="Datamart")
def list(
    workspace_id: Annotated[
        ...
        typer.Option(
            ...
            show_default=False,
            help="The id of the workspace to list datamarts for.",
        ),
    ],
