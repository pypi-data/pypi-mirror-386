...
from msfabricutils.rest_api import sql_endpoint_list
...
@app.command(help="List SQL endpoints for a workspace.", rich_help_panel="SQL Endpoint")
def list(
    workspace_id: Annotated[
        ...
        typer.Option(
            ...
            show_default=False,
            help="The id of the workspace to list SQL endpoints for.",
        ),
    ],
