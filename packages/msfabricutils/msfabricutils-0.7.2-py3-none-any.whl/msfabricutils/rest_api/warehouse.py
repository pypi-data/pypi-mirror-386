...
def warehouse_create(
    ...
    Args:
        workspace_id (str): The id of the workspace to create the warehouse in.
        display_name (str): The display name of the warehouse.
        description (str | None): The description of the warehouse.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/warehouses"  # noqa
    url = f"{url}?"
    url = url.rstrip("&?")
...
def warehouse_get(
    ...
    Args:
        workspace_id (str): The id of the workspace to get the warehouse from.
        warehouse_id (str): The id of the warehouse to get.
        preview (bool): Whether to preview the request. You will be asked to confirm the request before it is executed. Defaults to True.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/warehouses/{warehouse_id}"  # noqa
    url = f"{url}?"
    url = url.rstrip("&?")
...
def warehouse_list(
    ...
    Args:
        workspace_id (str): The id of the workspace to list warehouses for.
...
def warehouse_update(
    ...
    Args:
        workspace_id (str): The id of the workspace to update the warehouse in.
        display_name (str | None): The display name of the warehouse.
        description (str | None): The description of the warehouse.
        preview (bool): Whether to preview the request. You will be asked to confirm the request before it is executed. Defaults to True.
...
def warehouse_delete(
    ...
    Args:
        workspace_id (str): The id of the workspace to delete the warehouse from.
