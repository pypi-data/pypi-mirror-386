...
def datamart_list(
    ...
    """
    List datamarts for a workspace.

    Args:
        workspace_id (str): The id of the workspace to list datamarts for.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/datamarts"  # noqa
    url = f"{url}?"
