...
class cloud_object_storage(BaseStage):
    ...
    collecting: CLOUD_OBJECT_STORAGE.Collecting | None = Field(
        CLOUD_OBJECT_STORAGE.Collecting.auto, alias="coll_type"
    )
    ...
    write_mode: CLOUD_OBJECT_STORAGE.WriteMode | None = Field(
        CLOUD_OBJECT_STORAGE.WriteMode.write, alias="write_mode"
    )
    ...
    def validate_target(self) -> tuple[set, set]:
        ...
        (
            ...
            if (self.append_unique_identifier)
