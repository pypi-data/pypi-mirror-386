...
class column_export(BaseStage):
    ...
    check_intact: COLUMN_EXPORT.CheckIntact | None = Field(
        COLUMN_EXPORT.CheckIntact.check_intact, alias="check_intact"
    )
    ...
    combinability: COLUMN_EXPORT.Combinability | None = Field(
        COLUMN_EXPORT.Combinability.auto, alias="combinability"
    )
    ...
    key_col_select: COLUMN_EXPORT.KeyColSelect | None = Field(
        COLUMN_EXPORT.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    null_field_sep: COLUMN_EXPORT.NullFieldSep | None = Field(
        COLUMN_EXPORT.NullFieldSep.comma, alias="null_field_sep"
    )
