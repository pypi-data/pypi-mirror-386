...
class mysql_amazon(BaseStage):
    ...
    buf_mode_ronly: MYSQL_AMAZON.BufModeRonly | None = Field(
        MYSQL_AMAZON.BufModeRonly.default, alias="buf_mode_ronly"
    )
    ...
    execution_mode: MYSQL_AMAZON.ExecutionMode | None = Field(
        MYSQL_AMAZON.ExecutionMode.default_par, alias="execmode"
    )
