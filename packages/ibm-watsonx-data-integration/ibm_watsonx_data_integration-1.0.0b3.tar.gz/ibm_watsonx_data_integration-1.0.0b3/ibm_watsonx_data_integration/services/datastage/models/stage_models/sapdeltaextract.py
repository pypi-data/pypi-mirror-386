...
class sapdeltaextract(BaseStage):
    ...
    partition_type: SAPDELTAEXTRACT.PartitionType | None = Field(
        SAPDELTAEXTRACT.PartitionType.auto, alias="part_type"
    )
    ...
    sorting_key: SAPDELTAEXTRACT.KeyColSelect | None = Field(
        SAPDELTAEXTRACT.KeyColSelect.default, alias="keyColSelect"
    )
