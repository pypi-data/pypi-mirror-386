    ...
    def validate_parameters(self) -> tuple[set, set]:
        ...
        (
            ...
            if (
                    ...
                    self.selection
                    and (
                        (hasattr(self.selection, "value") and self.selection.value == "part")
                        or (self.selection == "part")
                    )
        ...
        (
            ...
            if (
                    ...
                    self.columns
                    and (
                        (hasattr(self.columns, "value") and self.columns.value == "field") or (self.columns == "field")
                    )
