...
class postgresql_ibmcloud(BaseStage):
    ...
    reject_uses: POSTGRESQL_IBMCLOUD.RejectUses | None = Field(
        POSTGRESQL_IBMCLOUD.RejectUses.rows, alias="reject_uses"
    )
    ...
    write_mode: POSTGRESQL_IBMCLOUD.WriteMode | None = Field(
        POSTGRESQL_IBMCLOUD.WriteMode.insert, alias="write_mode"
    )
