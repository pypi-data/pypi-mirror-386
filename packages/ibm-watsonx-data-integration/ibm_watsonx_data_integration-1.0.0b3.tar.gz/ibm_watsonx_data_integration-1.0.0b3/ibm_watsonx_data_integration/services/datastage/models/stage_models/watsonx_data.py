...
class watsonx_data(BaseStage):
    ...
    buf_mode_ronly: WATSONX_DATA.BufModeRonly | None = Field(
        WATSONX_DATA.BufModeRonly.default, alias="buf_mode_ronly"
    )
    ...
    execution_mode: WATSONX_DATA.ExecutionMode | None = Field(
        WATSONX_DATA.ExecutionMode.default_par, alias="execmode"
    )
