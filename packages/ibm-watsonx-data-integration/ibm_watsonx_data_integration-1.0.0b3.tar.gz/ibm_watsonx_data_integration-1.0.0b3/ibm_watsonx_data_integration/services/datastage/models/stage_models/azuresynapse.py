...
class azuresynapse(BaseStage):
    ...
    buf_mode_ronly: AZURESYNAPSE.BufModeRonly | None = Field(
        AZURESYNAPSE.BufModeRonly.default, alias="buf_mode_ronly"
    )
    ...
    execution_mode: AZURESYNAPSE.ExecutionMode | None = Field(
        AZURESYNAPSE.ExecutionMode.default_par, alias="execmode"
    )
    ...
    def validate_target(self) -> tuple[set, set]:
        ...
        (
            ...
            if (
                    ...
                    and (
                        ((self.hashing_required))
                        or (self.hashing_required and "#" in str(self.hashing_required))
                    )
        ...
        (
            ...
            if (
                    ...
                    and (
                        ((not self.create_statement)) or (self.create_statement and "#" in str(self.create_statement))
                    )
                    and (
                                        ...
                                        (
                                            (
                                                ...
                                                and (
                                                    (
                                                        hasattr(self.write_mode, "value")
                                                        and self.write_mode.value != "call"
                                                    )
                                                    or (self.write_mode != "call")
                                                )
                                            )
