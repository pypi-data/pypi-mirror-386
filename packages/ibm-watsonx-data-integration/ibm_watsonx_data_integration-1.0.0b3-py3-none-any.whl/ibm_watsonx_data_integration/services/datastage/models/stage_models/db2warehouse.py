...
class db2warehouse(BaseStage):
    ...
    buf_mode_ronly: DB2WAREHOUSE.BufModeRonly | None = Field(
        DB2WAREHOUSE.BufModeRonly.default, alias="buf_mode_ronly"
    )
    ...
    execution_mode: DB2WAREHOUSE.ExecutionMode | None = Field(
        DB2WAREHOUSE.ExecutionMode.default_par, alias="execmode"
    )
