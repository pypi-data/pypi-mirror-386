...
class amazon_redshift(BaseStage):
    ...
    partition_type: AMAZON_REDSHIFT.PartitionType | None = Field(
        AMAZON_REDSHIFT.PartitionType.auto, alias="part_type"
    )
    ...
    sampling_type: AMAZON_REDSHIFT.SamplingType | None = Field(
        AMAZON_REDSHIFT.SamplingType.none, alias="sampling_type"
    )
    ...
    sorting_key: AMAZON_REDSHIFT.KeyColSelect | None = Field(
        AMAZON_REDSHIFT.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    table_action: AMAZON_REDSHIFT.TableAction | None = Field(
        AMAZON_REDSHIFT.TableAction.append, alias="table_action"
    )
                                        ...
                                        (
                                            (
                                                ...
                                                and (
                                                    (
                                                        hasattr(self.write_mode, "value")
                                                        and self.write_mode.value != "load"
                                                    )
                                                    or (self.write_mode != "load")
                                                )
                                            )
