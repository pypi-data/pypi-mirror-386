...
class azure_file_storage(BaseStage):
    ...
    lookup_type: AZURE_FILE_STORAGE.LookupType | None = Field(
        AZURE_FILE_STORAGE.LookupType.empty, alias="lookup_type"
    )
    ...
    reject_mode: AZURE_FILE_STORAGE.RejectMode | None = Field(
        AZURE_FILE_STORAGE.RejectMode.cont, alias="reject_mode"
    )
