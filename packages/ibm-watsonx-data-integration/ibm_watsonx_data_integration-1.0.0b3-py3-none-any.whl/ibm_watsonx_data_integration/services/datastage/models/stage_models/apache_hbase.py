...
class apache_hbase(BaseStage):
    ...
    buf_mode_ronly: APACHE_HBASE.BufModeRonly | None = Field(
        APACHE_HBASE.BufModeRonly.default, alias="buf_mode_ronly"
    )
    ...
    execution_mode: APACHE_HBASE.ExecutionMode | None = Field(
        APACHE_HBASE.ExecutionMode.default_par, alias="execmode"
    )
