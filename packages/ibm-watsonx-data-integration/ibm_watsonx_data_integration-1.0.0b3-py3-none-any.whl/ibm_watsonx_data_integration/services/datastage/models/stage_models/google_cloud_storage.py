...
class google_cloud_storage(BaseStage):
    ...
    collecting: GOOGLE_CLOUD_STORAGE.Collecting | None = Field(
        GOOGLE_CLOUD_STORAGE.Collecting.auto, alias="coll_type"
    )
    ...
    write_mode: GOOGLE_CLOUD_STORAGE.WriteMode | None = Field(
        GOOGLE_CLOUD_STORAGE.WriteMode.write, alias="write_mode"
    )
                        ...
                        (
                            (
                                ...
                                and (
                                    (
                                        hasattr(self.write_mode, "value")
                                        and self.write_mode.value != "delete_multiple_prefix"
                                    )
                                    or (self.write_mode != "delete_multiple_prefix")
                                )
                            )
