...
class apache_hive(BaseStage):
    ...
    ds_session_character_set_for_non_unicode_columns: APACHE_HIVE.DSSessionCharacterSetForNonUnicodeColumns | None = Field(
    ...
    ds_table_action_generate_create_statement_row_format: APACHE_HIVE.DSTableActionGenerateCreateStatementRowFormat | None = Field(
    ...
    ds_table_action_generate_create_statement_storage_format: APACHE_HIVE.DSTableActionGenerateCreateStatementStorageFormat | None = Field(
