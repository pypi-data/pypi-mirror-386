...
class row_generator(BaseStage):
    ...
    combinability: ROW_GENERATOR.Combinability | None = Field(
        ROW_GENERATOR.Combinability.auto, alias="combinability"
    )
    ...
    key_col_select: ROW_GENERATOR.KeyColSelect | None = Field(
        ROW_GENERATOR.KeyColSelect.default, alias="keyColSelect"
    )
