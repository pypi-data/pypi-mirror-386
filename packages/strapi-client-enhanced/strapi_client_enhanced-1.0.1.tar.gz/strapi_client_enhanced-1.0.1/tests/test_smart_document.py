...
from src.strapi_client_enhanced import StrapiClientAsync, SmartDocument
from src.strapi_client_enhanced.models.base_document import BaseDocument
from src.strapi_client_enhanced.utils import hash_model
...
def test_create_document_with_populate(async_client):
    ...
    async def main():
        ...
        with patch('src.strapi_client_enhanced.models.smart_document.get_model_fields_and_population') as mock_get:
...
def test_update_document(async_client):
    ...
    async def main():
        ...
        with patch('src.strapi_client_enhanced.models.smart_document.get_model_fields_and_population') as mock_get:
            ...
            with patch('src.strapi_client_enhanced.models.smart_document.SmartDocument.refresh_document') as mock_refresh:
