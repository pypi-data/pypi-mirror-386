...
def pre_process_test_case(list_excel_files, repo_data):
    for excel_file in list_excel_files:
        split_excel_to_csv(
            input_excel_path=excel_file, output_folder=repo_data
        )


if __name__ == "__main__":
    repo = "pommes/example/test_case/data"
    excel_file1 = "pommes/example/test_case/raw_data/excel_1.xlsx"
    excel_file2 = "pommes/example/test_case/raw_data/excel_2.xlsx"
