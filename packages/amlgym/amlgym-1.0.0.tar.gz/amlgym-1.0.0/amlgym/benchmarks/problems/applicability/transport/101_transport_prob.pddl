...
(define (problem transport_three_cities_sequential_6nodes_10size_3degree_10mindistance_1trucks_2packages_122seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (road city_2_loc_1 city_3_loc_1)
  (road city_3_loc_1 city_2_loc_1)
