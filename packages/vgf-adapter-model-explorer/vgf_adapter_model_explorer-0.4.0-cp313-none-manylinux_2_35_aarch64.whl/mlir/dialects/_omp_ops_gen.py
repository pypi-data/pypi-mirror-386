...
class AllocateDirOp(_ods_ir.OpView):
  ...
  def __init__(self, varList, *, align=None, allocator=None, loc=None, ip=None):
    ...
    if allocator is not None: attributes["allocator"] = (allocator if (
        isinstance(allocator, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('AllocatorHandleAttr')) else
          _ods_ir.AttrBuilder.get('AllocatorHandleAttr')(allocator, context=_ods_context))
  ...
  @builtins.property
  def allocator(self):
    if "allocator" not in self.operation.attributes:
      return None
    return self.operation.attributes["allocator"]

  @allocator.setter
  def allocator(self, value):
    if value is not None:
      self.operation.attributes["allocator"] = value
    elif "allocator" in self.operation.attributes:
      del self.operation.attributes["allocator"]

  @allocator.deleter
  def allocator(self):
    del self.operation.attributes["allocator"]

def allocate_dir(var_list, *, align=None, allocator=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def canonical_loop(trip_count, *, cli=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def distribute(allocate_vars, allocator_vars, private_vars, *, dist_schedule_static=None, dist_schedule_chunk_size=None, order=None, order_mod=None, private_syms=None, private_needs_barrier=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def loop(private_vars, reduction_vars, *, bind_kind=None, private_syms=None, private_needs_barrier=None, order=None, order_mod=None, reduction_mod=None, reduction_byref=None, reduction_syms=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def new_cli(result, *, loc=None, ip=None) -> _ods_ir.Value:
...
def parallel(allocate_vars, allocator_vars, private_vars, reduction_vars, *, if_expr=None, num_threads=None, private_syms=None, private_needs_barrier=None, proc_bind_kind=None, reduction_mod=None, reduction_byref=None, reduction_syms=None, loc=None, ip=None) -> _ods_ir.Operation:
...
class PrivateClauseOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type_, data_sharing_type, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_846')) else
      _ods_ir.AttrBuilder.get('anonymous_846')(type_, context=_ods_context))
...
def sections(allocate_vars, allocator_vars, private_vars, reduction_vars, *, nowait=None, private_syms=None, private_needs_barrier=None, reduction_mod=None, reduction_byref=None, reduction_syms=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def single(allocate_vars, allocator_vars, copyprivate_vars, private_vars, *, copyprivate_syms=None, nowait=None, private_syms=None, private_needs_barrier=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def target(allocate_vars, allocator_vars, depend_vars, has_device_addr_vars, host_eval_vars, in_reduction_vars, is_device_ptr_vars, map_vars, private_vars, *, bare=None, depend_kinds=None, device=None, if_expr=None, in_reduction_byref=None, in_reduction_syms=None, nowait=None, private_syms=None, private_needs_barrier=None, thread_limit=None, private_maps=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def task(allocate_vars, allocator_vars, depend_vars, in_reduction_vars, private_vars, *, depend_kinds=None, final=None, if_expr=None, in_reduction_byref=None, in_reduction_syms=None, mergeable=None, priority=None, private_syms=None, private_needs_barrier=None, untied=None, event_handle=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def teams(allocate_vars, allocator_vars, private_vars, reduction_vars, *, if_expr=None, num_teams_lower=None, num_teams_upper=None, private_syms=None, private_needs_barrier=None, reduction_mod=None, reduction_byref=None, reduction_syms=None, thread_limit=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def unroll_heuristic(applyee, *, loc=None, ip=None) -> _ods_ir.Operation:
