...
def to_buffer(buffer, tensor, *, read_only=None, loc=None, ip=None) -> _ods_ir.Value:
...
def to_tensor(result, buffer, *, restrict=None, writable=None, loc=None, ip=None) -> _ods_ir.Value:
