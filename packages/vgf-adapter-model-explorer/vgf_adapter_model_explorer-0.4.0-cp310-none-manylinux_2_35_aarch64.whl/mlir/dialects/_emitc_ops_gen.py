...
def class_(sym_name, *, final_specifier=None, loc=None, ip=None) -> _ods_ir.Operation:
...
class FieldOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type_, *, attrs=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if attrs is not None: attributes["attrs"] = (attrs if (
        isinstance(attrs, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('AnyAttr')) else
          _ods_ir.AttrBuilder.get('AnyAttr')(attrs, context=_ods_context))
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
  ...
  @builtins.property
  def attrs(self):
    if "attrs" not in self.operation.attributes:
      return None
    return self.operation.attributes["attrs"]

  @attrs.setter
  def attrs(self, value):
    if value is not None:
      self.operation.attributes["attrs"] = value
    elif "attrs" in self.operation.attributes:
      del self.operation.attributes["attrs"]

  @attrs.deleter
  def attrs(self):
    del self.operation.attributes["attrs"]

def field(sym_name, type_, *, attrs=None, loc=None, ip=None) -> _ods_ir.Operation:
  return FieldOp(sym_name=sym_name, type_=type_, attrs=attrs, loc=loc, ip=ip)
...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, specifiers=None, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_537')) else
      _ods_ir.AttrBuilder.get('anonymous_537')(function_type, context=_ods_context))
...
def get_field(result, field_name, *, loc=None, ip=None) -> _ods_ir.Value:
