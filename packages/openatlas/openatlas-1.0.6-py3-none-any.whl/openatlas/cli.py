...
def print_banner(model_id: str, thinking: bool = False):
...
def print_status(model_id: str, thinking: bool = False):
...
def main():
    ...
    try:
        agent = CombinedAgent(markdown=True, model_id=model_id, thinking=thinking_enabled)
    ...
    clear_screen()
    print_banner(current_model, thinking_enabled)
        ...
        try:
            ...
            if user_input.startswith('/'):
                ...
                if command in ['/quit', '/exit', '/q']:
                    ...
                    print_status(current_model, thinking_enabled)
                    continue
                    ...
                    try:
                        agent = CombinedAgent(markdown=True, model_id=current_model, thinking=thinking_enabled)
                    ...
                    if new_model != current_model:
                        ...
                        try:
                            agent = CombinedAgent(markdown=True, model_id=new_model, thinking=thinking_enabled)
