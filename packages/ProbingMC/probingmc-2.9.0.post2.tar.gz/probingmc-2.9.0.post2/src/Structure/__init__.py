...
# s = Structure("C:/Users/Andrey/Dropbox/H2M/Projects/XPS/DFT/Graphite/XPS_files/gr_pl_001.out")
# # s1 = Structure('C:\\Users\\user\\Dropbox\\H2M\\Projects\\GO\\Ready_GO\\s3xs3_out.cif')
# s.decoration([10, 14], 1.6, "B")
# s.decoration([18], 1.43, "O")
# s.decoration([19], 2.4, "K")
# s.set_cell_height(20)
# s.write_structure_to_cif("BOK")
# s.write_structure_to_qe_in(modifier="BOK", type='relax')
# # print(s1.dist_between_atoms(20, 21))

# atoms_ = load_structure_from_mop_out('/home/andrey/Tresors/Cloud/modeling/Swelling/bck/pure/mopac/bck.out')
# print(len(atoms_))
# for atom in atoms_:
#     print(atom.__str__())

# struct = Structure('/home/andrey/Tresors/Cloud/modeling/Swelling/bck/pure/mopac/continue/bck_extended.out', type_relax='mopac', final=True)
# # struct.write_structure_to_mop(new_path_filename='../../../modeling/Swelling/bck/pure/mopac/continue/bck_extended.xyz')
# struct.write_structure_to_xyz(new_path_filename='/home/andrey/Tresors/Cloud/modeling/Swelling/bck/pure/mopac/continue/bck_extended_f.xyz')
