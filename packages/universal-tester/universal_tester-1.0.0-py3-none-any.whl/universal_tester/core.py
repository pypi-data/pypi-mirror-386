...
base_version = SYSTEM_CONFIG.get('PRODUCT_VERSION', '1.0.0')
is_beta = SYSTEM_CONFIG.get('PRODUCT_BETA', 'false').lower() == 'true'
APP_VERSION = f"{base_version} Beta" if is_beta else base_version
