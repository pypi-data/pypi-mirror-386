...
class ParseJobConfig(UncheckedBaseModel):
    """
    ...
    priority: typing.Optional[ParseJobConfigPriority] = pydantic.Field(default=None)
    """
    ...
    input_s_3_path: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="input_s3_path")] = (
    ...
    input_s_3_region: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="input_s3_region")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    output_s_3_region: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="output_s3_region")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    original_file_name: str = pydantic.Field()
    """
    The original file name.
    """

    file_key: str = pydantic.Field()
    """
    The file key.
    """
