...
class ValidationEmbeddingRequestBody_AzureEmbedding(UncheckedBaseModel):
...
class ValidationEmbeddingRequestBody_CohereEmbedding(UncheckedBaseModel):
...
class ValidationEmbeddingRequestBody_GeminiEmbedding(UncheckedBaseModel):
...
class ValidationEmbeddingRequestBody_HuggingfaceApiEmbedding(UncheckedBaseModel):
...
class ValidationEmbeddingRequestBody_OpenaiEmbedding(UncheckedBaseModel):
...
class ValidationEmbeddingRequestBody_VertexaiEmbedding(UncheckedBaseModel):
...
class ValidationEmbeddingRequestBody_BedrockEmbedding(UncheckedBaseModel):
...
ValidationEmbeddingRequestBody = typing_extensions.Annotated[
    typing.Union[
        ValidationEmbeddingRequestBody_AzureEmbedding,
        ValidationEmbeddingRequestBody_CohereEmbedding,
        ValidationEmbeddingRequestBody_GeminiEmbedding,
        ValidationEmbeddingRequestBody_HuggingfaceApiEmbedding,
        ValidationEmbeddingRequestBody_OpenaiEmbedding,
        ValidationEmbeddingRequestBody_VertexaiEmbedding,
        ValidationEmbeddingRequestBody_BedrockEmbedding,
    ],
