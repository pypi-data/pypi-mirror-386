...
class IdentityVerification:
    ...
    def agent_extraction(self, front_id, country, nationality, side, step_data=None):
        ...
        from idvpackage.common import get_facial_encodings_deepface_irq, load_and_process_image_deepface, \
            cosine_similarity
        ...
        try:
            ...
            if side == 'front' or side == 'page1':
                ...
                if step_data and len(json.loads(step_data.get("front_face_encodings"))[0]) == 128:
                    ...
                    front_face_locations, front_face_encodings = get_facial_encodings_deepface_irq(image,
                                                                                                   country=country)
                logging.info(f'----------------Time taken for face extraction: {time.time() - st} seconds\n')
                ...
                if step_data:
                    try:
                        ...
                        largest_face_index1 = national_id_front_face_locations.index(
                            max(national_id_front_face_locations,
        ...
        if country == 'IRQ':
            ...
            try:
                ...
                dict_mother_name['mother_first_name_en'] = GoogleTranslator('ar', 'en').translate(
                    f'Name: {dict_mother_name["mother_first_name"]}').upper()
        ...
        if country == 'UAE':
            ...
            try:
                ...
                try:
                    ...
                    mrz2 = \
                        [s for s in
                         [remove_special_characters1(ele).replace(' ', '') for ele in original_text.split('\n')]
            ...
            if video and data.get('front_face_locations', ''):
                ...
                try:
                    if country == 'IRQ':
                        ...
                        similarity = extract_face_and_compute_cosine_similarity(selfie, front_face_locations,
