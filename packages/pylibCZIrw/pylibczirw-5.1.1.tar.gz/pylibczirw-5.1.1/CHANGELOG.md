...
- mention MacOS as operating system ([`552a47d`](https://github.com/ZEISS/pylibczirw/commit/552a47d04e427f92610b167439d4b15d3e75da63))
...
Fixes #57
Fixes #82 
Fixes https://github.com/bioio-devs/bioio-czi/issues/51

# Context
`pylibrczirw` does not provide wheels for MacOS or ARM Linux. In [some
installation
contexts](https://github.com/bioio-devs/bioio-czi/issues/51#issuecomment-2920756044),
...
# Changes
Added 3 new build artifacts: x86-64 MacOS, ARM64 MacOS, and ARM64 Linux,
with MacOS-specific build logic in setup.py.
...
# Review notes
I strongly recommend also merging my PR #84 so that CI continues to work
past the end of the month.

---------

Co-authored-by: Sebastian Rhode &lt;3833249+sebi06@users.noreply.github.com&gt;
Co-authored-by: PintoCraig &lt;craig-kavan.pinto@zeiss.com&gt; ([`c8fd2ff`](https://github.com/ZEISS/pylibczirw/commit/c8fd2ff4b2b3aeac89d12bcfbeaeda2d694a1230))

* chore: Upgrade from windows-2019 to windows-2022 (#84)

# Context
The windows-2019 action runner image will be fully unsupported by
2025-06-30.
...
Co-authored-by: PintoCraig &lt;craig-kavan.pinto@zeiss.com&gt; ([`0dabe3a`](https://github.com/ZEISS/pylibczirw/commit/0dabe3ab48146997825a35ff421b19d789525242))
...
backwards compatibility). ([`cc17eb3`](https://github.com/ZEISS/pylibczirw/commit/cc17eb364af509aa4cc8047c75fae44669389e68))
