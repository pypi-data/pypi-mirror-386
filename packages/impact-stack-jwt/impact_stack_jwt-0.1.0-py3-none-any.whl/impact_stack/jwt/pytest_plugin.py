...
from impact_stack import jwt  # pylint: disable=unused-import


def _push_session_to_context(session: jwt.Session, context):
...
def fixture_inject_session():
    ...
    def inject_session(session: jwt.Session):
